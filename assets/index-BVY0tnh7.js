...
Please change the parent <Route path="${e}"> to <Route path="${e===`/`?`*`:`${e}/*`}">.`)}let u=gt(),d;if(t){let e=typeof t==`string`?le(t):t;w(c===`/`||e.pathname?.startsWith(c),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${c}" but pathname "${e.pathname}" was given in the \`location\` prop.`),d=e}else d=u;let f=d.pathname||`/`,p=f;if(c!==`/`){let e=c.replace(/^\//,``).split(`/`);p=`/`+f.replace(/^\//,``).split(`/`).slice(e.length).join(`/`)}let m=n&&n.state.matches.length?n.state.matches.map(e=>Object.assign(e,{route:n.manifest[e.route.id]||e.route})):E(e,{pathname:p});ie(l||m!=null,`No routes matched location "${d.pathname}${d.search}${d.hash}" `),ie(m==null||m[m.length-1].route.element!==void 0||m[m.length-1].route.Component!==void 0||m[m.length-1].route.lazy!==void 0,`Matched leaf route at location "${d.pathname}${d.search}${d.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let h=jt(m&&m.map(e=>Object.assign({},e,{params:Object.assign({},o,e.params),pathname:Re([c,r.encodeLocation?r.encodeLocation(e.pathname.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathname]),pathnameBase:e.pathnameBase===`/`?c:Re([c,r.encodeLocation?r.encodeLocation(e.pathnameBase.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathnameBase])})),i,n);return t&&h?x.createElement(ot.Provider,{value:{location:{pathname:`/`,search:``,hash:``,state:null,key:`default`,mask:void 0,...d},navigationType:`POP`}},h):h}function Tt(){let e=Bt(),t=We(e)?`${e.status} ${e.statusText}`:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,r=`rgba(200,200,200, 0.5)`,i={padding:`0.5rem`,backgroundColor:r},a={padding:`2px 4px`,backgroundColor:r},o=null;return console.error(`Error handled by React Router default ErrorBoundary:`,e),o=x.createElement(x.Fragment,null,x.createElement(`p`,null,`💿 Hey developer 👋`),x.createElement(`p`,null,`You can provide a way better UX than this when your app throws errors by providing your own `,x.createElement(`code`,{style:a},`ErrorBoundary`),` or`,` `,x.createElement(`code`,{style:a},`errorElement`),` prop on your route.`)),x.createElement(x.Fragment,null,x.createElement(`h2`,null,`Unexpected Application Error!`),x.createElement(`h3`,{style:{fontStyle:`italic`}},t),n?x.createElement(`pre`,{style:i},n):null,o)}var Et=x.createElement(Tt,null),Dt=class extends x.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!==`idle`&&e.revalidation===`idle`?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error===void 0?t.error:e.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){this.props.onError?this.props.onError(e,t):console.error(`React Router caught the following error during render`,e)}render(){let e=this.state.error;if(this.context&&typeof e==`object`&&e&&`digest`in e&&typeof e.digest==`string`){let t=pt(e.digest);t&&(e=t)}let t=e===void 0?this.props.children:x.createElement(st.Provider,{value:this.props.routeContext},x.createElement(ct.Provider,{value:e,children:this.props.component}));return this.context?x.createElement(kt,{error:e},t):t}};Dt.contextType=et;var Ot=new WeakMap;function kt({children:e,error:t}){let{basename:n}=x.useContext(at);if(typeof t==`object`&&t&&`digest`in t&&typeof t.digest==`string`){let e=ft(t.digest);if(e){let r=Ot.get(t);if(r)throw r;let i=qe(e.location,n),a=i.absoluteURL||i.to;if(Ze(a))throw Error(`Invalid redirect location`);if(Ke&&!Ot.get(t))if(i.isExternal||e.reloadDocument)window.location.href=a;else{let n=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(i.to,{replace:e.replace}));throw Ot.set(t,n),n}return x.createElement(`meta`,{httpEquiv:`refresh`,content:`0;url=${a}`})}}return e}function At({routeContext:e,match:t,children:n}){let r=x.useContext(Qe);return r&&r.static&&r.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=t.route.id),x.createElement(st.Provider,{value:e},n)}function jt(e,t=[],n){let r=n?.state;if(e==null){if(!r)return null;if(r.errors)e=r.matches;else if(t.length===0&&!r.initialized&&r.matches.length>0)e=r.matches;else return null}let i=e,a=r?.errors;if(a!=null){let e=i.findIndex(e=>e.route.id&&a?.[e.route.id]!==void 0);w(e>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(a).join(`,`)}`),i=i.slice(0,Math.min(i.length,e+1))}let o=!1,s=-1;if(n&&r){o=r.renderFallback;for(let e=0;e<i.length;e++){let t=i[e];if((t.route.HydrateFallback||t.route.hydrateFallbackElement)&&(s=e),t.route.id){let{loaderData:e,errors:a}=r,c=t.route.loader&&!e.hasOwnProperty(t.route.id)&&(!a||a[t.route.id]===void 0);if(t.route.lazy||c){n.isStatic&&(o=!0),i=s>=0?i.slice(0,s+1):[i[0]];break}}}}let c=n?.onError,l=r&&c?(e,t)=>{c(e,{location:r.location,params:r.matches?.[0]?.params??{},pattern:Ge(r.matches),errorInfo:t})}:void 0;return i.reduceRight((e,n,c)=>{let u,d=!1,f=null,p=null;r&&(u=a&&n.route.id?a[n.route.id]:void 0,f=n.route.errorElement||Et,o&&(s<0&&c===0?(Ut(`route-fallback`,!1,"No `HydrateFallback` element provided to render during initial hydration"),d=!0,p=null):s===c&&(d=!0,p=n.route.hydrateFallbackElement||null)));let m=t.concat(i.slice(0,c+1)),h=()=>{let t;return t=u?f:d?p:n.route.Component?x.createElement(n.route.Component,null):n.route.element?n.route.element:e,x.createElement(At,{match:n,routeContext:{outlet:e,matches:m,isDataRoute:r!=null},children:t})};return r&&(n.route.ErrorBoundary||n.route.errorElement||c===0)?x.createElement(Dt,{location:r.location,revalidation:r.revalidation,component:f,error:u,children:h(),routeContext:{outlet:null,matches:m,isDataRoute:!0},onError:l}):h()},null)}function Mt(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Nt(e){let t=x.useContext(Qe);return w(t,Mt(e)),t}function Pt(e){let t=x.useContext($e);return w(t,Mt(e)),t}function Ft(e){let t=x.useContext(st);return w(t,Mt(e)),t}function It(e){let t=Ft(e),n=t.matches[t.matches.length-1];return w(n.route.id,`${e} can only be used on routes that contain a unique "id"`),n.route.id}function Lt(){return It(`useRouteId`)}function Rt(){let e=Pt(`useNavigation`);return x.useMemo(()=>{let{matches:t,historyAction:n,...r}=e.navigation;return r},[e.navigation])}function zt(){let{matches:e,loaderData:t}=Pt(`useMatches`);return x.useMemo(()=>e.map(e=>fe(e,t)),[e,t])}function Bt(){let e=x.useContext(ct),t=Pt(`useRouteError`),n=It(`useRouteError`);return e===void 0?t.errors?.[n]:e}function Vt(){let{router:e}=Nt(`useNavigate`),t=It(`useNavigate`),n=x.useRef(!1);return vt(()=>{n.current=!0}),x.useCallback(async(r,i={})=>{ie(n.current,_t),n.current&&(typeof r==`number`?await e.navigate(r):await e.navigate(r,{fromRouteId:t,...i}))},[e,t])}var Ht={};function Ut(e,t,n){!t&&!Ht[e]&&(Ht[e]=!0,ie(!1,n))}x.memo(Wt);function Wt({routes:e,manifest:t,future:n,state:r,isStatic:i,onError:a}){return wt(e,void 0,{manifest:t,state:r,isStatic:i,onError:a,future:n})}function Gt({to:e,replace:t,state:n,relative:r}){w(ht(),`<Navigate> may be used only in the context of a <Router> component.`);let{static:i}=x.useContext(at);ie(!i,`<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.`);let{matches:a}=x.useContext(st),{pathname:o}=gt(),s=yt(),c=Ie(e,Fe(a),o,r===`path`),l=JSON.stringify(c);return x.useEffect(()=>{s(JSON.parse(l),{replace:t,state:n,relative:r})},[s,l,r,t,n]),null}function Kt(e){w(!1,`A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.`)}function qt({basename:e=`/`,children:t=null,location:n,navigationType:r=`POP`,navigator:i,static:a=!1,useTransitions:o}){w(!ht(),`You cannot render a <Router> inside another <Router>. You should never have more than one in your app.`);let s=e.replace(/^\/*/,`/`),c=x.useMemo(()=>({basename:s,navigator:i,static:a,useTransitions:o,future:{}}),[s,i,a,o]);typeof n==`string`&&(n=le(n));let{pathname:l=`/`,search:u=``,hash:d=``,state:f=null,key:p=`default`,mask:m}=n,h=x.useMemo(()=>{let e=Ae(l,s);return e==null?null:{location:{pathname:e,search:u,hash:d,state:f,key:p,mask:m},navigationType:r}},[s,l,u,d,f,p,r,m]);return ie(h!=null,`<Router basename="${s}"> is not able to match the URL "${l}${u}${d}" because it does not start with the basename, so the <Router> won't render anything.`),h==null?null:x.createElement(at.Provider,{value:c},x.createElement(ot.Provider,{children:t,value:h}))}function Jt({children:e,location:t}){return Ct(Yt(e),t)}x.Component;function Yt(e,t=[]){let n=[];return x.Children.forEach(e,(e,r)=>{if(!x.isValidElement(e))return;let i=[...t,r];if(e.type===x.Fragment){n.push.apply(n,Yt(e.props.children,i));return}w(e.type===Kt,`[${typeof e.type==`string`?e.type:e.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),w(!e.props.index||!e.props.children,`An index route cannot have child routes.`);let a={id:e.props.id||i.join(`-`),caseSensitive:e.props.caseSensitive,element:e.props.element,Component:e.props.Component,index:e.props.index,path:e.props.path,middleware:e.props.middleware,loader:e.props.loader,action:e.props.action,hydrateFallbackElement:e.props.hydrateFallbackElement,HydrateFallback:e.props.HydrateFallback,errorElement:e.props.errorElement,ErrorBoundary:e.props.ErrorBoundary,hasErrorBoundary:e.props.hasErrorBoundary===!0||e.props.ErrorBoundary!=null||e.props.errorElement!=null,shouldRevalidate:e.props.shouldRevalidate,handle:e.props.handle,lazy:e.props.lazy};e.props.children&&(a.children=Yt(e.props.children,i)),n.push(a)}),n}var Xt=`get`,Zt=`application/x-www-form-urlencoded`;function Qt(e){return typeof HTMLElement<`u`&&e instanceof HTMLElement}function $t(e){return Qt(e)&&e.tagName.toLowerCase()===`button`}function en(e){return Qt(e)&&e.tagName.toLowerCase()===`form`}function tn(e){return Qt(e)&&e.tagName.toLowerCase()===`input`}function nn(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function rn(e,t){return e.button===0&&(!t||t===`_self`)&&!nn(e)}var an=null;function on(){if(an===null)try{new FormData(document.createElement(`form`),0),an=!1}catch{an=!0}return an}var sn=new Set([`application/x-www-form-urlencoded`,`multipart/form-data`,`text/plain`]);function cn(e){return e!=null&&!sn.has(e)?(ie(!1,`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Zt}"`),null):e}function ln(e,t){let n,r,i,a,o;if(en(e)){let o=e.getAttribute(`action`);r=o?Ae(o,t):null,n=e.getAttribute(`method`)||Xt,i=cn(e.getAttribute(`enctype`))||Zt,a=new FormData(e)}else if($t(e)||tn(e)&&(e.type===`submit`||e.type===`image`)){let o=e.form;if(o==null)throw Error(`Cannot submit a <button> or <input type="submit"> without a <form>`);let s=e.getAttribute(`formaction`)||o.getAttribute(`action`);if(r=s?Ae(s,t):null,n=e.getAttribute(`formmethod`)||o.getAttribute(`method`)||Xt,i=cn(e.getAttribute(`formenctype`))||cn(o.getAttribute(`enctype`))||Zt,a=new FormData(o,e),!on()){let{name:t,type:n,value:r}=e;if(n===`image`){let e=t?`${t}.`:``;a.append(`${e}x`,`0`),a.append(`${e}y`,`0`)}else t&&a.append(t,r)}}else if(Qt(e))throw Error(`Cannot submit element that is not <form>, <button>, or <input type="submit|image">`);else n=Xt,r=null,i=Zt,o=e;return a&&i===`text/plain`&&(o=a,a=void 0),{action:r,method:n.toLowerCase(),encType:i,formData:a,body:o}}Object.getOwnPropertyNames(Object.prototype).sort().join(`\0`);var un={"&":`\\u0026`,">":`\\u003e`,"<":`\\u003c`,"\u2028":`\\u2028`,"\u2029":`\\u2029`},dn=/[&><\u2028\u2029]/g;function fn(e){return e.replace(dn,e=>un[e])}function pn(e,t){if(e===!1||e==null)throw Error(t)}function mn(e,t,n,r){let i=typeof e==`string`?new URL(e,typeof window>`u`?`server://singlefetch/`:window.location.origin):e;return n?i.pathname.endsWith(`/`)?i.pathname=`${i.pathname}_.${r}`:i.pathname=`${i.pathname}.${r}`:i.pathname===`/`?i.pathname=`_root.${r}`:t&&Ae(i.pathname,t)===`/`?i.pathname=`${ze(t)}/_root.${r}`:i.pathname=`${ze(i.pathname)}.${r}`,i}async function hn(e,t){if(e.id in t)return t[e.id];try{let n=await b(()=>import(e.module),[]);return t[e.id]=n,n}catch(t){return console.error(`Error loading route module \`${e.module}\`, reloading page...`),console.error(t),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function gn(e){return e!=null&&typeof e.page==`string`}function _n(e){return e==null?!1:e.href==null?e.rel===`preload`&&typeof e.imageSrcSet==`string`&&typeof e.imageSizes==`string`:typeof e.rel==`string`&&typeof e.href==`string`}async function vn(e,t,n){return Cn((await Promise.all(e.map(async e=>{let r=t.routes[e.route.id];if(r){let e=await hn(r,n);return e.links?e.links():[]}return[]}))).flat(1).filter(_n).filter(e=>e.rel===`stylesheet`||e.rel===`preload`).map(e=>e.rel===`stylesheet`?{...e,rel:`prefetch`,as:`style`}:{...e,rel:`prefetch`}))}function yn(e,t,n,r,i,a){let o=(e,t)=>n[t]?e.route.id!==n[t].route.id:!0,s=(e,t)=>n[t].pathname!==e.pathname||n[t].route.path?.endsWith(`*`)&&n[t].params[`*`]!==e.params[`*`];return a===`assets`?t.filter((e,t)=>o(e,t)||s(e,t)):a===`data`?t.filter((t,a)=>{let c=r.routes[t.route.id];if(!c||!c.hasLoader)return!1;if(o(t,a)||s(t,a))return!0;if(t.route.shouldRevalidate){let r=t.route.shouldRevalidate({currentUrl:new URL(i.pathname+i.search+i.hash,window.origin),currentParams:n[0]?.params||{},nextUrl:new URL(e,window.origin),nextParams:t.params,defaultShouldRevalidate:!0});if(typeof r==`boolean`)return r}return!0}):[]}function bn(e,t,{includeHydrateFallback:n}={}){return xn(e.map(e=>{let r=t.routes[e.route.id];if(!r)return[];let i=[r.module];return r.clientActionModule&&(i=i.concat(r.clientActionModule)),r.clientLoaderModule&&(i=i.concat(r.clientLoaderModule)),n&&r.hydrateFallbackModule&&(i=i.concat(r.hydrateFallbackModule)),r.imports&&(i=i.concat(r.imports)),i}).flat(1))}function xn(e){return[...new Set(e)]}function Sn(e){let t={},n=Object.keys(e).sort();for(let r of n)t[r]=e[r];return t}function Cn(e,t){let n=new Set,r=new Set(t);return e.reduce((e,i)=>{if(t&&!gn(i)&&i.as===`script`&&i.href&&r.has(i.href))return e;let a=JSON.stringify(Sn(i));return n.has(a)||(n.add(a),e.push({key:a,link:i})),e},[])}function wn(){let e=x.useContext(Qe);return pn(e,`You must render this element inside a <DataRouterContext.Provider> element`),e}function Tn(){let e=x.useContext($e);return pn(e,`You must render this element inside a <DataRouterStateContext.Provider> element`),e}var En=x.createContext(void 0);En.displayName=`FrameworkContext`;function Dn(){let e=x.useContext(En);return pn(e,`You must render this element inside a <HydratedRouter> element`),e}function On(e,t){let n=x.useContext(En),[r,i]=x.useState(!1),[a,o]=x.useState(!1),{onFocus:s,onBlur:c,onMouseEnter:l,onMouseLeave:u,onTouchStart:d}=t,f=x.useRef(null);x.useEffect(()=>{if(e===`render`&&o(!0),e===`viewport`){let e=new IntersectionObserver(e=>{e.forEach(e=>{o(e.isIntersecting)})},{threshold:.5});return f.current&&e.observe(f.current),()=>{e.disconnect()}}},[e]),x.useEffect(()=>{if(r){let e=setTimeout(()=>{o(!0)},100);return()=>{clearTimeout(e)}}},[r]);let p=()=>{i(!0)},m=()=>{i(!1),o(!1)};return n?e===`intent`?[a,f,{onFocus:kn(s,p),onBlur:kn(c,m),onMouseEnter:kn(l,p),onMouseLeave:kn(u,m),onTouchStart:kn(d,p)}]:[a,f,{}]:[!1,f,{}]}function kn(e,t){return n=>{e&&e(n),n.defaultPrevented||t(n)}}function An({page:e,...t}){let n=tt(),{nonce:r}=Dn(),{router:i}=wn(),a=x.useMemo(()=>E(i.routes,e,i.basename),[i.routes,e,i.basename]);return a?(t.nonce==null&&r&&(t={...t,nonce:r}),n?x.createElement(Mn,{page:e,matches:a,...t}):x.createElement(Nn,{page:e,matches:a,...t})):null}function jn(e){let{manifest:t,routeModules:n}=Dn(),[r,i]=x.useState([]);return x.useEffect(()=>{let r=!1;return vn(e,t,n).then(e=>{r||i(e)}),()=>{r=!0}},[e,t,n]),r}function Mn({page:e,matches:t,...n}){let r=gt(),{future:i}=Dn(),{basename:a}=wn(),o=x.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=mn(e,a,i.v8_trailingSlashAwareDataRequests,`rsc`),o=!1,s=[];for(let e of t)typeof e.route.shouldRevalidate==`function`?o=!0:s.push(e.route.id);return o&&s.length>0&&n.searchParams.set(`_routes`,s.join(`,`)),[n.pathname+n.search]},[a,i.v8_trailingSlashAwareDataRequests,e,r,t]);return x.createElement(x.Fragment,null,o.map(e=>x.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})))}function Nn({page:e,matches:t,...n}){let r=gt(),{future:i,manifest:a,routeModules:o}=Dn(),{basename:s}=wn(),{loaderData:c,matches:l}=Tn(),u=x.useMemo(()=>yn(e,t,l,a,r,`data`),[e,t,l,a,r]),d=x.useMemo(()=>yn(e,t,l,a,r,`assets`),[e,t,l,a,r]),f=x.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=new Set,l=!1;if(t.forEach(e=>{let t=a.routes[e.route.id];!t||!t.hasLoader||(!u.some(t=>t.route.id===e.route.id)&&e.route.id in c&&o[e.route.id]?.shouldRevalidate||t.hasClientLoader?l=!0:n.add(e.route.id))}),n.size===0)return[];let d=mn(e,s,i.v8_trailingSlashAwareDataRequests,`data`);return l&&n.size>0&&d.searchParams.set(`_routes`,t.filter(e=>n.has(e.route.id)).map(e=>e.route.id).join(`,`)),[d.pathname+d.search]},[s,i.v8_trailingSlashAwareDataRequests,c,r,a,u,t,e,o]),p=x.useMemo(()=>bn(d,a),[d,a]),m=jn(d);return x.createElement(x.Fragment,null,f.map(e=>x.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})),p.map(e=>x.createElement(`link`,{key:e,rel:`modulepreload`,href:e,...n})),m.map(({key:e,link:t})=>x.createElement(`link`,{key:e,nonce:n.nonce,...t,crossOrigin:t.crossOrigin??n.crossOrigin})))}function Pn(...e){return t=>{e.forEach(e=>{typeof e==`function`?e(t):e!=null&&(e.current=t)})}}x.Component;var Fn=typeof window<`u`&&window.document!==void 0&&window.document.createElement!==void 0;try{Fn&&(window.__reactRouterVersion=`7.18.1`)}catch{}function In({basename:e,children:t,useTransitions:n,window:r}){let i=x.useRef();i.current??=re({window:r,v5Compat:!0});let a=i.current,[o,s]=x.useState({action:a.action,location:a.location}),c=x.useCallback(e=>{n===!1?s(e):x.startTransition(()=>s(e))},[n]);return x.useLayoutEffect(()=>a.listen(c),[a,c]),x.createElement(qt,{basename:e,children:t,location:o.location,navigationType:o.action,navigator:a,useTransitions:n})}function Ln({basename:e,children:t,history:n,useTransitions:r}){let[i,a]=x.useState({action:n.action,location:n.location}),o=x.useCallback(e=>{r===!1?a(e):x.startTransition(()=>a(e))},[r]);return x.useLayoutEffect(()=>n.listen(o),[n,o]),x.createElement(qt,{basename:e,children:t,location:i.location,navigationType:i.action,navigator:n,useTransitions:r})}Ln.displayName=`unstable_HistoryRouter`;var O=x.forwardRef(function({onClick:e,discover:t=`render`,prefetch:n=`none`,relative:r,reloadDocument:i,replace:a,mask:o,state:s,target:c,to:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f,...p},m){let{basename:h,navigator:g,useTransitions:_}=x.useContext(at),v=typeof l==`string`&&ee.test(l),y=qe(l,h);l=y.to;let b=mt(l,{relative:r}),S=gt(),C=null;if(o){let e=Ie(o,[],S.mask?S.mask.pathname:`/`,!0);h!==`/`&&(e.pathname=e.pathname===`/`?h:Re([h,e.pathname])),C=g.createHref(e)}let[te,ne,re]=On(n,p),w=Wn(l,{replace:a,mask:o,state:s,target:c,preventScrollReset:u,relative:r,viewTransition:d,defaultShouldRevalidate:f,useTransitions:_});function ie(t){e&&e(t),t.defaultPrevented||w(t)}let ae=!(y.isExternal||i),oe=x.createElement(`a`,{...p,...re,href:(ae?C:void 0)||y.absoluteURL||b,onClick:ae?ie:e,ref:Pn(m,ne),target:c,"data-discover":!v&&t===`render`?`true`:void 0});return te&&!v?x.createElement(x.Fragment,null,oe,x.createElement(An,{page:b})):oe});O.displayName=`Link`;var Rn=x.forwardRef(function({"aria-current":e=`page`,caseSensitive:t=!1,className:n=``,end:r=!1,style:i,to:a,viewTransition:o,children:s,...c},l){let u=St(a,{relative:c.relative}),d=gt(),f=x.useContext($e),{navigator:p,basename:m}=x.useContext(at),h=f!=null&&er(u)&&o===!0,g=p.encodeLocation?p.encodeLocation(u).pathname:u.pathname,_=d.pathname,v=f&&f.navigation&&f.navigation.location?f.navigation.location.pathname:null;t||(_=_.toLowerCase(),v=v?v.toLowerCase():null,g=g.toLowerCase()),v&&m&&(v=Ae(v,m)||v);let y=g!==`/`&&g.endsWith(`/`)?g.length-1:g.length,b=_===g||!r&&_.startsWith(g)&&_.charAt(y)===`/`,ee=v!=null&&(v===g||!r&&v.startsWith(g)&&v.charAt(g.length)===`/`),S={isActive:b,isPending:ee,isTransitioning:h},C=b?e:void 0,te;te=typeof n==`function`?n(S):[n,b?`active`:null,ee?`pending`:null,h?`transitioning`:null].filter(Boolean).join(` `);let ne=typeof i==`function`?i(S):i;return x.createElement(O,{...c,"aria-current":C,className:te,ref:l,style:ne,to:a,viewTransition:o},typeof s==`function`?s(S):s)});Rn.displayName=`NavLink`;var zn=x.forwardRef(({discover:e=`render`,fetcherKey:t,navigate:n,reloadDocument:r,replace:i,state:a,method:o=Xt,action:s,onSubmit:c,relative:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f,...p},m)=>{let{useTransitions:h}=x.useContext(at),g=qn(),_=Jn(s,{relative:l}),v=o.toLowerCase()===`get`?`get`:`post`,y=typeof s==`string`&&ee.test(s);return x.createElement(`form`,{ref:m,method:v,action:_,onSubmit:r?c:e=>{if(c&&c(e),e.defaultPrevented)return;e.preventDefault();let r=e.nativeEvent.submitter,s=r?.getAttribute(`formmethod`)||o,p=()=>g(r||e.currentTarget,{fetcherKey:t,method:s,navigate:n,replace:i,state:a,relative:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f});h&&n!==!1?x.startTransition(()=>p()):p()},...p,"data-discover":!y&&e===`render`?`true`:void 0})});zn.displayName=`Form`;function Bn({getKey:e,storageKey:t,...n}){let r=x.useContext(En),{basename:i}=x.useContext(at),a=gt(),o=zt();Qn({getKey:e,storageKey:t});let s=x.useMemo(()=>{if(!r||!e)return null;let t=Zn(a,o,i,e);return t===a.key?null:t},[]);if(!r||r.isSpaMode)return null;let c=((e,t)=>{if(!window.history.state||!window.history.state.key){let e=Math.random().toString(32).slice(2);window.history.replaceState({key:e},``)}try{let n=JSON.parse(sessionStorage.getItem(e)||`{}`)[t||window.history.state.key];typeof n==`number`&&window.scrollTo(0,n)}catch(t){console.error(t),sessionStorage.removeItem(e)}}).toString();return n.nonce==null&&r?.nonce&&(n.nonce=r.nonce),x.createElement(`script`,{...n,suppressHydrationWarning:!0,dangerouslySetInnerHTML:{__html:`(${c})(${fn(JSON.stringify(t||Yn))}, ${fn(JSON.stringify(s))})`}})}Bn.displayName=`ScrollRestoration`;function Vn(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Hn(e){let t=x.useContext(Qe);return w(t,Vn(e)),t}function Un(e){let t=x.useContext($e);return w(t,Vn(e)),t}function Wn(e,{target:t,replace:n,mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,defaultShouldRevalidate:c,useTransitions:l}={}){let u=yt(),d=gt(),f=St(e,{relative:o});return x.useCallback(p=>{if(rn(p,t)){p.preventDefault();let t=n===void 0?ce(d)===ce(f):n,m=()=>u(e,{replace:t,mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,defaultShouldRevalidate:c});l?x.startTransition(()=>m()):m()}},[d,u,f,n,r,i,t,e,a,o,s,c,l])}var Gn=0,Kn=()=>`__${String(++Gn)}__`;function qn(){let{router:e}=Hn(`useSubmit`),{basename:t}=x.useContext(at),n=Lt(),r=e.fetch,i=e.navigate;return x.useCallback(async(e,a={})=>{let{action:o,method:s,encType:c,formData:l,body:u}=ln(e,t);if(a.navigate===!1){let e=a.fetcherKey||Kn();await r(e,n,a.action||o,{defaultShouldRevalidate:a.defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,flushSync:a.flushSync})}else await i(a.action||o,{defaultShouldRevalidate:a.defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,replace:a.replace,state:a.state,fromRouteId:n,flushSync:a.flushSync,viewTransition:a.viewTransition})},[r,i,t,n])}function Jn(e,{relative:t}={}){let{basename:n}=x.useContext(at),r=x.useContext(st);w(r,`useFormAction must be used inside a RouteContext`);let[i]=r.matches.slice(-1),a={...St(e||`.`,{relative:t})},o=gt();if(e==null){a.search=o.search;let e=new URLSearchParams(a.search),t=e.getAll(`index`);if(t.some(e=>e===``)){e.delete(`index`),t.filter(e=>e).forEach(t=>e.append(`index`,t));let n=e.toString();a.search=n?`?${n}`:``}}return(!e||e===`.`)&&i.route.index&&(a.search=a.search?a.search.replace(/^\?/,`?index&`):`?index`),n!==`/`&&(a.pathname=a.pathname===`/`?n:Re([n,a.pathname])),ce(a)}var Yn=`react-router-scroll-positions`,Xn={};function Zn(e,t,n,r){let i=null;return r&&(i=r(n===`/`?e:{...e,pathname:Ae(e.pathname,n)||e.pathname},t)),i??=e.key,i}function Qn({getKey:e,storageKey:t}={}){let{router:n}=Hn(`useScrollRestoration`),{restoreScrollPosition:r,preventScrollReset:i}=Un(`useScrollRestoration`),{basename:a}=x.useContext(at),o=gt(),s=zt(),c=Rt();x.useEffect(()=>(window.history.scrollRestoration=`manual`,()=>{window.history.scrollRestoration=`auto`}),[]),$n(x.useCallback(()=>{if(c.state===`idle`){let t=Zn(o,s,a,e);Xn[t]=window.scrollY}try{sessionStorage.setItem(t||Yn,JSON.stringify(Xn))}catch(e){ie(!1,`Failed to save scroll positions in sessionStorage, <ScrollRestoration /> will not work properly (${e}).`)}window.history.scrollRestoration=`auto`},[c.state,e,a,o,s,t])),typeof document<`u`&&(x.useLayoutEffect(()=>{try{let e=sessionStorage.getItem(t||Yn);e&&(Xn=JSON.parse(e))}catch{}},[t]),x.useLayoutEffect(()=>{let t=n?.enableScrollRestoration(Xn,()=>window.scrollY,e?(t,n)=>Zn(t,n,a,e):void 0);return()=>t&&t()},[n,a,e]),x.useLayoutEffect(()=>{if(r!==!1){if(typeof r==`number`){window.scrollTo(0,r);return}try{if(o.hash){let e=document.getElementById(decodeURIComponent(o.hash.slice(1)));if(e){e.scrollIntoView();return}}}catch{ie(!1,`"${o.hash.slice(1)}" is not a decodable element ID. The view will not scroll to it.`)}i!==!0&&window.scrollTo(0,0)}},[o,r,i]))}function $n(e,t){let{capture:n}=t||{};x.useEffect(()=>{let t=n==null?void 0:{capture:n};return window.addEventListener(`pagehide`,e,t),()=>{window.removeEventListener(`pagehide`,e,t)}},[e,n])}function er(e,{relative:t}={}){let n=x.useContext(nt);w(n!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=Hn(`useViewTransitionState`),i=St(e,{relative:t});if(!n.isTransitioning)return!1;let a=Ae(n.currentLocation.pathname,r)||n.currentLocation.pathname,o=Ae(n.nextLocation.pathname,r)||n.nextLocation.pathname;return Ee(i.pathname,o)!=null||Ee(i.pathname,a)!=null}var tr=g(),nr=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),k=o(((e,t)=>{t.exports=nr()}))();function rr({source:e}){return(0,k.jsx)(`div`,{className:`markdown-view`,children:ir(e).map((e,t)=>e.type===`heading`?(0,k.jsx)(e.level===2?`h2`:`h3`,{children:e.text},t):e.type===`list`?(0,k.jsx)(e.ordered?`ol`:`ul`,{children:e.items.map(e=>(0,k.jsx)(`li`,{children:e},e))},t):(0,k.jsx)(`p`,{children:e.text},t))})}function ir(e){let t=[],n=e.split(`
`),r=[],i=null,a=()=>{r.length>0&&(t.push({type:`paragraph`,text:r.join(` `)}),r=[])},o=()=>{i&&=(t.push({type:`list`,ordered:i.ordered,items:i.items}),null)};for(let e of n){let n=e.trim();if(!n){a(),o();continue}let s=/^(#{2,3})\s+(.+)$/.exec(n);if(s){a(),o(),t.push({type:`heading`,level:s[1].length,text:s[2]});continue}let c=/^[-*]\s+(.+)$/.exec(n),l=/^\d+\.\s+(.+)$/.exec(n);if(c||l){a();let e=!!l;(!i||i.ordered!==e)&&(o(),i={ordered:e,items:[]}),i.items.push((c??l)?.[1]??``);continue}o(),r.push(n)}return a(),o(),t}var ar=[{id:`no-rest-for-the-wicked`,name:`恶意不息`,cover:`https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/1371980/header.jpg`,description:`综合整理自互联网公开资料的《恶意不息》攻略库，覆盖流程、探索、装备、Build、资源和 Boss。`,supportedCategories:[`quest_exploration`,`equipment`,`build`,`resource_map`,`boss`,`collection`]}],or={quest_exploration:`任务与探索`,build:`Build 与流派`,equipment:`装备资料`,resource_map:`地图资源`,boss:`Boss 攻略`,collection:`全收集`},sr={none:`无剧透`,light:`轻微剧透`,major:`重大剧透`},cr={draft:`综合草稿`,verified:`已校对`,needs_review:`待复核`},lr=`---
title: 攻略标题
...
`).map(e=>e.trim()).filter(Boolean).map(t=>{let n=t.indexOf(`:`);if(n===-1)throw Error(`Guide "${e}" has invalid frontmatter line "${t}".`);return[t.slice(0,n).trim(),Pr(t.slice(n+1).trim())]})),body:i}}function Nr(e,t){for(let n of Er)if(!(n in t))throw Error(`Guide "${e}" is missing required field "${n}".`);let n=Br(e,`category`,t.category,Cr),r=Br(e,`spoilerLevel`,t.spoilerLevel,wr);return{title:Fr(e,`title`,t.title),gameId:Fr(e,`gameId`,t.gameId),category:n,region:Fr(e,`region`,t.region),phase:Fr(e,`phase`,t.phase),npcs:Rr(e,`npcs`,t.npcs),items:Rr(e,`items`,t.items),prerequisites:Rr(e,`prerequisites`,t.prerequisites),rewards:Rr(e,`rewards`,t.rewards),spoilerLevel:r,tags:Rr(e,`tags`,t.tags),summary:Fr(e,`summary`,t.summary),updatedAt:Fr(e,`updatedAt`,t.updatedAt),example:Lr(e,`example`,t.example),sources:Vr(e,t.sources),images:Hr(e,t.images),contentStatus:Br(e,`contentStatus`,t.contentStatus,Tr),lastVerifiedAt:Fr(e,`lastVerifiedAt`,t.lastVerifiedAt),bossType:Ir(e,`bossType`,t.bossType),equipmentType:Ir(e,`equipmentType`,t.equipmentType),buildTags:zr(e,`buildTags`,t.buildTags)}}function Pr(e){if(e===`true`)return!0;if(e===`false`)return!1;if(e.startsWith(`[`)&&e.endsWith(`]`)){try{return JSON.parse(e)}catch{}let t=e.slice(1,-1).trim();return t?t.split(`,`).map(e=>e.trim()).filter(Boolean):[]}return e.startsWith(`{`)&&e.endsWith(`}`)?JSON.parse(e):e}function Fr(e,t,n){if(typeof n!=`string`||n.length===0)throw Error(`Guide "${e}" field "${t}" must be a string.`);return n}function Ir(e,t,n){if(n!==void 0)return Fr(e,t,n)}function Lr(e,t,n){if(typeof n!=`boolean`)throw Error(`Guide "${e}" field "${t}" must be a boolean.`);return n}function Rr(e,t,n){if(!Array.isArray(n)||n.some(e=>typeof e!=`string`))throw Error(`Guide "${e}" field "${t}" must be a string array.`);return n}function zr(e,t,n){if(n!==void 0)return Rr(e,t,n)}function Br(e,t,n,r){if(typeof n!=`string`||!r.includes(n))throw Error(`Guide "${e}" field "${t}" must be one of: ${r.join(`, `)}.`);return n}function Vr(e,t){if(!Array.isArray(t)||t.length===0)throw Error(`Guide "${e}" field "sources" must be a non-empty array.`);return t.map(t=>{if(typeof t==`string`){let n=yr[t];if(!n)throw Error(`Guide "${e}" references unknown source "${t}".`);return n}if(typeof t!=`object`||!t)throw Error(`Guide "${e}" has an invalid source item.`);let n=t;return{title:Fr(e,`sources.title`,n.title),url:Fr(e,`sources.url`,n.url),type:Br(e,`sources.type`,n.type,[`official`,`wiki`,`guide`,`video`,`community`,`news`]),language:Br(e,`sources.language`,n.language,[`zh`,`en`])}})}function Hr(e,t){if(!Array.isArray(t))throw Error(`Guide "${e}" field "images" must be an array.`);return t.map(t=>{if(typeof t==`string`){let n=xr[t];if(!n)throw Error(`Guide "${e}" references unknown image "${t}".`);return n}if(typeof t!=`object`||!t)throw Error(`Guide "${e}" has an invalid image item.`);let n=t;return{url:Fr(e,`images.url`,n.url),alt:Fr(e,`images.alt`,n.alt),caption:Fr(e,`images.caption`,n.caption),sourceUrl:Fr(e,`images.sourceUrl`,n.sourceUrl),licenseNote:Fr(e,`images.licenseNote`,n.licenseNote)}})}function Ur(e,t,n,r){let i=n.trim().toLowerCase();return e.filter(e=>e.gameId!==t||r.category!==`all`&&e.category!==r.category||r.region!==`all`&&e.region!==r.region||r.phase!==`all`&&e.phase!==r.phase||r.spoilerLevel!==`all`&&e.spoilerLevel!==r.spoilerLevel?!1:i?e.searchText.includes(i):!0)}function Wr(e,t){return Array.from(new Set(e.map(e=>e[t]).filter(e=>typeof e==`string`))).sort((e,t)=>e.localeCompare(t,`zh-Hans-CN`))}var Gr=[{slug:`warrick-the-torn`,gameId:`no-rest-for-the-wicked`,categoryLabelZh:`主线 Boss`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Warrick+The+Torn`,notes:[],lastVerifiedAt:`2026-07-09`,name:`Warrick The Torn`,category:`main_story`,bossType:`大型变异人形`,optional:`否`,location:[`Orban Glades，Sacrament 城门附近`],quest:[`序章通往 Sacrament 的主线推进`],weakness:[`火`],strongAgainst:[`瘟疫`],resistantTo:[`无稳定抗性记录`],immuneTo:[`无稳定免疫记录`],rewards:[`随机物品`,`Corpse Smeared Blade 概率掉落`,`Plague Ichor`],imageUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/warrick-the-torn-boss-no-rest-for-the-wicked-wiki-guide.jpg`,summary:`第一批主线 Boss。动作前摇清楚，主要考验玩家是否能等招式收尾后从侧面或背后反击。`,preparation:[`准备火属性或高爆发武器。`,`保留体力用于连续闪避，不要在正面贪完整连段。`],strategy:[`下劈、360 度挥砍、突刺和双重挥砍都有明显蓄力；看到抬刀或身体前压时先横向闪避。`,`低血量后会追加跳砸。Boss 起跳后目标点基本锁定在你原位置，立刻横移离开落点。`,`多数攻击覆盖正面，真正安全的输出窗口在招式落空后的侧后方。`],attacks:[{name:`下劈`,counter:`抬刀后横向闪避，落地硬直时侧面反击。`},{name:`旋身挥砍`,counter:`等他贴近再翻滚或侧移，过早闪避容易被追到。`},{name:`突刺`,counter:`蓄力时间较长，等刺出瞬间侧闪。`},{name:`跳砸`,counter:`低血量阶段出现，起跳后立即离开原站位。`}],searchText:`warrick the torn 大型变异人形 主线 boss 第一批主线 boss。动作前摇清楚，主要考验玩家是否能等招式收尾后从侧面或背后反击。 orban glades，sacrament 城门附近 序章通往 sacrament 的主线推进 火 随机物品 corpse smeared blade 概率掉落 plague ichor 下劈、360 度挥砍、突刺和双重挥砍都有明显蓄力；看到抬刀或身体前压时先横向闪避。 低血量后会追加跳砸。boss 起跳后目标点基本锁定在你原位置，立刻横移离开落点。 多数攻击覆盖正面，真正安全的输出窗口在招式落空后的侧后方。 下劈 抬刀后横向闪避，落地硬直时侧面反击。 旋身挥砍 等他贴近再翻滚或侧移，过早闪避容易被追到。 突刺 蓄力时间较长，等刺出瞬间侧闪。 跳砸 低血量阶段出现，起跳后立即离开原站位。`},{slug:`the-riven-twins`,gameId:`no-rest-for-the-wicked`,categoryLabelZh:`主线 Boss`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Riven+Twins`,notes:[],lastVerifiedAt:`2026-07-09`,name:`The Riven Twins`,category:`main_story`,bossType:`双子大型人形`,optional:`否`,location:[`The Nameless Pass`],quest:[`Servant of God`],weakness:[`火`],strongAgainst:[`瘟疫`],resistantTo:[`无稳定抗性记录`],immuneTo:[`无稳定免疫记录`],rewards:[`随机物品`,`Laquered Bow 概率掉落`,`Fetid Club 概率掉落`,`Plague Ichor`],imageUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-riven-twins-boss-no-rest-for-the-wicked-wiki-guide.jpg`,summary:`用长柄武器压制空间的主线 Boss。难点在于大范围扫击、瘟疫球和地面瘟疫区会逐步限制走位。`,preparation:[`先清支线和探索提升等级，避免低等级硬打。`,`火属性伤害收益较高。`],strategy:[`中近距离重点处理横扫和插地攻击。横扫可向内闪避抢反击，插地动作慢，可侧闪后输出。`,`远距离会用纵向砸地、瘟疫球和连段推进；不要一直后退，避免被逼到场地边缘。`,`后半段会制造瘟疫水泡并留下危险区域，应把水泡引到边缘再回到中心作战。`],attacks:[{name:`长柄横扫`,counter:`熟悉节奏后向 Boss 内侧闪避，结束后立即短连段反击。`},{name:`插地 / 砸地`,counter:`动作慢，侧向离开直线范围即可。`},{name:`瘟疫球`,counter:`看准弹道横移，躲完后利用施法硬直靠近。`},{name:`瘟疫水泡`,counter:`先引到场地边缘，避免安全区域被持续伤害区切碎。`}],searchText:`the riven twins 双子大型人形 主线 boss 用长柄武器压制空间的主线 boss。难点在于大范围扫击、瘟疫球和地面瘟疫区会逐步限制走位。 the nameless pass servant of god 火 随机物品 laquered bow 概率掉落 fetid club 概率掉落 plague ichor 中近距离重点处理横扫和插地攻击。横扫可向内闪避抢反击，插地动作慢，可侧闪后输出。 远距离会用纵向砸地、瘟疫球和连段推进；不要一直后退，避免被逼到场地边缘。 后半段会制造瘟疫水泡并留下危险区域，应把水泡引到边缘再回到中心作战。 长柄横扫 熟悉节奏后向 boss 内侧闪避，结束后立即短连段反击。 插地 / 砸地 动作慢，侧向离开直线范围即可。 瘟疫球 看准弹道横移，躲完后利用施法硬直靠近。 瘟疫水泡 先引到场地边缘，避免安全区域被持续伤害区切碎。`},{slug:`the-caretaker-and-the-tusk`,gameId:`no-rest-for-the-wicked`,categoryLabelZh:`主线 Boss`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Caretaker+and+the+Tusk`,notes:[],lastVerifiedAt:`2026-07-09`,name:`The Caretaker and the Tusk`,category:`main_story`,bossType:`双目标 Boss`,optional:`是/否待复核`,location:[`Temple of Day and Night，Marin Woods`],quest:[`Marin Woods 主线推进`],weakness:[`来源未稳定标注`],strongAgainst:[`来源未稳定标注`],resistantTo:[`来源未稳定标注`],immuneTo:[`来源未稳定标注`],rewards:[`Basic Hide`,`Boar Tusk`,`The Caretaker's Habit`,`Human Bone`,`Plague Ichor`],imageUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-caretaker-the-tusk-boss-nrftw-wiki-guide-300px.jpg`,summary:`照看者与巨兽同时行动的双目标战。攻击源多，优先目标和场地观察比单纯输出更重要。`,preparation:[`使用机动性较好的武器，避免重武器长时间锁动画。`,`保持视角能同时看到 Tusk 和 Caretaker。`],strategy:[`Tusk 冲撞可引向墙面，最后一刻闪开让它撞墙，争取输出窗口。`,`Caretaker 会瞬移并接直线地波、范围震荡或召唤横穿场地的小怪；看到紫色提示先脱离范围。`,`来源说明攻击 Caretaker 时会同时影响 Tusk，可根据当前安全窗口选择攻击 Caretaker 来间接压低 Tusk。`],attacks:[{name:`Tusk 冲撞`,counter:`贴近墙边诱导，最后横向闪避。`},{name:`连续踏地`,counter:`最多多次下砸，看到抬身后先拉开，别急着回头输出。`},{name:`Caretaker 地波`,counter:`地波走直线，横向移动即可避开。`},{name:`召唤穿场生物`,counter:`只沿短直线冲刺，观察路线后侧移。`}],searchText:`the caretaker and the tusk 双目标 boss 主线 boss 照看者与巨兽同时行动的双目标战。攻击源多，优先目标和场地观察比单纯输出更重要。 temple of day and night，marin woods marin woods 主线推进 来源未稳定标注 basic hide boar tusk the caretaker's habit human bone plague ichor tusk 冲撞可引向墙面，最后一刻闪开让它撞墙，争取输出窗口。 caretaker 会瞬移并接直线地波、范围震荡或召唤横穿场地的小怪；看到紫色提示先脱离范围。 来源说明攻击 caretaker 时会同时影响 tusk，可根据当前安全窗口选择攻击 caretaker 来间接压低 tusk。 tusk 冲撞 贴近墙边诱导，最后横向闪避。 连续踏地 最多多次下砸，看到抬身后先拉开，别急着回头输出。 caretaker 地波 地波走直线，横向移动即可避开。 召唤穿场生物 只沿短直线冲刺，观察路线后侧移。`},{slug:`the-lost-huntress`,gameId:`no-rest-for-the-wicked`,categoryLabelZh:`主线 Boss`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Lost+Huntress`,notes:[],lastVerifiedAt:`2026-07-09`,name:`The Lost Huntress`,category:`main_story`,bossType:`兽型变异 Boss`,optional:`是/否待复核`,location:[`Lowland Meadows`],quest:[`The Weeping Sisters`],weakness:[`来源未稳定标注`],strongAgainst:[`来源未稳定标注`],resistantTo:[`来源未稳定标注`],immuneTo:[`来源未稳定标注`],rewards:[`False Noble Gauntlets`,`Plague Ichor`],imageUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-lost-huntress-boss-nrftw-wiki-guide-300px.jpg`,summary:`被瘟疫侵蚀的兽型 Boss。前半段以冲锋、啃咬、拍击为主，半血后加入更大范围的地面爆发。`,preparation:[`优先准备能快速脱离的轻中型武器。`,`保持场地外圈可用，避免被连续冲锋逼到死角。`],strategy:[`三连冲锋和多段啃咬都会在起手时锁定方向，看到起身或后缩时向侧面走位。`,`半血后 Lara 会从怪物口中出现并制造蓝色地面爆点；爆点会跟随玩家，靠近 Boss 诱导后立刻闪出。`,`直线爆发会沿线延伸，等第一段爆开后侧移，不要沿线后退。`],attacks:[{name:`三连冲锋爪击`,counter:`起身锁定后横向跑或侧闪。`},{name:`连续啃咬`,counter:`每次后缩都是提示，拉开或侧闪，不要贴脸硬拼。`},{name:`单次砸地`,counter:`抬身后向侧面闪避。`},{name:`地面爆点 / 爆发线`,counter:`引导到 Boss 附近后离开蓝点；直线爆发侧移处理。`}],searchText:`the lost huntress 兽型变异 boss 主线 boss 被瘟疫侵蚀的兽型 boss。前半段以冲锋、啃咬、拍击为主，半血后加入更大范围的地面爆发。 lowland meadows the weeping sisters 来源未稳定标注 false noble gauntlets plague ichor 三连冲锋和多段啃咬都会在起手时锁定方向，看到起身或后缩时向侧面走位。 半血后 lara 会从怪物口中出现并制造蓝色地面爆点；爆点会跟随玩家，靠近 boss 诱导后立刻闪出。 直线爆发会沿线延伸，等第一段爆开后侧移，不要沿线后退。 三连冲锋爪击 起身锁定后横向跑或侧闪。 连续啃咬 每次后缩都是提示，拉开或侧闪，不要贴脸硬拼。 单次砸地 抬身后向侧面闪避。 地面爆点 / 爆发线 引导到 boss 附近后离开蓝点；直线爆发侧移处理。`},{slug:`the-winged-brood`,gameId:`no-rest-for-the-wicked`,categoryLabelZh:`主线 Boss`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Winged+Brood`,notes:[],lastVerifiedAt:`2026-07-09`,name:`The Winged Brood`,category:`main_story`,bossType:`飞行群体 Boss`,optional:`否`,location:[`Nameless Pass`],quest:[`Faith and Flames`],weakness:[`来源未稳定标注`],strongAgainst:[`来源未稳定标注`],resistantTo:[`来源未稳定标注`],immuneTo:[`来源未稳定标注`],rewards:[`Winged Brood Wing`,`Plague Ichor`,`Ashen Trousers`],imageUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-winged-brood-boss-nrftw-wiki-guide-300px.png`,summary:`三阶段飞行群体战。第一阶段是多只 Winged Brood，后续 Bile Wretch 和 Blood Wraith 会加入。`,preparation:[`准备能快速击杀单体的武器，减少多 Boss 同场时间。`,`阶段转换时优先处理新出现的大型目标。`],strategy:[`第一阶段的小型飞行敌人攻击模式一致，俯冲、爪击、翼扫都能通过观察起飞高度和尖叫动作预判。`,`第二阶段 Bile Wretch 下场后要尽快击杀，否则第三阶段 Blood Wraith 加入会形成双 Boss 压力。`,`不要被飞行目标拖到场地边缘；每次躲完俯冲后回到开阔位置。`],attacks:[{name:`俯冲`,counter:`飞高后会向当前位置俯冲，向前或侧面闪避。`},{name:`爪击`,counter:`低空悬停是提示，向侧面闪避。`},{name:`翼扫`,counter:`尖叫后准备后闪。`},{name:`Bile Wretch 冲锋`,counter:`尖叫后横向闪避，避免被连续推进。`}],searchText:`the winged brood 飞行群体 boss 主线 boss 三阶段飞行群体战。第一阶段是多只 winged brood，后续 bile wretch 和 blood wraith 会加入。 nameless pass faith and flames 来源未稳定标注 winged brood wing plague ichor ashen trousers 第一阶段的小型飞行敌人攻击模式一致，俯冲、爪击、翼扫都能通过观察起飞高度和尖叫动作预判。 第二阶段 bile wretch 下场后要尽快击杀，否则第三阶段 blood wraith 加入会形成双 boss 压力。 不要被飞行目标拖到场地边缘；每次躲完俯冲后回到开阔位置。 俯冲 飞高后会向当前位置俯冲，向前或侧面闪避。 爪击 低空悬停是提示，向侧面闪避。 翼扫 尖叫后准备后闪。 bile wretch 冲锋 尖叫后横向闪避，避免被连续推进。`},{slug:`falstead-darak`,gameId:`no-rest-for-the-wicked`,categoryLabelZh:`支线 Boss`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Falstead+Darak`,notes:[],lastVerifiedAt:`2026-07-09`,name:`Falstead Darak`,category:`side_quest`,bossType:`人形首领`,optional:`是`,location:[`Mariner's Keep`,`The Black Trench`,`Orban Galdes`],quest:[`Of Rats and Raiders`],weakness:[`火`],strongAgainst:[`瘟疫`],resistantTo:[`无稳定抗性记录`],immuneTo:[`无稳定免疫记录`],rewards:[`随机物品`,`Stag of Embers 概率掉落`,`Falstead's Fury`,`Falstead's Barricade`,`Plague Ichor`],imageUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/falstead-derek-boss-no-rest-for-the-wicked-wiki-guide.jpg`,summary:`Risen 首领，支线中会多次交手。招式池不大，但连段有时会追加一两击。`,preparation:[`火属性有效。`,`不要在他第一段连击后立刻贪刀，先确认是否有追加动作。`],strategy:[`第一次交手整体难度较低；核心是等连段完全结束再反击。`,`黑沟重战时压力更高，要把每次攻击后的短暂停顿当成主要输出窗口。`,`他会被固定连段锁住，玩家可以利用这一点绕侧面或背后输出。`],attacks:[{name:`武器连击`,counter:`等最后一击落空后再进攻，避免被追加击打断。`},{name:`前压攻击`,counter:`横向闪避，保持中距离观察。`},{name:`重战阶段压制`,counter:`保留体力，优先处理生存而不是换血。`}],searchText:`falstead darak 人形首领 支线 boss risen 首领，支线中会多次交手。招式池不大，但连段有时会追加一两击。 mariner's keep the black trench orban galdes of rats and raiders 火 随机物品 stag of embers 概率掉落 falstead's fury falstead's barricade plague ichor 第一次交手整体难度较低；核心是等连段完全结束再反击。 黑沟重战时压力更高，要把每次攻击后的短暂停顿当成主要输出窗口。 他会被固定连段锁住，玩家可以利用这一点绕侧面或背后输出。 武器连击 等最后一击落空后再进攻，避免被追加击打断。 前压攻击 横向闪避，保持中距离观察。 重战阶段压制 保留体力，优先处理生存而不是换血。`},{slug:`echo-knight`,gameId:`no-rest-for-the-wicked`,categoryLabelZh:`支线 Boss`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Echo+Knight`,notes:[],lastVerifiedAt:`2026-07-09`,name:`Echo Knight`,category:`side_quest`,bossType:`骑乘人形 Boss`,optional:`是`,location:[`Cerim Crucible`],quest:[`Spoken and Unspoken`],weakness:[`来源未稳定标注`],strongAgainst:[`来源未稳定标注`],resistantTo:[`来源未稳定标注`],immuneTo:[`来源未稳定标注`],rewards:[`随机物品`,`Wind of Death 概率掉落`,`Plague Ichor`],imageUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/echo-knight-boss-no-rest-for-the-wicked-wiki-guide.jpg`,summary:`试炼中的骑乘 Boss。长枪、冲锋、瘟疫球和蓝焰地面限制会不断压缩空间。`,preparation:[`保持耐心，优先规避冲锋和地面蓝焰。`,`使用短硬直武器更容易抓四颗瘟疫球后的窗口。`],strategy:[`开局可能直接冲锋或投掷瘟疫球。若投球，向 Boss 两侧闪避，第四颗后通常有短暂输出机会。`,`冲锋躲过后不要立刻贴近，转身时长枪也可能造成伤害。`,`蓝色火焰会停留一段时间。可以把火焰引到场地边缘，避免核心区域被封锁。`,`低血量时攻击频率增加，瘟疫球、践踏和蓝焰可能连续出现，必须减少贪刀。`],attacks:[{name:`骑乘冲锋`,counter:`横向闪避，等转身动作结束后再靠近。`},{name:`四连瘟疫球`,counter:`向两侧或斜前方闪避，第四颗后反击。`},{name:`长枪快刺`,counter:`第一刺命中后立刻闪第二刺，不要硬直站桩。`},{name:`连续践踏`,counter:`被第一下击倒也不要慌，起身前继续等节奏闪避。`},{name:`蓝焰地面爆发`,counter:`离开脚下爆点，并把残留火焰引到场地边缘。`}],searchText:`echo knight 骑乘人形 boss 支线 boss 试炼中的骑乘 boss。长枪、冲锋、瘟疫球和蓝焰地面限制会不断压缩空间。 cerim crucible spoken and unspoken 来源未稳定标注 随机物品 wind of death 概率掉落 plague ichor 开局可能直接冲锋或投掷瘟疫球。若投球，向 boss 两侧闪避，第四颗后通常有短暂输出机会。 冲锋躲过后不要立刻贴近，转身时长枪也可能造成伤害。 蓝色火焰会停留一段时间。可以把火焰引到场地边缘，避免核心区域被封锁。 低血量时攻击频率增加，瘟疫球、践踏和蓝焰可能连续出现，必须减少贪刀。 骑乘冲锋 横向闪避，等转身动作结束后再靠近。 四连瘟疫球 向两侧或斜前方闪避，第四颗后反击。 长枪快刺 第一刺命中后立刻闪第二刺，不要硬直站桩。 连续践踏 被第一下击倒也不要慌，起身前继续等节奏闪避。 蓝焰地面爆发 离开脚下爆点，并把残留火焰引到场地边缘。`},{slug:`the-unbreakable-egg`,gameId:`no-rest-for-the-wicked`,categoryLabelZh:`支线 Boss`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Unbreakable+Egg`,notes:[`来源页未提供稳定 Boss 图片，后续需从其他可靠来源补图。`],lastVerifiedAt:`2026-07-09`,name:`The Unbreakable Egg`,category:`side_quest`,bossType:`人形镰刀 Boss`,optional:`是`,location:[`Marin Woods`],quest:[`支线 Boss`],weakness:[`来源未稳定标注`],strongAgainst:[`来源未稳定标注`],resistantTo:[`来源未稳定标注`],immuneTo:[`来源未稳定标注`],rewards:[`击败后不直接掉落 Boss 物品`,`后续可开启宝箱：gold、Armor Shard、Crooked Key、Stallion Sentiel Shield、Saltstone、Legs of the Egg、Crown of the Egg、Champion of the Egg、Clutch of the Egg`],imageUrl:``,summary:`羽毛装束、蛋壳头盔、使用镰刀的支线 Boss。招式数量少，但单次伤害高。`,preparation:[`保持横向移动，避免被远距离镰刀投掷贯穿。`,`不要在四连挥砍中途反击。`],strategy:[`镰刀投掷覆盖距离很长，向侧面跑比后退更稳定。`,`四连挥砍之间有短暂停顿，等完整四段结束后再输出。`,`跳砸接旋身挥击需要整体躲开；看到跳到最高点时立刻向远端移动。`],attacks:[{name:`双向镰刀投掷`,counter:`向侧面跑或闪，不要沿直线后退。`},{name:`四连挥砍`,counter:`观察抬武器节奏，完整结束后再进场。`},{name:`跳砸接旋身`,counter:`跳到高点时远离落点，继续避开后续挥击。`}],searchText:`the unbreakable egg 人形镰刀 boss 支线 boss 羽毛装束、蛋壳头盔、使用镰刀的支线 boss。招式数量少，但单次伤害高。 marin woods 支线 boss 来源未稳定标注 击败后不直接掉落 boss 物品 后续可开启宝箱：gold、armor shard、crooked key、stallion sentiel shield、saltstone、legs of the egg、crown of the egg、champion of the egg、clutch of the egg 镰刀投掷覆盖距离很长，向侧面跑比后退更稳定。 四连挥砍之间有短暂停顿，等完整四段结束后再输出。 跳砸接旋身挥击需要整体躲开；看到跳到最高点时立刻向远端移动。 双向镰刀投掷 向侧面跑或闪，不要沿直线后退。 四连挥砍 观察抬武器节奏，完整结束后再进场。 跳砸接旋身 跳到高点时远离落点，继续避开后续挥击。`}],Kr=[{slug:`drone-trap`,gameId:`no-rest-for-the-wicked`,name:`Drone Trap`,description:`Dodge through the air and thrust your weapon onto the target`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`All Weapons (Except Bows)`,whereToFind:`Purchased from Illaria`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`drone-trap no-rest-for-the-wicked drone trap dodge through the air and thrust your weapon onto the target 50 focus ranged all weapons (except bows) purchased from illaria https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`dropkick`,gameId:`no-rest-for-the-wicked`,name:`Dropkick`,description:`Flying kick — 1500% Physical, +20 Poise Dmg, +150% Kickback.`,cost:`30 Stamina`,attackType:`Melee`,compatibleWeaponType:`All Weapons (Except Bows)`,whereToFind:`Purchased from Illaria`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`dropkick no-rest-for-the-wicked dropkick flying kick — 1500% physical, +20 poise dmg, +150% kickback. 30 stamina melee all weapons (except bows) purchased from illaria https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`frontflip-kick`,gameId:`no-rest-for-the-wicked`,name:`Frontflip Kick`,description:`Somersault stomp — 1500% Physical, +10 Poise Dmg, +150% Kickback.`,cost:`20 Stamina`,attackType:`Melee`,compatibleWeaponType:`All Weapons (Except Bows)`,whereToFind:`Purchased from Illaria`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`frontflip-kick no-rest-for-the-wicked frontflip kick somersault stomp — 1500% physical, +10 poise dmg, +150% kickback. 20 stamina melee all weapons (except bows) purchased from illaria https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`regurgitate`,gameId:`no-rest-for-the-wicked`,name:`Regurgitate`,description:`Toxic bile stream; poisons and leaves a 25s plague pool.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`All Weapons (Except Bows)`,whereToFind:`Purchased from The Seneschal`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`regurgitate no-rest-for-the-wicked regurgitate toxic bile stream; poisons and leaves a 25s plague pool. 50 focus ranged all weapons (except bows) purchased from the seneschal https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`swipe-kick`,gameId:`no-rest-for-the-wicked`,name:`Swipe Kick`,description:`Spinning roundhouse — 3000% Physical, +10 Poise Dmg, +150% Kickback.`,cost:`40 Stamina`,attackType:`Melee`,compatibleWeaponType:`All Weapons (Except Bows)`,whereToFind:`Purchased from Illaria`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`swipe-kick no-rest-for-the-wicked swipe kick spinning roundhouse — 3000% physical, +10 poise dmg, +150% kickback. 40 stamina melee all weapons (except bows) purchased from illaria https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`throw-axe`,gameId:`no-rest-for-the-wicked`,name:`Throw Axe`,description:`Homing spinning axe — Physical, -30% More, +20 Poise Dmg, +100% Kickback.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`All Weapons (Except Bows)`,whereToFind:`Purchased from Illaria`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`throw-axe no-rest-for-the-wicked throw axe homing spinning axe — physical, -30% more, +20 poise dmg, +100% kickback. 50 focus ranged all weapons (except bows) purchased from illaria https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`throw-knife`,gameId:`no-rest-for-the-wicked`,name:`Throw Knife`,description:`Homing knife — Physical, no modifier, +10 Poise Dmg, +100% Kickback.`,cost:`25 Focus`,attackType:`Ranged`,compatibleWeaponType:`All Weapons (Except Bows)`,whereToFind:`Purchased from Illaria`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`throw-knife no-rest-for-the-wicked throw knife homing knife — physical, no modifier, +10 poise dmg, +100% kickback. 25 focus ranged all weapons (except bows) purchased from illaria https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`turnback-kick`,gameId:`no-rest-for-the-wicked`,name:`Turnback Kick`,description:`Backward kick — 2000% Physical, +10 Poise Dmg, +200% Kickback.`,cost:`30 Stamina`,attackType:`Melee`,compatibleWeaponType:`All Weapons (Except Bows)`,whereToFind:`Purchased from Illaria`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`turnback-kick no-rest-for-the-wicked turnback kick backward kick — 2000% physical, +10 poise dmg, +200% kickback. 30 stamina melee all weapons (except bows) purchased from illaria https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`arrowstorm`,gameId:`no-rest-for-the-wicked`,name:`Arrowstorm`,description:`Signal arrow calls down a rain of 10 homing arrows (x2 at Charge 2).`,cost:`150 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Fungus Strung Bow`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`arrowstorm no-rest-for-the-wicked arrowstorm signal arrow calls down a rain of 10 homing arrows (x2 at charge 2). 150 focus ranged bows extracted from fungus strung bow https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`breakstep`,gameId:`no-rest-for-the-wicked`,name:`Breakstep`,description:`Kicks target back then fires 3 quick arrows.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`breakstep no-rest-for-the-wicked breakstep kicks target back then fires 3 quick arrows. 100 focus ranged bows tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`cone-shot`,gameId:`no-rest-for-the-wicked`,name:`Cone Shot`,description:`Fans 9 arrows in a tight cone (-20% More).`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Siren's Call`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`cone-shot no-rest-for-the-wicked cone shot fans 9 arrows in a tight cone (-20% more). 100 focus ranged bows extracted from siren's call https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`crosscut`,gameId:`no-rest-for-the-wicked`,name:`Crosscut`,description:`Two sweeping cuts then somersaults away and fires a parting shot.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`crosscut no-rest-for-the-wicked crosscut two sweeping cuts then somersaults away and fires a parting shot. 100 focus ranged bows tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`evasive-shot`,gameId:`no-rest-for-the-wicked`,name:`Evasive Shot`,description:`Leaps backward and fires simultaneously — 200% Physical, +200% Kickback.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Twined Recurve Bow`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`evasive-shot no-rest-for-the-wicked evasive shot leaps backward and fires simultaneously — 200% physical, +200% kickback. 50 focus ranged bows extracted from twined recurve bow https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`flipkick-burst`,gameId:`no-rest-for-the-wicked`,name:`Flipkick Burst`,description:`Upward kick into backflip releases 5 homing arrows (50% More each).`,cost:`125 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Pale Ash`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`flipkick-burst no-rest-for-the-wicked flipkick burst upward kick into backflip releases 5 homing arrows (50% more each). 125 focus ranged bows extracted from pale ash https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`glideburst`,gameId:`no-rest-for-the-wicked`,name:`Glideburst`,description:`Slides forward firing 3 quick arrows.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Woodland Protector`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`glideburst no-rest-for-the-wicked glideburst slides forward firing 3 quick arrows. 100 focus ranged bows extracted from woodland protector https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`knockout-shot`,gameId:`no-rest-for-the-wicked`,name:`Knockout Shot`,description:`Single arrow — 300% Physical, +200% Kickback, Knocks Down, Breaks Block.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Patience`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`knockout-shot no-rest-for-the-wicked knockout shot single arrow — 300% physical, +200% kickback, knocks down, breaks block. 100 focus ranged bows extracted from patience https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`multi-shot`,gameId:`no-rest-for-the-wicked`,name:`Multi Shot`,description:`Rapid volley of 3-10 homing arrows (10% More each).`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Yew Longbow`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`multi-shot no-rest-for-the-wicked multi shot rapid volley of 3-10 homing arrows (10% more each). 100 focus ranged bows extracted from yew longbow https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`retreating-trimshot`,gameId:`no-rest-for-the-wicked`,name:`Retreating Trimshot`,description:`Backflips away while firing 6 arrows (30% More each).`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Balak Talon`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`retreating-trimshot no-rest-for-the-wicked retreating trimshot backflips away while firing 6 arrows (30% more each). 100 focus ranged bows extracted from balak talon https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`skyburst-volley`,gameId:`no-rest-for-the-wicked`,name:`Skyburst Volley`,description:`Launches into air, fires 5 spreading arrows downward (70% More each).`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Answered Prayer`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`skyburst-volley no-rest-for-the-wicked skyburst volley launches into air, fires 5 spreading arrows downward (70% more each). 100 focus ranged bows extracted from answered prayer https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`skyfall-shot`,gameId:`no-rest-for-the-wicked`,name:`Skyfall Shot`,description:`Jumps high and plunges arrow down; shockwave on impact.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Short Bow`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`skyfall-shot no-rest-for-the-wicked skyfall shot jumps high and plunges arrow down; shockwave on impact. 50 focus ranged bows extracted from short bow https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`firefall`,gameId:`no-rest-for-the-wicked`,name:`Firefall`,description:`Vaults up and drives an arrow into the ground, igniting the area.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`firefall no-rest-for-the-wicked firefall vaults up and drives an arrow into the ground, igniting the area. 100 focus ranged bows tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`skybreaker`,gameId:`no-rest-for-the-wicked`,name:`Skybreaker`,description:`Leaps up and drives an arrow down; triggers a lightning strike on nearby enemies.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Twinkling Short Bow`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`skybreaker no-rest-for-the-wicked skybreaker leaps up and drives an arrow down; triggers a lightning strike on nearby enemies. 50 focus ranged bows extracted from twinkling short bow https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-arrow`,gameId:`no-rest-for-the-wicked`,name:`Fire Arrow`,description:`Flaming arrow; fully charged hits 130% More with +10 Poise Dmg.`,cost:`20 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Lacquered Bow`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`fire-arrow no-rest-for-the-wicked fire arrow flaming arrow; fully charged hits 130% more with +10 poise dmg. 20 focus ranged bows extracted from lacquered bow https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`ice-arrow`,gameId:`no-rest-for-the-wicked`,name:`Ice Arrow`,description:`Frost-enchanted shot — 30% More Ice Damage.`,cost:`20 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Lacquered Bow`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`ice-arrow no-rest-for-the-wicked ice arrow frost-enchanted shot — 30% more ice damage. 20 focus ranged bows extracted from lacquered bow https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-arrow`,gameId:`no-rest-for-the-wicked`,name:`Lightning Arrow`,description:`Electrified arrow — 30% More Lightning Damage.`,cost:`20 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Lacquered Bow`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`lightning-arrow no-rest-for-the-wicked lightning arrow electrified arrow — 30% more lightning damage. 20 focus ranged bows extracted from lacquered bow https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-arrow`,gameId:`no-rest-for-the-wicked`,name:`Plague Arrow`,description:`Toxic arrow — 30% More Plague Damage.`,cost:`20 Focus`,attackType:`Ranged`,compatibleWeaponType:`Bows`,whereToFind:`Extracted from Lacquered Bow`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-arrow no-rest-for-the-wicked plague arrow toxic arrow — 30% more plague damage. 20 focus ranged bows extracted from lacquered bow https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`dashing-stab`,gameId:`no-rest-for-the-wicked`,name:`Dashing Stab`,description:`13-hit rapid piercing series at reduced power (-70% More per hit).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Double Daggers`,whereToFind:`Extracted from Chipped Daggers`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`dashing-stab no-rest-for-the-wicked dashing stab 13-hit rapid piercing series at reduced power (-70% more per hit). 100 focus melee dual wielding double daggers extracted from chipped daggers https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`double-take`,gameId:`no-rest-for-the-wicked`,name:`Double Take`,description:`Double strike Knocks Down (50% More x2), plus two lighter follow-up hits.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Double Daggers`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`double-take no-rest-for-the-wicked double take double strike knocks down (50% more x2), plus two lighter follow-up hits. 100 focus melee dual wielding double daggers tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`dual-breaker`,gameId:`no-rest-for-the-wicked`,name:`Dual Breaker`,description:`Cross-slash with Bleed Damage — 150% More x2, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Double Daggers`,whereToFind:`Extracted from Brothers Keepers`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`dual-breaker no-rest-for-the-wicked dual breaker cross-slash with bleed damage — 150% more x2, breaks block. 100 focus melee dual wielding double daggers extracted from brothers keepers https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`dual-flurry`,gameId:`no-rest-for-the-wicked`,name:`Dual Flurry`,description:`12-hit barrage at -85% More per hit — pure sustained pressure.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Double Daggers`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`dual-flurry no-rest-for-the-wicked dual flurry 12-hit barrage at -85% more per hit — pure sustained pressure. 50 focus melee dual wielding double daggers tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`dual-slash`,gameId:`no-rest-for-the-wicked`,name:`Dual Slash`,description:`Two-hit overhead combo — 100% More on first hit.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Double Daggers`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`dual-slash no-rest-for-the-wicked dual slash two-hit overhead combo — 100% more on first hit. 50 focus melee dual wielding double daggers tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`piercing-dodge`,gameId:`no-rest-for-the-wicked`,name:`Piercing Dodge`,description:`Dodge an attack then counter with a 2-hit pierce (100% More each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Double Daggers`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`piercing-dodge no-rest-for-the-wicked piercing dodge dodge an attack then counter with a 2-hit pierce (100% more each). 100 focus melee dual wielding double daggers tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`tornado-spin`,gameId:`no-rest-for-the-wicked`,name:`Tornado Spin`,description:`Block-breaking whirlwind — 6 hits, -25% More, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Double Daggers`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`tornado-spin no-rest-for-the-wicked tornado spin block-breaking whirlwind — 6 hits, -25% more, breaks block. 100 focus melee dual wielding double daggers tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`wild-rush`,gameId:`no-rest-for-the-wicked`,name:`Wild Rush`,description:`Charge forward with 6 rapid dagger strikes (30% More each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Double Daggers`,whereToFind:`Extracted from Butcher's Work`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`wild-rush no-rest-for-the-wicked wild rush charge forward with 6 rapid dagger strikes (30% more each). 100 focus melee dual wielding double daggers extracted from butcher's work https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-claw`,gameId:`no-rest-for-the-wicked`,name:`Lightning Claw`,description:`Dash + 4 rapid lightning claw strikes (25% More each).`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Double Daggers`,whereToFind:`Extracted from Ash Soothed Daggers`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`lightning-claw no-rest-for-the-wicked lightning claw dash + 4 rapid lightning claw strikes (25% more each). 50 focus melee dual wielding double daggers extracted from ash soothed daggers https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`bare-knuckle`,gameId:`no-rest-for-the-wicked`,name:`Bare Knuckle`,description:`Lunging haymaker — 300% Physical, +20 Poise Dmg, +200% Kickback, Knocks Down.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`bare-knuckle no-rest-for-the-wicked bare knuckle lunging haymaker — 300% physical, +20 poise dmg, +200% kickback, knocks down. 100 focus melee dual wielding gauntlets tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`breakrush`,gameId:`no-rest-for-the-wicked`,name:`Breakrush`,description:`Five-hit punch barrage (75% More each, +10 Poise Dmg).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`Extracted from Crystal Fist`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`breakrush no-rest-for-the-wicked breakrush five-hit punch barrage (75% more each, +10 poise dmg). 100 focus melee dual wielding gauntlets extracted from crystal fist https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`buster-rift`,gameId:`no-rest-for-the-wicked`,name:`Buster Rift`,description:`Ground tremor wave + heavier follow-up slide strike (75% / 375% More).`,cost:`125 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`Extracted from Shellguard Gauntlets`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`buster-rift no-rest-for-the-wicked buster rift ground tremor wave + heavier follow-up slide strike (75% / 375% more). 125 focus melee dual wielding gauntlets extracted from shellguard gauntlets https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`cyclone-kick`,gameId:`no-rest-for-the-wicked`,name:`Cyclone Kick`,description:`Aerial 3-hit sweeping kick (150% More each, +150% Kickback).`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`Extracted from Nith Grovebinders`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`cyclone-kick no-rest-for-the-wicked cyclone kick aerial 3-hit sweeping kick (150% more each, +150% kickback). 50 focus melee dual wielding gauntlets extracted from nith grovebinders https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`dragonfly-kick`,gameId:`no-rest-for-the-wicked`,name:`Dragonfly Kick`,description:`Arc up and dive foot-first — 2-hit (100% More each, +150% Kickback).`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`Extracted from Gossamer Gauntlets`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`dragonfly-kick no-rest-for-the-wicked dragonfly kick arc up and dive foot-first — 2-hit (100% more each, +150% kickback). 50 focus melee dual wielding gauntlets extracted from gossamer gauntlets https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`drive-break`,gameId:`no-rest-for-the-wicked`,name:`Drive Break`,description:`Charge and single crushing punch — 300% Physical, +200% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`drive-break no-rest-for-the-wicked drive break charge and single crushing punch — 300% physical, +200% kickback. 50 focus melee dual wielding gauntlets tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`recoil-strike`,gameId:`no-rest-for-the-wicked`,name:`Recoil Strike`,description:`Dash back then rising uppercut — 500% Physical, +200% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`recoil-strike no-rest-for-the-wicked recoil strike dash back then rising uppercut — 500% physical, +200% kickback. 50 focus melee dual wielding gauntlets tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`skyfall-smash`,gameId:`no-rest-for-the-wicked`,name:`Skyfall Smash`,description:`Leaps and crashes down — 450% Physical x2 + shockwave, +20 Poise Dmg.`,cost:`125 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`Extracted from Emerald Talons`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`skyfall-smash no-rest-for-the-wicked skyfall smash leaps and crashes down — 450% physical x2 + shockwave, +20 poise dmg. 125 focus melee dual wielding gauntlets extracted from emerald talons https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`tempest-kick`,gameId:`no-rest-for-the-wicked`,name:`Tempest Kick`,description:`Aerial 6-hit spinning kick assault, +10 Poise Dmg, +100% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`tempest-kick no-rest-for-the-wicked tempest kick aerial 6-hit spinning kick assault, +10 poise dmg, +100% kickback. 50 focus melee dual wielding gauntlets tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`tremor-wave`,gameId:`no-rest-for-the-wicked`,name:`Tremor Wave`,description:`Ground punch sends shockwave — 350% Physical, +10 Poise Dmg, +100% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`Extracted from Deadfang`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`tremor-wave no-rest-for-the-wicked tremor wave ground punch sends shockwave — 350% physical, +10 poise dmg, +100% kickback. 50 focus melee dual wielding gauntlets extracted from deadfang https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-retch`,gameId:`no-rest-for-the-wicked`,name:`Plague Retch`,description:`Evade backward then fire homing plague projectile — 300% More, +150% Kickback.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`Extracted from Cursed Unguis`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-retch no-rest-for-the-wicked plague retch evade backward then fire homing plague projectile — 300% more, +150% kickback. 50 focus ranged dual wielding gauntlets extracted from cursed unguis https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`rising-fang`,gameId:`no-rest-for-the-wicked`,name:`Rising Fang`,description:`Blazing uppercut — 200% Fire, +200% Kickback, Knocks Down.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`Extracted from Sun's Scorn`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`rising-fang no-rest-for-the-wicked rising fang blazing uppercut — 200% fire, +200% kickback, knocks down. 50 focus melee dual wielding gauntlets extracted from sun's scorn https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`spirit-burst`,gameId:`no-rest-for-the-wicked`,name:`Spirit Burst`,description:`Focused lightning fist projectile — 300% Lightning, +20 Poise Dmg, +150% Kickback.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`Dual Wielding Gauntlets`,whereToFind:`Extracted from Woven Wraps`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`spirit-burst no-rest-for-the-wicked spirit burst focused lightning fist projectile — 300% lightning, +20 poise dmg, +150% kickback. 50 focus ranged dual wielding gauntlets extracted from woven wraps https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`advancing-flurry`,gameId:`no-rest-for-the-wicked`,name:`Advancing Flurry`,description:`Push through enemies with 4 rapid hits (+20 Poise Dmg, +100% Kickback each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Reclaimer`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`advancing-flurry no-rest-for-the-wicked advancing flurry push through enemies with 4 rapid hits (+20 poise dmg, +100% kickback each). 100 focus melee one-handed weapons extracted from reclaimer https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`air-dodge`,gameId:`no-rest-for-the-wicked`,name:`Air Dodge`,description:`Roll through air to dodge, then counter stab — 300% Physical, +200% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Moonshaft`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`air-dodge no-rest-for-the-wicked air dodge roll through air to dodge, then counter stab — 300% physical, +200% kickback. 100 focus melee one-handed weapons extracted from moonshaft https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`brutal-reprise`,gameId:`no-rest-for-the-wicked`,name:`Brutal Reprise`,description:`Three heavy swings (+10 Poise Dmg, +100% Kickback each).`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Blacksmith's Folly`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`brutal-reprise no-rest-for-the-wicked brutal reprise three heavy swings (+10 poise dmg, +100% kickback each). 50 focus melee one-handed weapons extracted from blacksmith's folly https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`charge-strike`,gameId:`no-rest-for-the-wicked`,name:`Charge Strike`,description:`Dash + devastating hit — 300% Physical, +200% Kickback, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Grimacing Stone`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`charge-strike no-rest-for-the-wicked charge strike dash + devastating hit — 300% physical, +200% kickback, breaks block. 100 focus melee one-handed weapons extracted from grimacing stone https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`circular`,gameId:`no-rest-for-the-wicked`,name:`Circular`,description:`Two wide arc spins — 100% Physical x2, +20 Poise Dmg, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Broken Forge`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`circular no-rest-for-the-wicked circular two wide arc spins — 100% physical x2, +20 poise dmg, breaks block. 100 focus melee one-handed weapons extracted from broken forge https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`crush`,gameId:`no-rest-for-the-wicked`,name:`Crush`,description:`Overhead spin into ground slam — 200% Physical, Knocks Down, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Petaled Spear`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`crush no-rest-for-the-wicked crush overhead spin into ground slam — 200% physical, knocks down, breaks block. 100 focus melee one-handed weapons extracted from petaled spear https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`crushing-flurry`,gameId:`no-rest-for-the-wicked`,name:`Crushing Flurry`,description:`Six heavy swings (-20% More each, +10 Poise Dmg, +50% Kickback).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Nail-Laden Club`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`crushing-flurry no-rest-for-the-wicked crushing flurry six heavy swings (-20% more each, +10 poise dmg, +50% kickback). 100 focus melee one-handed weapons extracted from nail-laden club https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`double-spin`,gameId:`no-rest-for-the-wicked`,name:`Double Spin`,description:`Two spinning block-breaking hits (35% More each, +100% Kickback).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Governor's Dagger`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`double-spin no-rest-for-the-wicked double spin two spinning block-breaking hits (35% more each, +100% kickback). 100 focus melee one-handed weapons extracted from governor's dagger https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`evasive-pierce`,gameId:`no-rest-for-the-wicked`,name:`Evasive Pierce`,description:`Knockdown hit then immediately retreat — 300% Physical, +200% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Tucked Falcon`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`evasive-pierce no-rest-for-the-wicked evasive pierce knockdown hit then immediately retreat — 300% physical, +200% kickback. 100 focus melee one-handed weapons extracted from tucked falcon https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`evasive-strike`,gameId:`no-rest-for-the-wicked`,name:`Evasive Strike`,description:`Step right + quick powerful strike — 150% Physical, +20 Poise Dmg, +100% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Spirit Edge`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`evasive-strike no-rest-for-the-wicked evasive strike step right + quick powerful strike — 150% physical, +20 poise dmg, +100% kickback. 50 focus melee one-handed weapons extracted from spirit edge https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`evasive-swing`,gameId:`no-rest-for-the-wicked`,name:`Evasive Swing`,description:`Step left while swinging in evasive arc — 300% Physical, +100% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Tortured Blade`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`evasive-swing no-rest-for-the-wicked evasive swing step left while swinging in evasive arc — 300% physical, +100% kickback. 100 focus melee one-handed weapons extracted from tortured blade https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fierce-dash`,gameId:`no-rest-for-the-wicked`,name:`Fierce Dash`,description:`Burst forward and stab to knock down — 300% Physical, Knocks Down.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from A Singular Purpose`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`fierce-dash no-rest-for-the-wicked fierce dash burst forward and stab to knock down — 300% physical, knocks down. 100 focus melee one-handed weapons extracted from a singular purpose https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`gyro-slash`,gameId:`no-rest-for-the-wicked`,name:`Gyro Slash`,description:`Spin forward slicing twice — 35% Physical x2, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Gnarled Harpoon`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`gyro-slash no-rest-for-the-wicked gyro slash spin forward slicing twice — 35% physical x2, breaks block. 100 focus melee one-handed weapons extracted from gnarled harpoon https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`jump-cut`,gameId:`no-rest-for-the-wicked`,name:`Jump Cut`,description:`Leap + block-breaking downward slash — 300% Physical, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Wooden Sword`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`jump-cut no-rest-for-the-wicked jump cut leap + block-breaking downward slash — 300% physical, breaks block. 100 focus melee one-handed weapons extracted from wooden sword https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`leap`,gameId:`no-rest-for-the-wicked`,name:`Leap`,description:`Jump forward + block-breaking slam — 300% Physical, +20 Poise Dmg, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Singing Peal`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`leap no-rest-for-the-wicked leap jump forward + block-breaking slam — 300% physical, +20 poise dmg, breaks block. 100 focus melee one-handed weapons extracted from singing peal https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`overrun`,gameId:`no-rest-for-the-wicked`,name:`Overrun`,description:`Three-hit combo ending in full-body lunge (50% More each, +130% Kickback).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Whetted Wedge`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`overrun no-rest-for-the-wicked overrun three-hit combo ending in full-body lunge (50% more each, +130% kickback). 100 focus melee one-handed weapons extracted from whetted wedge https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`piercing-dash`,gameId:`no-rest-for-the-wicked`,name:`Piercing Dash`,description:`Dash + deep penetrating strike — 300% Physical, +150% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Hunter's Knife`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`piercing-dash no-rest-for-the-wicked piercing dash dash + deep penetrating strike — 300% physical, +150% kickback. 100 focus melee one-handed weapons extracted from hunter's knife https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`piercing-flurry`,gameId:`no-rest-for-the-wicked`,name:`Piercing Flurry`,description:`Eight-hit alternating rapid pierce sequence.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Pig Sticker`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`piercing-flurry no-rest-for-the-wicked piercing flurry eight-hit alternating rapid pierce sequence. 100 focus melee one-handed weapons extracted from pig sticker https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`piercing-spin`,gameId:`no-rest-for-the-wicked`,name:`Piercing Spin`,description:`Double spinning strike — Knocks Down, Breaks Block, +200% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`piercing-spin no-rest-for-the-wicked piercing spin double spinning strike — knocks down, breaks block, +200% kickback. 50 focus melee one-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`slamdown`,gameId:`no-rest-for-the-wicked`,name:`Slamdown`,description:`Leap + area crash — 200% Physical, +20 Poise Dmg, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Governor's Sword`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`slamdown no-rest-for-the-wicked slamdown leap + area crash — 200% physical, +20 poise dmg, breaks block. 100 focus melee one-handed weapons extracted from governor's sword https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`slashing-dash`,gameId:`no-rest-for-the-wicked`,name:`Slashing Dash`,description:`Dash + heavy slash — 300% Physical, +200% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from The Last Word`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`slashing-dash no-rest-for-the-wicked slashing dash dash + heavy slash — 300% physical, +200% kickback. 100 focus melee one-handed weapons extracted from the last word https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`slashing-dodge`,gameId:`no-rest-for-the-wicked`,name:`Slashing Dodge`,description:`Step back + block-breaking slash lunge — 300% Physical, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Nith Blade`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`slashing-dodge no-rest-for-the-wicked slashing dodge step back + block-breaking slash lunge — 300% physical, breaks block. 100 focus melee one-handed weapons extracted from nith blade https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`slashing-flurry`,gameId:`no-rest-for-the-wicked`,name:`Slashing Flurry`,description:`Six rapid slashes (-60% More each, +10 Poise Dmg, +50% Kickback).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Cerulean Blade`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`slashing-flurry no-rest-for-the-wicked slashing flurry six rapid slashes (-60% more each, +10 poise dmg, +50% kickback). 100 focus melee one-handed weapons extracted from cerulean blade https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`slashing-pirouette`,gameId:`no-rest-for-the-wicked`,name:`Slashing Pirouette`,description:`Graceful 2-hit pirouette — 100% More each, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Etched Yatagan`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`slashing-pirouette no-rest-for-the-wicked slashing pirouette graceful 2-hit pirouette — 100% more each, breaks block. 100 focus melee one-handed weapons extracted from etched yatagan https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`spin`,gameId:`no-rest-for-the-wicked`,name:`Spin`,description:`Two-hit wheel sweep — 100% More each, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Blood-Rusted Sword`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`spin no-rest-for-the-wicked spin two-hit wheel sweep — 100% more each, breaks block. 100 focus melee one-handed weapons extracted from blood-rusted sword https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`surge-slash`,gameId:`no-rest-for-the-wicked`,name:`Surge Slash`,description:`Spinning charge — 100% Physical, Knocks Down, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Malice`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`surge-slash no-rest-for-the-wicked surge slash spinning charge — 100% physical, knocks down, breaks block. 100 focus melee one-handed weapons extracted from malice https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`taunt-strike`,gameId:`no-rest-for-the-wicked`,name:`Taunt Strike`,description:`Taunt enemies then land block-breaking blow — 500% Physical.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Ripper`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`taunt-strike no-rest-for-the-wicked taunt strike taunt enemies then land block-breaking blow — 500% physical. 100 focus melee one-handed weapons extracted from ripper https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`throw`,gameId:`no-rest-for-the-wicked`,name:`Throw`,description:`Hurl weapon through enemies and return — 50% Physical x2.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`throw no-rest-for-the-wicked throw hurl weapon through enemies and return — 50% physical x2. 50 focus ranged one-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`thrust`,gameId:`no-rest-for-the-wicked`,name:`Thrust`,description:`Forward thrust — 100% Physical, Knocks Down, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Cleric's Mace`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`thrust no-rest-for-the-wicked thrust forward thrust — 100% physical, knocks down, breaks block. 100 focus melee one-handed weapons extracted from cleric's mace https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`tornado-strike`,gameId:`no-rest-for-the-wicked`,name:`Tornado Strike`,description:`Rapid axis spin — 3 block-breaking hits (+10 Poise Dmg, +100% Kickback).`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Harvester's Bonesaw`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`tornado-strike no-rest-for-the-wicked tornado strike rapid axis spin — 3 block-breaking hits (+10 poise dmg, +100% kickback). 50 focus melee one-handed weapons extracted from harvester's bonesaw https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`trinity-barrage`,gameId:`no-rest-for-the-wicked`,name:`Trinity Barrage`,description:`Three consecutive strikes (25% More each, +100% Kickback).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Brutal Maul`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`trinity-barrage no-rest-for-the-wicked trinity barrage three consecutive strikes (25% more each, +100% kickback). 100 focus melee one-handed weapons extracted from brutal maul https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`triple-swipe`,gameId:`no-rest-for-the-wicked`,name:`Triple Swipe`,description:`Three block-breaking slashes (50% More each, +100% Kickback).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`triple-swipe no-rest-for-the-wicked triple swipe three block-breaking slashes (50% more each, +100% kickback). 100 focus melee one-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`twirl-dash`,gameId:`no-rest-for-the-wicked`,name:`Twirl Dash`,description:`Spiral dash with 5 block-breaking spinning strikes (-50% More each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Scimitar`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`twirl-dash no-rest-for-the-wicked twirl dash spiral dash with 5 block-breaking spinning strikes (-50% more each). 100 focus melee one-handed weapons extracted from scimitar https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`twirl-spin`,gameId:`no-rest-for-the-wicked`,name:`Twirl Spin`,description:`Two-hit spinning whirlwind — 150% More each, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Assegai`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`twirl-spin no-rest-for-the-wicked twirl spin two-hit spinning whirlwind — 150% more each, breaks block. 100 focus melee one-handed weapons extracted from assegai https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`whirl`,gameId:`no-rest-for-the-wicked`,name:`Whirl`,description:`Six rapid spins hitting all nearby enemies (-30% More each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Tongue Splitter`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`whirl no-rest-for-the-wicked whirl six rapid spins hitting all nearby enemies (-30% more each). 100 focus melee one-handed weapons extracted from tongue splitter https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`whirlstep-strike`,gameId:`no-rest-for-the-wicked`,name:`Whirlstep Strike`,description:`Two-hit whirl with heavy impact (150% More each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Rostock`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`whirlstep-strike no-rest-for-the-wicked whirlstep strike two-hit whirl with heavy impact (150% more each). 100 focus melee one-handed weapons extracted from rostock https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`blazing-rupture`,gameId:`no-rest-for-the-wicked`,name:`Blazing Rupture`,description:`Ground smash fire burst + spinning fire arc — 200% Fire each.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Unholy Hearth`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`blazing-rupture no-rest-for-the-wicked blazing rupture ground smash fire burst + spinning fire arc — 200% fire each. 100 focus melee one-handed weapons extracted from unholy hearth https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-dash`,gameId:`no-rest-for-the-wicked`,name:`Fire Dash`,description:`Flame-wreathed dash — 250% Fire, +20 Poise Dmg, +200% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`fire-dash no-rest-for-the-wicked fire dash flame-wreathed dash — 250% fire, +20 poise dmg, +200% kickback. 100 focus melee one-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-flurry`,gameId:`no-rest-for-the-wicked`,name:`Fire Flurry`,description:`Six rapid fiery strikes (-60% More each, +20 Poise Dmg, +50% Kickback).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Coiled Dawn`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`fire-flurry no-rest-for-the-wicked fire flurry six rapid fiery strikes (-60% more each, +20 poise dmg, +50% kickback). 100 focus melee one-handed weapons extracted from coiled dawn https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-throw`,gameId:`no-rest-for-the-wicked`,name:`Fire Throw`,description:`Fling flaming weapon through enemies and return — 25% Fire x2.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Climber's Pick`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`fire-throw no-rest-for-the-wicked fire throw fling flaming weapon through enemies and return — 25% fire x2. 50 focus ranged one-handed weapons extracted from climber's pick https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-whirl`,gameId:`no-rest-for-the-wicked`,name:`Fire Whirl`,description:`Six-hit fiery whirlwind — Breaks Block each hit.`,cost:`150 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Talwar`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`fire-whirl no-rest-for-the-wicked fire whirl six-hit fiery whirlwind — breaks block each hit. 150 focus melee one-handed weapons extracted from talwar https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`frost-dash`,gameId:`no-rest-for-the-wicked`,name:`Frost Dash`,description:`Frost-cloaked dash — 250% Ice, +20 Poise Dmg, +150% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Jackknife`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`frost-dash no-rest-for-the-wicked frost dash frost-cloaked dash — 250% ice, +20 poise dmg, +150% kickback. 100 focus melee one-handed weapons extracted from jackknife https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`frost-strike`,gameId:`no-rest-for-the-wicked`,name:`Frost Strike`,description:`Ice-infused single hit — 50% Ice, +20 Poise Dmg, +100% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Jade-Spined Axe`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`frost-strike no-rest-for-the-wicked frost strike ice-infused single hit — 50% ice, +20 poise dmg, +100% kickback. 50 focus melee one-handed weapons extracted from jade-spined axe https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`ice-throw`,gameId:`no-rest-for-the-wicked`,name:`Ice Throw`,description:`Hurl ice-coated weapon and return — 25% Ice x2, Breaks Block.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Risen Blade`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`ice-throw no-rest-for-the-wicked ice throw hurl ice-coated weapon and return — 25% ice x2, breaks block. 50 focus ranged one-handed weapons extracted from risen blade https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`ice-whirl`,gameId:`no-rest-for-the-wicked`,name:`Ice Whirl`,description:`Six-hit icy whirlwind — Breaks Block each hit.`,cost:`150 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Sacrament's Sin`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`ice-whirl no-rest-for-the-wicked ice whirl six-hit icy whirlwind — breaks block each hit. 150 focus melee one-handed weapons extracted from sacrament's sin https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-dash`,gameId:`no-rest-for-the-wicked`,name:`Lightning Dash`,description:`Lightning-crackling dash — 300% Lightning, Knocks Down.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`lightning-dash no-rest-for-the-wicked lightning dash lightning-crackling dash — 300% lightning, knocks down. 100 focus melee one-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-flurry`,gameId:`no-rest-for-the-wicked`,name:`Lightning Flurry`,description:`Four rapid lightning strikes (+20 Poise Dmg, +100% Kickback each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Buried Shamsir`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`lightning-flurry no-rest-for-the-wicked lightning flurry four rapid lightning strikes (+20 poise dmg, +100% kickback each). 100 focus melee one-handed weapons extracted from buried shamsir https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-slam`,gameId:`no-rest-for-the-wicked`,name:`Lightning Slam`,description:`Leap + electrical slam — 300% Lightning, +20 Poise Dmg.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`lightning-slam no-rest-for-the-wicked lightning slam leap + electrical slam — 300% lightning, +20 poise dmg. 100 focus melee one-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-spin`,gameId:`no-rest-for-the-wicked`,name:`Lightning Spin`,description:`Two spinning lightning strikes — 125% More x2, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Filleter`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`lightning-spin no-rest-for-the-wicked lightning spin two spinning lightning strikes — 125% more x2, breaks block. 100 focus melee one-handed weapons extracted from filleter https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-throw`,gameId:`no-rest-for-the-wicked`,name:`Lightning Throw`,description:`Hurl electrified weapon and return — 25% Lightning x2.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Demon's Key`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`lightning-throw no-rest-for-the-wicked lightning throw hurl electrified weapon and return — 25% lightning x2. 50 focus ranged one-handed weapons extracted from demon's key https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-whirl`,gameId:`no-rest-for-the-wicked`,name:`Lightning Whirl`,description:`Six-hit electric whirlwind — Breaks Block each hit.`,cost:`150 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`lightning-whirl no-rest-for-the-wicked lightning whirl six-hit electric whirlwind — breaks block each hit. 150 focus melee one-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`shock-strike`,gameId:`no-rest-for-the-wicked`,name:`Shock Strike`,description:`Electrified hit then jump back — 50% Lightning x2, +20 Poise Dmg.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Reaching Nail`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`shock-strike no-rest-for-the-wicked shock strike electrified hit then jump back — 50% lightning x2, +20 poise dmg. 50 focus melee one-handed weapons extracted from reaching nail https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`stormpiercer`,gameId:`no-rest-for-the-wicked`,name:`Stormpiercer`,description:`Lunge strike + 2 homing lightning projectiles (200% More each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Scorched Broadblade`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`stormpiercer no-rest-for-the-wicked stormpiercer lunge strike + 2 homing lightning projectiles (200% more each). 100 focus melee one-handed weapons extracted from scorched broadblade https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-dash`,gameId:`no-rest-for-the-wicked`,name:`Plague Dash`,description:`Plague-coated dash — 300% Plague, +150% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`plague-dash no-rest-for-the-wicked plague dash plague-coated dash — 300% plague, +150% kickback. 100 focus melee one-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-strike`,gameId:`no-rest-for-the-wicked`,name:`Plague Strike`,description:`Heavy plague hit — 300% More, Knocks Down, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`Extracted from Ogre's Club`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`plague-strike no-rest-for-the-wicked plague strike heavy plague hit — 300% more, knocks down, breaks block. 100 focus melee one-handed weapons extracted from ogre's club https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-swirl`,gameId:`no-rest-for-the-wicked`,name:`Plague Swirl`,description:`Two sweeping plague strikes — Breaks Block, +200% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`plague-swirl no-rest-for-the-wicked plague swirl two sweeping plague strikes — breaks block, +200% kickback. 50 focus melee one-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-throw`,gameId:`no-rest-for-the-wicked`,name:`Plague Throw`,description:`Fling plague-coated weapon and return — 25% Plague x2.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-throw no-rest-for-the-wicked plague throw fling plague-coated weapon and return — 25% plague x2. 50 focus ranged one-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-whirl`,gameId:`no-rest-for-the-wicked`,name:`Plague Whirl`,description:`Six-hit toxic whirlwind — Breaks Block each hit.`,cost:`150 Focus`,attackType:`Melee`,compatibleWeaponType:`One-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`plague-whirl no-rest-for-the-wicked plague whirl six-hit toxic whirlwind — breaks block each hit. 150 focus melee one-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`balance-smash`,gameId:`no-rest-for-the-wicked`,name:`Balance Smash`,description:`Roll over weapon + ground-shattering smash — 200% Physical, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Weeping Earth`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`balance-smash no-rest-for-the-wicked balance smash roll over weapon + ground-shattering smash — 200% physical, breaks block. 100 focus melee two-handed weapons extracted from weeping earth https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`berserk-flurry`,gameId:`no-rest-for-the-wicked`,name:`Berserk Flurry`,description:`Four rapid block-breaking swings with berserker fury (+10 Poise Dmg, +100% Kickback).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`berserk-flurry no-rest-for-the-wicked berserk flurry four rapid block-breaking swings with berserker fury (+10 poise dmg, +100% kickback). 100 focus melee two-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`berserk-slam`,gameId:`no-rest-for-the-wicked`,name:`Berserk Slam`,description:`Battle cry + forward ground slam — 100% Physical, Breaks Block.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Tooth of the Ancient One`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`berserk-slam no-rest-for-the-wicked berserk slam battle cry + forward ground slam — 100% physical, breaks block. 50 focus melee two-handed weapons extracted from tooth of the ancient one https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`berserk-strike`,gameId:`no-rest-for-the-wicked`,name:`Berserk Strike`,description:`Chest thump rage boost + devastating hit — 250% Physical, Knocks Down, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Bud of the Everlasting Tree`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`berserk-strike no-rest-for-the-wicked berserk strike chest thump rage boost + devastating hit — 250% physical, knocks down, breaks block. 100 focus melee two-handed weapons extracted from bud of the everlasting tree https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`breaker-thrust`,gameId:`no-rest-for-the-wicked`,name:`Breaker Thrust`,description:`Lunge + weapon drive — 100% Physical, Knocks Down, +200% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Harvester's Dread`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`breaker-thrust no-rest-for-the-wicked breaker thrust lunge + weapon drive — 100% physical, knocks down, +200% kickback. 50 focus melee two-handed weapons extracted from harvester's dread https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`crushing-quad`,gameId:`no-rest-for-the-wicked`,name:`Crushing Quad`,description:`Four rapid block-breaking swings (10% More each, +10 Poise Dmg).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`crushing-quad no-rest-for-the-wicked crushing quad four rapid block-breaking swings (10% more each, +10 poise dmg). 100 focus melee two-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`crushing-slam`,gameId:`no-rest-for-the-wicked`,name:`Crushing Slam`,description:`Leap forward + ground crush — 200% Physical, Knocks Down, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Brutish Cudgel`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`crushing-slam no-rest-for-the-wicked crushing slam leap forward + ground crush — 200% physical, knocks down, breaks block. 100 focus melee two-handed weapons extracted from brutish cudgel https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`crushing-triple`,gameId:`no-rest-for-the-wicked`,name:`Crushing Triple`,description:`Three-hit combo, each hit heavier — Breaks Block (+10 Poise Dmg, +100% Kickback).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Broken Fang`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`crushing-triple no-rest-for-the-wicked crushing triple three-hit combo, each hit heavier — breaks block (+10 poise dmg, +100% kickback). 100 focus melee two-handed weapons extracted from broken fang https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`crushing-uppercut`,gameId:`no-rest-for-the-wicked`,name:`Crushing Uppercut`,description:`Whirling momentum into devastating block-breaking upswing — 100% x2.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`crushing-uppercut no-rest-for-the-wicked crushing uppercut whirling momentum into devastating block-breaking upswing — 100% x2. 50 focus melee two-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`cyclone-swipe`,gameId:`no-rest-for-the-wicked`,name:`Cyclone Swipe`,description:`Single circular sweep — 100% Physical, +10 Poise Dmg, +200% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Sunbeam`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`cyclone-swipe no-rest-for-the-wicked cyclone swipe single circular sweep — 100% physical, +10 poise dmg, +200% kickback. 50 focus melee two-handed weapons extracted from sunbeam https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`dodge-slamdown`,gameId:`no-rest-for-the-wicked`,name:`Dodge Slamdown`,description:`Bounce forward + block-breaking overhead slam — 100% Physical, +200% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted frin Bandit's Cleaver`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`dodge-slamdown no-rest-for-the-wicked dodge slamdown bounce forward + block-breaking overhead slam — 100% physical, +200% kickback. 50 focus melee two-handed weapons extracted frin bandit's cleaver https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`double-crush`,gameId:`no-rest-for-the-wicked`,name:`Double Crush`,description:`Bounce forward + two block-breaking strikes (50% More each, +200% Kickback).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Spliced Hammer`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`double-crush no-rest-for-the-wicked double crush bounce forward + two block-breaking strikes (50% more each, +200% kickback). 100 focus melee two-handed weapons extracted from spliced hammer https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`frenzied-cleave`,gameId:`no-rest-for-the-wicked`,name:`Frenzied Cleave`,description:`Three wild block-breaking swings (100% More each, +10 Poise Dmg).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Soul Thresher`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`frenzied-cleave no-rest-for-the-wicked frenzied cleave three wild block-breaking swings (100% more each, +10 poise dmg). 100 focus melee two-handed weapons extracted from soul thresher https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`ground-slam`,gameId:`no-rest-for-the-wicked`,name:`Ground Slam`,description:`Horizontal block-breaking sweep + aerial downward slam (3 hits total).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Festering Earth`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`ground-slam no-rest-for-the-wicked ground slam horizontal block-breaking sweep + aerial downward slam (3 hits total). 100 focus melee two-handed weapons extracted from festering earth https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`juggle-strike`,gameId:`no-rest-for-the-wicked`,name:`Juggle Strike`,description:`Charged block-breaking swinging uppercut — 200% Physical, +100% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Claymore`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`juggle-strike no-rest-for-the-wicked juggle strike charged block-breaking swinging uppercut — 200% physical, +100% kickback. 100 focus melee two-handed weapons extracted from claymore https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`kick-slash`,gameId:`no-rest-for-the-wicked`,name:`Kick Slash`,description:`Spinning kick + block-breaking slash — 100% Physical x2.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`kick-slash no-rest-for-the-wicked kick slash spinning kick + block-breaking slash — 100% physical x2. 100 focus melee two-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`knockdown-swirl`,gameId:`no-rest-for-the-wicked`,name:`Knockdown Swirl`,description:`Two-hit spinning combo — Knocks Down, Breaks Block.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Divine Scimitar`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`knockdown-swirl no-rest-for-the-wicked knockdown swirl two-hit spinning combo — knocks down, breaks block. 50 focus melee two-handed weapons extracted from divine scimitar https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`limit-break`,gameId:`no-rest-for-the-wicked`,name:`Limit Break`,description:`Four-hit slashing combo ending with overwhelming block-breaking blow (-20% More each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Gnarled Saw`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`limit-break no-rest-for-the-wicked limit break four-hit slashing combo ending with overwhelming block-breaking blow (-20% more each). 100 focus melee two-handed weapons extracted from gnarled saw https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`multi-spin`,gameId:`no-rest-for-the-wicked`,name:`Multi Spin`,description:`Six slow spins continuously hitting all nearby enemies (-30% More each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Serrated Cutter`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`multi-spin no-rest-for-the-wicked multi spin six slow spins continuously hitting all nearby enemies (-30% more each). 100 focus melee two-handed weapons extracted from serrated cutter https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`pole-flurry`,gameId:`no-rest-for-the-wicked`,name:`Pole Flurry`,description:`Two vertical sweeps + downward slam (50% More each, +150% Kickback).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`pole-flurry no-rest-for-the-wicked pole flurry two vertical sweeps + downward slam (50% more each, +150% kickback). 100 focus melee two-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`raging-spiral`,gameId:`no-rest-for-the-wicked`,name:`Raging Spiral`,description:`Spin forward 3 times in block-breaking arc (50% More, x4 hits).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Midnight Shredder`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`raging-spiral no-rest-for-the-wicked raging spiral spin forward 3 times in block-breaking arc (50% more, x4 hits). 100 focus melee two-handed weapons extracted from midnight shredder https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`reap`,gameId:`no-rest-for-the-wicked`,name:`Reap`,description:`Two block-breaking spinning blows + crushing slam finish.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Scythe of Wretches`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`reap no-rest-for-the-wicked reap two block-breaking spinning blows + crushing slam finish. 100 focus melee two-handed weapons extracted from scythe of wretches https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`relentless-cleave`,gameId:`no-rest-for-the-wicked`,name:`Relentless Cleave`,description:`Four block-breaking swings + final fiery explosion.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Boarskin Reaper`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`relentless-cleave no-rest-for-the-wicked relentless cleave four block-breaking swings + final fiery explosion. 100 focus melee two-handed weapons extracted from boarskin reaper https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`rip-and-tear`,gameId:`no-rest-for-the-wicked`,name:`Rip and Tear`,description:`Single massive block-breaking strike — 300% Physical, Knocks Down, +200% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Hope Shorn`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`rip-and-tear no-rest-for-the-wicked rip and tear single massive block-breaking strike — 300% physical, knocks down, +200% kickback. 100 focus melee two-handed weapons extracted from hope shorn https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`seismic-crush`,gameId:`no-rest-for-the-wicked`,name:`Seismic Crush`,description:`Ground slam shockwave — Knocks Down, Breaks Block.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Evening Star`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`seismic-crush no-rest-for-the-wicked seismic crush ground slam shockwave — knocks down, breaks block. 50 focus melee two-handed weapons extracted from evening star https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`slashing-spin`,gameId:`no-rest-for-the-wicked`,name:`Slashing Spin`,description:`Charged spinning strike — 250% Physical, Knocks Down, Breaks Block, +200% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Freiheit`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`slashing-spin no-rest-for-the-wicked slashing spin charged spinning strike — 250% physical, knocks down, breaks block, +200% kickback. 100 focus melee two-handed weapons extracted from freiheit https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`spin-crush`,gameId:`no-rest-for-the-wicked`,name:`Spin Crush`,description:`Horizontal sweep + crushing downward strike (75% More x2, Breaks Block).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Regal Cleft`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`spin-crush no-rest-for-the-wicked spin crush horizontal sweep + crushing downward strike (75% more x2, breaks block). 100 focus melee two-handed weapons extracted from regal cleft https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`spiral-crash`,gameId:`no-rest-for-the-wicked`,name:`Spiral Crash`,description:`Crushing spin + knockdown blow — 100% Physical, Knocks Down.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Cerim's Skyrend`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`spiral-crash no-rest-for-the-wicked spiral crash crushing spin + knockdown blow — 100% physical, knocks down. 50 focus melee two-handed weapons extracted from cerim's skyrend https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`tremor-slam`,gameId:`no-rest-for-the-wicked`,name:`Tremor Slam`,description:`Ground slam + shockwave — 100% Physical x2, +200% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Mayhem`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`tremor-slam no-rest-for-the-wicked tremor slam ground slam + shockwave — 100% physical x2, +200% kickback. 100 focus melee two-handed weapons extracted from mayhem https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`wallbreaker`,gameId:`no-rest-for-the-wicked`,name:`Wallbreaker`,description:`Single block-shattering stab — 250% Physical, +10 Poise Dmg, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Summer's Sting`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`wallbreaker no-rest-for-the-wicked wallbreaker single block-shattering stab — 250% physical, +10 poise dmg, breaks block. 100 focus melee two-handed weapons extracted from summer's sting https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`whirlwind`,gameId:`no-rest-for-the-wicked`,name:`Whirlwind`,description:`Five rapid block-breaking spins hitting all nearby enemies (+200% Kickback each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Shattered Sun`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`whirlwind no-rest-for-the-wicked whirlwind five rapid block-breaking spins hitting all nearby enemies (+200% kickback each). 100 focus melee two-handed weapons extracted from shattered sun https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`eruption`,gameId:`no-rest-for-the-wicked`,name:`Eruption`,description:`Leap + volcanic explosion — 400% Fire, Knocks Down, Breaks Block.`,cost:`150 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Festering Cleft`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`eruption no-rest-for-the-wicked eruption leap + volcanic explosion — 400% fire, knocks down, breaks block. 150 focus melee two-handed weapons extracted from festering cleft https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-slam`,gameId:`no-rest-for-the-wicked`,name:`Fire Slam`,description:`Leap + fiery blast — 100% Fire x2, Knocks Down, Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Pound of Cadavers`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`fire-slam no-rest-for-the-wicked fire slam leap + fiery blast — 100% fire x2, knocks down, breaks block. 100 focus melee two-handed weapons extracted from pound of cadavers https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-swipe`,gameId:`no-rest-for-the-wicked`,name:`Fire Swipe`,description:`Sweeping flame strike — 70% Fire, +10 Poise Dmg, +200% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Blister`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`fire-swipe no-rest-for-the-wicked fire swipe sweeping flame strike — 70% fire, +10 poise dmg, +200% kickback. 50 focus melee two-handed weapons extracted from blister https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-whirlwind`,gameId:`no-rest-for-the-wicked`,name:`Fire Whirlwind`,description:`Six spinning fire hits (-30% More each) — Breaks Block.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`fire-whirlwind no-rest-for-the-wicked fire whirlwind six spinning fire hits (-30% more each) — breaks block. 100 focus melee two-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`ice-ram`,gameId:`no-rest-for-the-wicked`,name:`Ice Ram`,description:`Sweeping frost strike — 70% Ice, +10 Poise Dmg, +200% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`ice-ram no-rest-for-the-wicked ice ram sweeping frost strike — 70% ice, +10 poise dmg, +200% kickback. 50 focus melee two-handed weapons tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-assault`,gameId:`no-rest-for-the-wicked`,name:`Lightning Assault`,description:`Gap-closing sweeping lightning strike — 200% Lightning, Knocks Down, +200% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Gilded Twibill`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`lightning-assault no-rest-for-the-wicked lightning assault gap-closing sweeping lightning strike — 200% lightning, knocks down, +200% kickback. 100 focus melee two-handed weapons extracted from gilded twibill https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`pestilent-recoil`,gameId:`no-rest-for-the-wicked`,name:`Pestilent Recoil`,description:`Two plague melee hits + leaps back and fires toxic knockdown wave (4 hits total).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Sieger`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`pestilent-recoil no-rest-for-the-wicked pestilent recoil two plague melee hits + leaps back and fires toxic knockdown wave (4 hits total). 100 focus melee two-handed weapons extracted from sieger https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-crush`,gameId:`no-rest-for-the-wicked`,name:`Plague Crush`,description:`Sweeping plague strike — 70% Plague, +10 Poise Dmg, +200% Kickback.`,cost:`50 Focus`,attackType:`Melee`,compatibleWeaponType:`Two-Handed Weapons`,whereToFind:`Extracted from Spalled Axe`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`plague-crush no-rest-for-the-wicked plague crush sweeping plague strike — 70% plague, +10 poise dmg, +200% kickback. 50 focus melee two-handed weapons extracted from spalled axe https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`armageddon-fire`,gameId:`no-rest-for-the-wicked`,name:`Armageddon (Fire)`,description:`Calls down a massive firestorm — 1000% Fire.`,cost:`150 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Molten Clutch`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`armageddon-fire no-rest-for-the-wicked armageddon (fire) calls down a massive firestorm — 1000% fire. 150 focus ranged wands & staves extracted from molten clutch https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`armageddon-physical`,gameId:`no-rest-for-the-wicked`,name:`Armageddon (Physical)`,description:`Close-range devastating block-breaking strike — 400% Physical.`,cost:`150 Focus`,attackType:`Melee`,compatibleWeaponType:`Wands & Staves`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`armageddon-physical no-rest-for-the-wicked armageddon (physical) close-range devastating block-breaking strike — 400% physical. 150 focus melee wands & staves tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`converging-flame`,gameId:`no-rest-for-the-wicked`,name:`Converging Flame`,description:`6 hovering fireballs converge on enemies; Charge 2: 150% More.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Flame Becomes Us`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`converging-flame no-rest-for-the-wicked converging flame 6 hovering fireballs converge on enemies; charge 2: 150% more. 100 focus ranged wands & staves extracted from flame becomes us https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-blast`,gameId:`no-rest-for-the-wicked`,name:`Fire Blast`,description:`Small intense fire explosion — 300% Fire, +150% Kickback.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Entwined Root`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`fire-blast no-rest-for-the-wicked fire blast small intense fire explosion — 300% fire, +150% kickback. 50 focus ranged wands & staves extracted from entwined root https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-burst`,gameId:`no-rest-for-the-wicked`,name:`Fire Burst`,description:`Delayed fire projectile detonates — 900% Fire, 3m explosion radius.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Flame Becomes Us`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`fire-burst no-rest-for-the-wicked fire burst delayed fire projectile detonates — 900% fire, 3m explosion radius. 100 focus ranged wands & staves extracted from flame becomes us https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-dart`,gameId:`no-rest-for-the-wicked`,name:`Fire Dart`,description:`Focused flame dart — 30% Fire, -50% Poise Dmg, +50% Kickback.`,cost:`35 Stamina`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Entwined Root`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`fire-dart no-rest-for-the-wicked fire dart focused flame dart — 30% fire, -50% poise dmg, +50% kickback. 35 stamina ranged wands & staves extracted from entwined root https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-nova`,gameId:`no-rest-for-the-wicked`,name:`Fire Nova`,description:`Fire burst around you — 300% Fire, Knocks Down; Charge doubles power.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Gnarled Staff`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`fire-nova no-rest-for-the-wicked fire nova fire burst around you — 300% fire, knocks down; charge doubles power. 100 focus ranged wands & staves extracted from gnarled staff https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-walk`,gameId:`no-rest-for-the-wicked`,name:`Fire Walk`,description:`Engulfs self in flames; leaves burning trail (+20% Burn Buildup, +20% Fire Dmg).`,cost:`150 Focus`,attackType:`Self`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Fused Coronet`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`magic`,searchText:`fire-walk no-rest-for-the-wicked fire walk engulfs self in flames; leaves burning trail (+20% burn buildup, +20% fire dmg). 150 focus self wands & staves extracted from fused coronet https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-wall`,gameId:`no-rest-for-the-wicked`,name:`Fire Wall`,description:`Erects a wall of continuous fire — 50% Fire x10.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Molten Clutch`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`fire-wall no-rest-for-the-wicked fire wall erects a wall of continuous fire — 50% fire x10. 100 focus ranged wands & staves extracted from molten clutch https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fire-wave`,gameId:`no-rest-for-the-wicked`,name:`Fire Wave`,description:`Five homing fireballs in a wave; Charge 2: 150% More.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Stag of Embers`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`fire-wave no-rest-for-the-wicked fire wave five homing fireballs in a wave; charge 2: 150% more. 100 focus ranged wands & staves extracted from stag of embers https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`fireball`,gameId:`no-rest-for-the-wicked`,name:`Fireball`,description:`Blazing fireball; Charge 2: 100% More with full kickback.`,cost:`35 Stamina`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Gnarled Staff`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`fireball no-rest-for-the-wicked fireball blazing fireball; charge 2: 100% more with full kickback. 35 stamina ranged wands & staves extracted from gnarled staff https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`flame-sweep`,gameId:`no-rest-for-the-wicked`,name:`Flame Sweep`,description:`360-degree flaming staff sweep — 200% Fire, +10 Poise Dmg, Breaks Block.`,cost:`25 Focus`,attackType:`Melee`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Dried Hive`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`flame-sweep no-rest-for-the-wicked flame sweep 360-degree flaming staff sweep — 200% fire, +10 poise dmg, breaks block. 25 focus melee wands & staves extracted from dried hive https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`hellfire`,gameId:`no-rest-for-the-wicked`,name:`Hellfire`,description:`Leap + large fiery eruption — 1000% Fire, Knocks Down.`,cost:`150 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Stag of Embers`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`hellfire no-rest-for-the-wicked hellfire leap + large fiery eruption — 1000% fire, knocks down. 150 focus ranged wands & staves extracted from stag of embers https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`inferno`,gameId:`no-rest-for-the-wicked`,name:`Inferno`,description:`Sustained fire beam — 6 hits at -50% More until released.`,cost:`15 Focus/tick`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Dried Hive`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`inferno no-rest-for-the-wicked inferno sustained fire beam — 6 hits at -50% more until released. 15 focus/tick ranged wands & staves extracted from dried hive https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`spin-strike`,gameId:`no-rest-for-the-wicked`,name:`Spin Strike`,description:`Four-hit fiery whirlwind in all directions (100% Fire each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Fused Coronet`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`spin-strike no-rest-for-the-wicked spin strike four-hit fiery whirlwind in all directions (100% fire each). 100 focus melee wands & staves extracted from fused coronet https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`cold-sling`,gameId:`no-rest-for-the-wicked`,name:`Cold Sling`,description:`Leap + 3 homing ice projectiles (160% More each, +20 Poise Dmg).`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Hoar Frost Sickle`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`cold-sling no-rest-for-the-wicked cold sling leap + 3 homing ice projectiles (160% more each, +20 poise dmg). 100 focus ranged wands & staves extracted from hoar frost sickle https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`frigid-arc`,gameId:`no-rest-for-the-wicked`,name:`Frigid Arc`,description:`Leap + sweeping frost arc — 80% Ice x2.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from All Is Known`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`frigid-arc no-rest-for-the-wicked frigid arc leap + sweeping frost arc — 80% ice x2. 100 focus ranged wands & staves extracted from all is known https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`frost-needles`,gameId:`no-rest-for-the-wicked`,name:`Frost Needles`,description:`Four homing ice shards — 100% Ice each, +20 Poise Dmg.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from All Is Known`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`frost-needles no-rest-for-the-wicked frost needles four homing ice shards — 100% ice each, +20 poise dmg. 100 focus ranged wands & staves extracted from all is known https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`frost-nova`,gameId:`no-rest-for-the-wicked`,name:`Frost Nova`,description:`Icy burst around you — 300% Ice; Charge doubles power.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Spherin`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`frost-nova no-rest-for-the-wicked frost nova icy burst around you — 300% ice; charge doubles power. 100 focus ranged wands & staves extracted from spherin https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`frost-step`,gameId:`no-rest-for-the-wicked`,name:`Frost Step`,description:`Dodge then counter frost stream — 6 hits at -30% More.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Moon Shard`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`frost-step no-rest-for-the-wicked frost step dodge then counter frost stream — 6 hits at -30% more. 50 focus ranged wands & staves extracted from moon shard https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`frost-stream`,gameId:`no-rest-for-the-wicked`,name:`Frost Stream`,description:`Sustained frost beam — 6 hits at -50% More until released.`,cost:`15 Focus/tick`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Endless Winter`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`frost-stream no-rest-for-the-wicked frost stream sustained frost beam — 6 hits at -50% more until released. 15 focus/tick ranged wands & staves extracted from endless winter https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`glacial-spike`,gameId:`no-rest-for-the-wicked`,name:`Glacial Spike`,description:`Leap + massive freezing eruption — 1000% Ice, Knocks Down.`,cost:`150 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`glacial-spike no-rest-for-the-wicked glacial spike leap + massive freezing eruption — 1000% ice, knocks down. 150 focus ranged wands & staves tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`hail`,gameId:`no-rest-for-the-wicked`,name:`Hail`,description:`Five ice bolts in a wave; Charge 2: 150% More.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`hail no-rest-for-the-wicked hail five ice bolts in a wave; charge 2: 150% more. 100 focus ranged wands & staves tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`homing-frost`,gameId:`no-rest-for-the-wicked`,name:`Homing Frost`,description:`10 icy homing darts; Charge 2: 30% More.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Endless Winter`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`homing-frost no-rest-for-the-wicked homing frost 10 icy homing darts; charge 2: 30% more. 100 focus ranged wands & staves extracted from endless winter https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`ice-dart`,gameId:`no-rest-for-the-wicked`,name:`Ice Dart`,description:`Chilling ice dart — 30% Ice, slows on impact.`,cost:`35 Stamina`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Hoar Frost Sickle`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`ice-dart no-rest-for-the-wicked ice dart chilling ice dart — 30% ice, slows on impact. 35 stamina ranged wands & staves extracted from hoar frost sickle https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`ice-sweep`,gameId:`no-rest-for-the-wicked`,name:`Ice Sweep`,description:`360-degree ice-encased staff sweep — 200% Ice, +10 Poise Dmg, Breaks Block.`,cost:`25 Focus`,attackType:`Melee`,compatibleWeaponType:`Wands & Staves`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`ice-sweep no-rest-for-the-wicked ice sweep 360-degree ice-encased staff sweep — 200% ice, +10 poise dmg, breaks block. 25 focus melee wands & staves tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`icebolt`,gameId:`no-rest-for-the-wicked`,name:`Icebolt`,description:`Chilling ice ball; Charge 2: 100% More.`,cost:`35 Stamina`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Spherin`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`icebolt no-rest-for-the-wicked icebolt chilling ice ball; charge 2: 100% more. 35 stamina ranged wands & staves extracted from spherin https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`chain-lightning`,gameId:`no-rest-for-the-wicked`,name:`Chain Lightning`,description:`Lightning bolt that arcs to 3 nearby enemies when charged (200% multiplier).`,cost:`35 Stamina`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Cursed Crone`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`chain-lightning no-rest-for-the-wicked chain lightning lightning bolt that arcs to 3 nearby enemies when charged (200% multiplier). 35 stamina ranged wands & staves extracted from cursed crone https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`charged-bolt`,gameId:`no-rest-for-the-wicked`,name:`Charged Bolt`,description:`Releases 18 lightning bolts in all directions — 250% Lightning each.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`charged-bolt no-rest-for-the-wicked charged bolt releases 18 lightning bolts in all directions — 250% lightning each. 50 focus ranged wands & staves tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-barrage`,gameId:`no-rest-for-the-wicked`,name:`Lightning Barrage`,description:`Dash into enemies + electrified strike flurry — 170% Lightning, +150% Kickback.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Crooked Key`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`lightning-barrage no-rest-for-the-wicked lightning barrage dash into enemies + electrified strike flurry — 170% lightning, +150% kickback. 100 focus melee wands & staves extracted from crooked key https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-blast`,gameId:`no-rest-for-the-wicked`,name:`Lightning Blast`,description:`Electrifies ground beneath enemies — 300% Lightning.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Grasping Magus Wand`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`lightning-blast no-rest-for-the-wicked lightning blast electrifies ground beneath enemies — 300% lightning. 50 focus ranged wands & staves extracted from grasping magus wand https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-bolt`,gameId:`no-rest-for-the-wicked`,name:`Lightning Bolt`,description:`Single massive lightning strike from the sky — 1300% Lightning, +200% Kickback.`,cost:`150 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`lightning-bolt no-rest-for-the-wicked lightning bolt single massive lightning strike from the sky — 1300% lightning, +200% kickback. 150 focus ranged wands & staves tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-dart`,gameId:`no-rest-for-the-wicked`,name:`Lightning Dart`,description:`Crackling lightning dart — 30% Lightning.`,cost:`35 Stamina`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Grasping Magus Wand`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`lightning-dart no-rest-for-the-wicked lightning dart crackling lightning dart — 30% lightning. 35 stamina ranged wands & staves extracted from grasping magus wand https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-flash`,gameId:`no-rest-for-the-wicked`,name:`Lightning Flash`,description:`Three concentrated homing lightning bolts (200% More each).`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Crooked Key`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`lightning-flash no-rest-for-the-wicked lightning flash three concentrated homing lightning bolts (200% more each). 100 focus ranged wands & staves extracted from crooked key https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-leap`,gameId:`no-rest-for-the-wicked`,name:`Lightning Leap`,description:`Leap + multi-hit lightning plunge; 3m radius shockwave.`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Amberhusk`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`lightning-leap no-rest-for-the-wicked lightning leap leap + multi-hit lightning plunge; 3m radius shockwave. 100 focus melee wands & staves extracted from amberhusk https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-storm`,gameId:`no-rest-for-the-wicked`,name:`Lightning Storm`,description:`Five homing lightning bolts in succession (100% More each).`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Amberhusk`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`lightning-storm no-rest-for-the-wicked lightning storm five homing lightning bolts in succession (100% more each). 100 focus ranged wands & staves extracted from amberhusk https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`lightning-sweep`,gameId:`no-rest-for-the-wicked`,name:`Lightning Sweep`,description:`360-degree electric staff sweep — 200% Lightning, +10 Poise Dmg, Breaks Block.`,cost:`25 Focus`,attackType:`Melee`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Cursed Crone`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`lightning-sweep no-rest-for-the-wicked lightning sweep 360-degree electric staff sweep — 200% lightning, +10 poise dmg, breaks block. 25 focus melee wands & staves extracted from cursed crone https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`shock-nova`,gameId:`no-rest-for-the-wicked`,name:`Shock Nova`,description:`Electric burst around you — 300% Lightning, Knocks Down; Charge doubles power.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Sinner's Crown`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`shock-nova no-rest-for-the-wicked shock nova electric burst around you — 300% lightning, knocks down; charge doubles power. 100 focus ranged wands & staves extracted from sinner's crown https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`spark`,gameId:`no-rest-for-the-wicked`,name:`Spark`,description:`Five lightning bolts in a wave; Charge 2: 150% More.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Sinner's Crown`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`spark no-rest-for-the-wicked spark five lightning bolts in a wave; charge 2: 150% more. 100 focus ranged wands & staves extracted from sinner's crown https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`static`,gameId:`no-rest-for-the-wicked`,name:`Static`,description:`Body charge shocks nearby enemies; 3 instances when charged (+50% Shock Buildup).`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`static no-rest-for-the-wicked static body charge shocks nearby enemies; 3 instances when charged (+50% shock buildup). 100 focus ranged wands & staves tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`thunderstrike`,gameId:`no-rest-for-the-wicked`,name:`Thunderstrike`,description:`Leap + thunderous eruption — 1000% Lightning, Knocks Down.`,cost:`150 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Sinner's Crown`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`thunderstrike no-rest-for-the-wicked thunderstrike leap + thunderous eruption — 1000% lightning, knocks down. 150 focus ranged wands & staves extracted from sinner's crown https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`pestilence`,gameId:`no-rest-for-the-wicked`,name:`Pestilence`,description:`Leap + massive toxic eruption — 1000% Plague, Knocks Down.`,cost:`150 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`pestilence no-rest-for-the-wicked pestilence leap + massive toxic eruption — 1000% plague, knocks down. 150 focus ranged wands & staves tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-barrage`,gameId:`no-rest-for-the-wicked`,name:`Plague Barrage`,description:`Charge forward + 5 homing plague projectiles (100% More each).`,cost:`100 Focus`,attackType:`Melee`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Rune-Stricken Wand`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`plague-barrage no-rest-for-the-wicked plague barrage charge forward + 5 homing plague projectiles (100% more each). 100 focus melee wands & staves extracted from rune-stricken wand https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-breath`,gameId:`no-rest-for-the-wicked`,name:`Plague Breath`,description:`Toxic plague ball; Charge 2: 100% More.`,cost:`35 Stamina`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Pinwheel Staff`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-breath no-rest-for-the-wicked plague breath toxic plague ball; charge 2: 100% more. 35 stamina ranged wands & staves extracted from pinwheel staff https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-burst`,gameId:`no-rest-for-the-wicked`,name:`Plague Burst`,description:`Four homing plague projectiles — 130% More each.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Sanglier`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-burst no-rest-for-the-wicked plague burst four homing plague projectiles — 130% more each. 100 focus ranged wands & staves extracted from sanglier https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-column`,gameId:`no-rest-for-the-wicked`,name:`Plague Column`,description:`Vertical plague torrent that fires infectious projectiles outward.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Nith Gate`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-column no-rest-for-the-wicked plague column vertical plague torrent that fires infectious projectiles outward. 100 focus ranged wands & staves extracted from nith gate https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-dart`,gameId:`no-rest-for-the-wicked`,name:`Plague Dart`,description:`Diseased dart — 30% Plague, slow-acting lingering poison.`,cost:`35 Stamina`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Lord of the Muck`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-dart no-rest-for-the-wicked plague dart diseased dart — 30% plague, slow-acting lingering poison. 35 stamina ranged wands & staves extracted from lord of the muck https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-explosion`,gameId:`no-rest-for-the-wicked`,name:`Plague Explosion`,description:`Detonates plague buboes — 170% Plague.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Rune-Stricken Wand`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-explosion no-rest-for-the-wicked plague explosion detonates plague buboes — 170% plague. 100 focus ranged wands & staves extracted from rune-stricken wand https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-launch`,gameId:`no-rest-for-the-wicked`,name:`Plague Launch`,description:`Leap back + plague shockwave — 650% Plague, Knocks Down, +200% Kickback.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Sanglier`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-launch no-rest-for-the-wicked plague launch leap back + plague shockwave — 650% plague, knocks down, +200% kickback. 100 focus ranged wands & staves extracted from sanglier https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-nova`,gameId:`no-rest-for-the-wicked`,name:`Plague Nova`,description:`Plague burst around you — 300% Plague, Knocks Down; Charge doubles power.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Pinwheel Staff`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-nova no-rest-for-the-wicked plague nova plague burst around you — 300% plague, knocks down; charge doubles power. 100 focus ranged wands & staves extracted from pinwheel staff https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-smite`,gameId:`no-rest-for-the-wicked`,name:`Plague Smite`,description:`Erupts pestilence beneath enemies' feet — 300% Plague.`,cost:`50 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Lord of the Muck`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-smite no-rest-for-the-wicked plague smite erupts pestilence beneath enemies' feet — 300% plague. 50 focus ranged wands & staves extracted from lord of the muck https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-splatter`,gameId:`no-rest-for-the-wicked`,name:`Plague Splatter`,description:`Massive plague bubble bursts in spreading corruption — 1000% Plague.`,cost:`150 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from Nith Gate`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-splatter no-rest-for-the-wicked plague splatter massive plague bubble bursts in spreading corruption — 1000% plague. 150 focus ranged wands & staves extracted from nith gate https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-sweep`,gameId:`no-rest-for-the-wicked`,name:`Plague Sweep`,description:`360-degree toxin-laced staff sweep — 200% Plague, +10 Poise Dmg, Breaks Block.`,cost:`25 Focus`,attackType:`Melee`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from False Truth`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`melee`,searchText:`plague-sweep no-rest-for-the-wicked plague sweep 360-degree toxin-laced staff sweep — 200% plague, +10 poise dmg, breaks block. 25 focus melee wands & staves extracted from false truth https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-wave`,gameId:`no-rest-for-the-wicked`,name:`Plague Wave`,description:`Five plague projectiles in a wave; Charge 2: 150% More.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`Extracted from False Truth`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`plague-wave no-rest-for-the-wicked plague wave five plague projectiles in a wave; charge 2: 150% more. 100 focus ranged wands & staves extracted from false truth https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`rotwheel`,gameId:`no-rest-for-the-wicked`,name:`Rotwheel`,description:`Rolling plague mass that barrels forward — 200% Plague + 100% trail.`,cost:`100 Focus`,attackType:`Ranged`,compatibleWeaponType:`Wands & Staves`,whereToFind:`TBC`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`ranged`,searchText:`rotwheel no-rest-for-the-wicked rotwheel rolling plague mass that barrels forward — 200% plague + 100% trail. 100 focus ranged wands & staves tbc https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`blink`,gameId:`no-rest-for-the-wicked`,name:`Blink`,description:`Teleport 4m forward, passing through enemies.`,cost:`25 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`blink no-rest-for-the-wicked blink teleport 4m forward, passing through enemies. 25 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`channel`,gameId:`no-rest-for-the-wicked`,name:`Channel`,description:`Sacrifice health to restore +2 Focus.`,cost:`30 Health/tick`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`utility`,searchText:`channel no-rest-for-the-wicked channel sacrifice health to restore +2 focus. 30 health/tick utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`damage-surge`,gameId:`no-rest-for-the-wicked`,name:`Damage Surge`,description:`+20% Overall Damage Dealt for 120 seconds.`,cost:`100 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`damage-surge no-rest-for-the-wicked damage surge +20% overall damage dealt for 120 seconds. 100 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`focus-halo`,gameId:`no-rest-for-the-wicked`,name:`Focus Halo`,description:`+100 Max Focus for 120 seconds.`,cost:`100 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`utility`,searchText:`focus-halo no-rest-for-the-wicked focus halo +100 max focus for 120 seconds. 100 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`heal`,gameId:`no-rest-for-the-wicked`,name:`Heal`,description:`Instantly restore +40 Health.`,cost:`50 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`utility`,searchText:`heal no-rest-for-the-wicked heal instantly restore +40 health. 50 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`heal-aura`,gameId:`no-rest-for-the-wicked`,name:`Heal Aura`,description:`Sustained healing aura — +2 Health per tick.`,cost:`20 Focus/tick`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`utility`,searchText:`heal-aura no-rest-for-the-wicked heal aura sustained healing aura — +2 health per tick. 20 focus/tick utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`illuminate`,gameId:`no-rest-for-the-wicked`,name:`Illuminate`,description:`Summons a light source that follows you.`,cost:`25 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`illuminate no-rest-for-the-wicked illuminate summons a light source that follows you. 25 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`poise-shield`,gameId:`no-rest-for-the-wicked`,name:`Poise Shield`,description:`+200% Poise for 120 seconds (much harder to stagger).`,cost:`100 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`poise-shield no-rest-for-the-wicked poise shield +200% poise for 120 seconds (much harder to stagger). 100 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`pulse-of-health`,gameId:`no-rest-for-the-wicked`,name:`Pulse of Health`,description:`+25 Current Health and +20% Max Health for 120 seconds.`,cost:`100 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`utility`,searchText:`pulse-of-health no-rest-for-the-wicked pulse of health +25 current health and +20% max health for 120 seconds. 100 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`repair`,gameId:`no-rest-for-the-wicked`,name:`Repair`,description:`Restore +25 Durability to equipped items.`,cost:`150 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`repair no-rest-for-the-wicked repair restore +25 durability to equipped items. 150 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`return`,gameId:`no-rest-for-the-wicked`,name:`Return`,description:`Fast travel to any unlocked whisper point.`,cost:`25 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`return no-rest-for-the-wicked return fast travel to any unlocked whisper point. 25 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`scream`,gameId:`no-rest-for-the-wicked`,name:`Scream`,description:`Powerful scream — Knocks Down all enemies in front of you.`,cost:`50 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`scream no-rest-for-the-wicked scream powerful scream — knocks down all enemies in front of you. 50 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`stamina-wellspring`,gameId:`no-rest-for-the-wicked`,name:`Stamina Wellspring`,description:`+30% Stamina for 120 seconds.`,cost:`100 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Purchased from Eleanor Extracted from Paddle`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`stamina-wellspring no-rest-for-the-wicked stamina wellspring +30% stamina for 120 seconds. 100 focus utility 来源未标注 purchased from eleanor extracted from paddle https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`heat-enchantment`,gameId:`no-rest-for-the-wicked`,name:`Heat Enchantment`,description:`Gain Fire Infusion for 60 seconds.`,cost:`50 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Purchased from Eleanor Extracted from Azure Blade`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`magic`,searchText:`heat-enchantment no-rest-for-the-wicked heat enchantment gain fire infusion for 60 seconds. 50 focus utility 来源未标注 purchased from eleanor extracted from azure blade https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`heat-resistance`,gameId:`no-rest-for-the-wicked`,name:`Heat Resistance`,description:`+25% Fire Resistance for 120 seconds.`,cost:`50 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`magic`,searchText:`heat-resistance no-rest-for-the-wicked heat resistance +25% fire resistance for 120 seconds. 50 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`cold-enchantment`,gameId:`no-rest-for-the-wicked`,name:`Cold Enchantment`,description:`Gain Ice Infusion for 60 seconds.`,cost:`50 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Purchased from Eleanor Extracted from Icebreaker`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`cold-enchantment no-rest-for-the-wicked cold enchantment gain ice infusion for 60 seconds. 50 focus utility 来源未标注 purchased from eleanor extracted from icebreaker https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`cold-resistance`,gameId:`no-rest-for-the-wicked`,name:`Cold Resistance`,description:`+25% Ice Resistance for 120 seconds.`,cost:`50 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`cold-resistance no-rest-for-the-wicked cold resistance +25% ice resistance for 120 seconds. 50 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`electric-enchantment`,gameId:`no-rest-for-the-wicked`,name:`Electric Enchantment`,description:`Gain Lightning Infusion for 60 seconds.`,cost:`50 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Purchased from Eleanor Extracted from Cronus`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`electric-enchantment no-rest-for-the-wicked electric enchantment gain lightning infusion for 60 seconds. 50 focus utility 来源未标注 purchased from eleanor extracted from cronus https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`electric-resistance`,gameId:`no-rest-for-the-wicked`,name:`Electric Resistance`,description:`+25% Lightning Resistance for 120 seconds.`,cost:`50 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`electric-resistance no-rest-for-the-wicked electric resistance +25% lightning resistance for 120 seconds. 50 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-enchantment`,gameId:`no-rest-for-the-wicked`,name:`Plague Enchantment`,description:`Gain Plague Infusion for 60 seconds.`,cost:`50 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Purchased from Eleanor Extracted from Shroudcleaver`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`magic`,searchText:`plague-enchantment no-rest-for-the-wicked plague enchantment gain plague infusion for 60 seconds. 50 focus utility 来源未标注 purchased from eleanor extracted from shroudcleaver https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`plague-resistance`,gameId:`no-rest-for-the-wicked`,name:`Plague Resistance`,description:`+25% Plague Resistance for 120 seconds.`,cost:`50 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`magic`,searchText:`plague-resistance no-rest-for-the-wicked plague resistance +25% plague resistance for 120 seconds. 50 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`},{slug:`thorns`,gameId:`no-rest-for-the-wicked`,name:`Thorns`,description:`Reflect 80% of incoming damage back at attackers for 120 seconds.`,cost:`50 Focus`,attackType:`Utility`,compatibleWeaponType:`来源未标注`,whereToFind:`Eleanor`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Runes`,lastVerifiedAt:`2026-07-09`,category:`unknown`,searchText:`thorns no-rest-for-the-wicked thorns reflect 80% of incoming damage back at attackers for 120 seconds. 50 focus utility 来源未标注 eleanor https://norestforthewicked.wiki.fextralife.com/runes 2026-07-09`}],qr={main_story:`主线 Boss`,side_quest:`支线 Boss`},Jr={melee:`近战`,ranged:`远程`,magic:`元素 / 法术`,utility:`功能`,unknown:`未分类`};function Yr(e){return Gr.filter(t=>t.gameId===e)}function Xr(e){return Kr.filter(t=>t.gameId===e)}function Zr(e,t){return Gr.find(n=>n.gameId===e&&n.slug===t)}function Qr(e,t){return Kr.find(n=>n.gameId===e&&n.slug===t)}function $r(e,t,n,r){let i=t.trim().toLowerCase();return e.filter(e=>n!==`all`&&e.category!==n||r!==`all`&&e.bossType!==r?!1:i?e.searchText.includes(i):!0)}function ei(e,t,n,r){let i=t.trim().toLowerCase();return e.filter(e=>n!==`all`&&e.category!==n||r!==`all`&&e.attackType!==r?!1:i?e.searchText.includes(i):!0)}function ti(e){let t=new Map;for(let n of e)t.set(n.category,[...t.get(n.category)??[],n]);return Array.from(t.entries()).sort(([e],[t])=>qr[e].localeCompare(qr[t],`zh-Hans-CN`))}function ni(e){let t=new Map;for(let n of e)t.set(n.category,[...t.get(n.category)??[],n]);return Array.from(t.entries()).sort(([e],[t])=>Jr[e].localeCompare(Jr[t],`zh-Hans-CN`))}var ri=[{slug:`breaking-wave`,gameId:`no-rest-for-the-wicked`,name:`Breaking Wave`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/breaking-wave-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Breaking+Wave`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`breaking wave axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`holy-felled`,gameId:`no-rest-for-the-wicked`,name:`Holy Felled`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/holy-felled-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Holy+Felled`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`holy felled axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`hooked-yue`,gameId:`no-rest-for-the-wicked`,name:`Hooked Yue`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/hooked-yue-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Hooked+Yue`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`hooked yue axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`hunter-s-axe`,gameId:`no-rest-for-the-wicked`,name:`Hunter's Axe`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/hunters_axe_one_handed_axe_no_rest_for_the_wicked_wiki_guide_100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Hunter's+Axe`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`hunter's axe axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`jade-spined-axe`,gameId:`no-rest-for-the-wicked`,name:`Jade Spined Axe`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/jade-spined-axe-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Jade+Spined+Axe`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`jade spined axe axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`lonely-labrys`,gameId:`no-rest-for-the-wicked`,name:`Lonely Labrys`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/lonely-labrys-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Lonely+Labrys`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`lonely labrys axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`maelstrom-s-heart`,gameId:`no-rest-for-the-wicked`,name:`Maelstrom's Heart`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/maelstroms-heart-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Maelstrom's+Heart`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`maelstrom's heart axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`piercing-beak`,gameId:`no-rest-for-the-wicked`,name:`Piercing Beak`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/piercing-beak-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Piercing+Beak`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`piercing beak axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`ripper`,gameId:`no-rest-for-the-wicked`,name:`Ripper`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/ripper-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Ripper`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`ripper axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`rivensong`,gameId:`no-rest-for-the-wicked`,name:`Rivensong`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/rivensong-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Rivensong`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`rivensong axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`royal-hewn-axe`,gameId:`no-rest-for-the-wicked`,name:`Royal Hewn Axe`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/royal-hewn-axe-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Royal+Hewn+Axe`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`royal hewn axe axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`the-remnant`,gameId:`no-rest-for-the-wicked`,name:`The Remnant`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-remnant-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Remnant`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`the remnant axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`tongue-splitter`,gameId:`no-rest-for-the-wicked`,name:`Tongue Splitter`,category:`axes`,categoryLabel:`Axes`,categoryLabelZh:`斧`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/tongue-splitter-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Tongue+Splitter`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`tongue splitter axes 斧 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`answered-prayer`,gameId:`no-rest-for-the-wicked`,name:`Answered Prayer`,category:`bows`,categoryLabel:`Bows`,categoryLabelZh:`弓`,handedness:`远程`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/answered-prayer-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Answered+Prayer`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`answered prayer bows 弓 远程 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`glimmering-bolt`,gameId:`no-rest-for-the-wicked`,name:`Glimmering Bolt`,category:`bows`,categoryLabel:`Bows`,categoryLabelZh:`弓`,handedness:`远程`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/glimmering-bolt-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Glimmering+Bolt`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`glimmering bolt bows 弓 远程 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`laquered-bow`,gameId:`no-rest-for-the-wicked`,name:`Laquered Bow`,category:`bows`,categoryLabel:`Bows`,categoryLabelZh:`弓`,handedness:`远程`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/lacquered-bow-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Laquered+Bow`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`laquered bow bows 弓 远程 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`pale-ash`,gameId:`no-rest-for-the-wicked`,name:`Pale Ash`,category:`bows`,categoryLabel:`Bows`,categoryLabelZh:`弓`,handedness:`远程`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/pale-ash-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Pale+Ash`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`pale ash bows 弓 远程 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`patience`,gameId:`no-rest-for-the-wicked`,name:`Patience`,category:`bows`,categoryLabel:`Bows`,categoryLabelZh:`弓`,handedness:`远程`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/patience-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Patience`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`patience bows 弓 远程 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`short-bow`,gameId:`no-rest-for-the-wicked`,name:`Short Bow`,category:`bows`,categoryLabel:`Bows`,categoryLabelZh:`弓`,handedness:`远程`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/short_bow_none_bow_no_rest_for_the_wicked_wiki_guide_100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Short+Bow`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`short bow bows 弓 远程 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`siren-s-song`,gameId:`no-rest-for-the-wicked`,name:`Siren's Song`,category:`bows`,categoryLabel:`Bows`,categoryLabelZh:`弓`,handedness:`远程`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/sirens-song-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Siren's+Song`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`siren's song bows 弓 远程 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`twinned-recurve-bow`,gameId:`no-rest-for-the-wicked`,name:`Twinned Recurve Bow`,category:`bows`,categoryLabel:`Bows`,categoryLabelZh:`弓`,handedness:`远程`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/twinned-recurve-bow-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Twinned+Recurve+Bow`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`twinned recurve bow bows 弓 远程 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`woodland-protector`,gameId:`no-rest-for-the-wicked`,name:`Woodland Protector`,category:`bows`,categoryLabel:`Bows`,categoryLabelZh:`弓`,handedness:`远程`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/woodland-protector-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Woodland+Protector`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`woodland protector bows 弓 远程 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`yewn-longbow`,gameId:`no-rest-for-the-wicked`,name:`Yewn Longbow`,category:`bows`,categoryLabel:`Bows`,categoryLabelZh:`弓`,handedness:`远程`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/yewn-longbow-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Yewn+Longbow`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`yewn longbow bows 弓 远程 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`nail-laden-club`,gameId:`no-rest-for-the-wicked`,name:`Nail-Laden Club`,category:`clubs`,categoryLabel:`Clubs`,categoryLabelZh:`棍棒`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/nail-laden-club-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Nail-Laden+Club`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`nail-laden club clubs 棍棒 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`ogre-s-club`,gameId:`no-rest-for-the-wicked`,name:`Ogre's Club`,category:`clubs`,categoryLabel:`Clubs`,categoryLabelZh:`棍棒`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/ogres-club-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Ogre's+Club`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`ogre's club clubs 棍棒 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`death-s-shroud`,gameId:`no-rest-for-the-wicked`,name:`Death's Shroud`,category:`curved_great_swords`,categoryLabel:`Curved Great Swords`,categoryLabelZh:`曲刃大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/deaths-shroud-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Death's+Shroud`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`death's shroud curved great swords 曲刃大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`divine-scimitar`,gameId:`no-rest-for-the-wicked`,name:`Divine Scimitar`,category:`curved_great_swords`,categoryLabel:`Curved Great Swords`,categoryLabelZh:`曲刃大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/divine-scimitar-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Divine+Scimitar`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`divine scimitar curved great swords 曲刃大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`sunbeam`,gameId:`no-rest-for-the-wicked`,name:`Sunbeam`,category:`curved_great_swords`,categoryLabel:`Curved Great Swords`,categoryLabelZh:`曲刃大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/sunbeam-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Sunbeam`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`sunbeam curved great swords 曲刃大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`a-supple-end`,gameId:`no-rest-for-the-wicked`,name:`A Supple End`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/a-supple-end-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/A+Supple+End`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`a supple end curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`etched-yatagan`,gameId:`no-rest-for-the-wicked`,name:`Etched Yatagan`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/bone-yatagan-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Bone+Yatagan`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`etched yatagan curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`buried-shamshir`,gameId:`no-rest-for-the-wicked`,name:`Buried Shamshir`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/buried-shamshir-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Buried+Shamshir`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`buried shamshir curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`cerulean-blade`,gameId:`no-rest-for-the-wicked`,name:`Cerulean Blade`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/cerulean-blade-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Cerulean+Blade`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`cerulean blade curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`dark-tide`,gameId:`no-rest-for-the-wicked`,name:`Dark Tide`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/dark-tide-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Dark+Tide`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`dark tide curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`demon-s-key`,gameId:`no-rest-for-the-wicked`,name:`Demon's Key`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/demons-key-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Demon's+Key`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`demon's key curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`filleter`,gameId:`no-rest-for-the-wicked`,name:`Filleter`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/filleter-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Filleter`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`filleter curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`giant-s-toothpick`,gameId:`no-rest-for-the-wicked`,name:`Giant's Toothpick`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/giants-toothpick-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Giant's+Toothpick`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`giant's toothpick curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`malwoven-hook`,gameId:`no-rest-for-the-wicked`,name:`Malwoven Hook`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/malwoven-hook-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Malwoven+Hook`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`malwoven hook curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`risen-blade`,gameId:`no-rest-for-the-wicked`,name:`Risen Blade`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/risen-blade-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Risen+Blade`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`risen blade curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`rusty-arakh`,gameId:`no-rest-for-the-wicked`,name:`Rusty Arakh`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/rusty-arakh-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Rusty+Arakh`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`rusty arakh curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`scimitar`,gameId:`no-rest-for-the-wicked`,name:`Scimitar`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/scimitar-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Scimitar`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`scimitar curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`song-of-steel`,gameId:`no-rest-for-the-wicked`,name:`Song of Steel`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/song-of-steel-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Song+of+Steel`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`song of steel curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`talwar`,gameId:`no-rest-for-the-wicked`,name:`Talwar`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/talwar-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Talwar`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`talwar curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`tempered-cutlass`,gameId:`no-rest-for-the-wicked`,name:`Tempered Cutlass`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/tempered-cutlass-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Tempered+Cutlass`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`tempered cutlass curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`tremble`,gameId:`no-rest-for-the-wicked`,name:`Tremble`,category:`curved_swords`,categoryLabel:`Curved Swords`,categoryLabelZh:`曲剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/tremble-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Tremble`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`tremble curved swords 曲剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`a-singular-purpose`,gameId:`no-rest-for-the-wicked`,name:`A Singular Purpose`,category:`daggers`,categoryLabel:`Daggers`,categoryLabelZh:`匕首`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/a-singular-purpose-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/A+Singular+Purpose`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`a singular purpose daggers 匕首 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`barbtrader`,gameId:`no-rest-for-the-wicked`,name:`Barbtrader`,category:`daggers`,categoryLabel:`Daggers`,categoryLabelZh:`匕首`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/barbtrader-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Barbtrader`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`barbtrader daggers 匕首 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`butcher-s-work`,gameId:`no-rest-for-the-wicked`,name:`Butcher's Work`,category:`daggers`,categoryLabel:`Daggers`,categoryLabelZh:`匕首`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/butchers-work-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Butcher's+Work`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`butcher's work daggers 匕首 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`glimmering-bone`,gameId:`no-rest-for-the-wicked`,name:`Glimmering Bone`,category:`daggers`,categoryLabel:`Daggers`,categoryLabelZh:`匕首`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/glimmering-bone-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Glimmering+Bone`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`glimmering bone daggers 匕首 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`glory-s-bite`,gameId:`no-rest-for-the-wicked`,name:`Glory's Bite`,category:`daggers`,categoryLabel:`Daggers`,categoryLabelZh:`匕首`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/glorys-bite-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Glory's+Bite`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`glory's bite daggers 匕首 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`hunter-s-knife`,gameId:`no-rest-for-the-wicked`,name:`Hunter's Knife`,category:`daggers`,categoryLabel:`Daggers`,categoryLabelZh:`匕首`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/hunters_knife_one_handed_knife_weapons_no_rest_for_the_wicked_wiki_guide_100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Hunter's+Knife`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`hunter's knife daggers 匕首 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`jackknife`,gameId:`no-rest-for-the-wicked`,name:`Jackknife`,category:`daggers`,categoryLabel:`Daggers`,categoryLabelZh:`匕首`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/jackknife-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Jackknife`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`jackknife daggers 匕首 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`midnight-blade`,gameId:`no-rest-for-the-wicked`,name:`Midnight Blade`,category:`daggers`,categoryLabel:`Daggers`,categoryLabelZh:`匕首`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/midnight-blade-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Midnight+Blade`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`midnight blade daggers 匕首 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`scowling-dirk`,gameId:`no-rest-for-the-wicked`,name:`Scowling Dirk`,category:`daggers`,categoryLabel:`Daggers`,categoryLabelZh:`匕首`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/scowling-dirk-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Scowling+Dirk`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`scowling dirk daggers 匕首 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`serpent-s-tongue`,gameId:`no-rest-for-the-wicked`,name:`Serpent's Tongue`,category:`daggers`,categoryLabel:`Daggers`,categoryLabelZh:`匕首`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/serpents-tongue-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Serpent's+Tongue`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`serpent's tongue daggers 匕首 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`the-old-ways`,gameId:`no-rest-for-the-wicked`,name:`The Old Ways`,category:`daggers`,categoryLabel:`Daggers`,categoryLabelZh:`匕首`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-old-ways-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Old+Ways`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`the old ways daggers 匕首 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`all-s-well`,gameId:`no-rest-for-the-wicked`,name:`All's Well`,category:`double_daggers`,categoryLabel:`Double Daggers`,categoryLabelZh:`双匕首`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/alls-well-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/All's+Well`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`all's well double daggers 双匕首 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`ash-soothed-daggers`,gameId:`no-rest-for-the-wicked`,name:`Ash Soothed Daggers`,category:`double_daggers`,categoryLabel:`Double Daggers`,categoryLabelZh:`双匕首`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/ash-soothed-daggers-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Ash+Soothed+Daggers`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`ash soothed daggers double daggers 双匕首 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`bleeder-s-delight`,gameId:`no-rest-for-the-wicked`,name:`Bleeder's Delight`,category:`double_daggers`,categoryLabel:`Double Daggers`,categoryLabelZh:`双匕首`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/bleeders-delight-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Bleeder's+Delight`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`bleeder's delight double daggers 双匕首 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`brothers-keepers`,gameId:`no-rest-for-the-wicked`,name:`Brothers Keepers`,category:`double_daggers`,categoryLabel:`Double Daggers`,categoryLabelZh:`双匕首`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/brothers_keepers_dual_wielding_double_dagger_weapons_no_rest_for_the_wicked_wiki_guide_100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Brothers+Keepers`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`brothers keepers double daggers 双匕首 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`chipped-daggers`,gameId:`no-rest-for-the-wicked`,name:`Chipped Daggers`,category:`double_daggers`,categoryLabel:`Double Daggers`,categoryLabelZh:`双匕首`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/chipped-daggers-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Chipped+Daggers`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`chipped daggers double daggers 双匕首 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`death-s-touch`,gameId:`no-rest-for-the-wicked`,name:`Death's Touch`,category:`double_daggers`,categoryLabel:`Double Daggers`,categoryLabelZh:`双匕首`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/deaths-touch-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Death's+Touch`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`death's touch double daggers 双匕首 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`grave-scrapers`,gameId:`no-rest-for-the-wicked`,name:`Grave Scrapers`,category:`double_daggers`,categoryLabel:`Double Daggers`,categoryLabelZh:`双匕首`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/grave-scrapers-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Grave+Scrapers`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`grave scrapers double daggers 双匕首 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`rogue-messer`,gameId:`no-rest-for-the-wicked`,name:`Rogue Messer`,category:`double_daggers`,categoryLabel:`Double Daggers`,categoryLabelZh:`双匕首`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/rogue-messer-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Rogue+Messer`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`rogue messer double daggers 双匕首 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`the-vizier-s-advice`,gameId:`no-rest-for-the-wicked`,name:`The Vizier's Advice`,category:`double_daggers`,categoryLabel:`Double Daggers`,categoryLabelZh:`双匕首`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-viziers-advice-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Vizier's+Advice`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`the vizier's advice double daggers 双匕首 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`wavering-faith`,gameId:`no-rest-for-the-wicked`,name:`Wavering Faith`,category:`double_daggers`,categoryLabel:`Double Daggers`,categoryLabelZh:`双匕首`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/wavering-faith-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Wavering+Faith`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`wavering faith double daggers 双匕首 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`wolf-bane`,gameId:`no-rest-for-the-wicked`,name:`Wolf Bane`,category:`double_daggers`,categoryLabel:`Double Daggers`,categoryLabelZh:`双匕首`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/wolf-bane-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Wolf+Bane`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`wolf bane double daggers 双匕首 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`bandit-s-cleaver`,gameId:`no-rest-for-the-wicked`,name:`Bandit's Cleaver`,category:`great_axes`,categoryLabel:`Great Axes`,categoryLabelZh:`大斧`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/bandits-cleaver-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Bandit's+Cleaver`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`bandit's cleaver great axes 大斧 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`broken-fang`,gameId:`no-rest-for-the-wicked`,name:`Broken Fang`,category:`great_axes`,categoryLabel:`Great Axes`,categoryLabelZh:`大斧`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/broken-fang-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Broken+Fang`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`broken fang great axes 大斧 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`cavalier`,gameId:`no-rest-for-the-wicked`,name:`Cavalier`,category:`great_axes`,categoryLabel:`Great Axes`,categoryLabelZh:`大斧`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/cavalier-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Cavalier`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`cavalier great axes 大斧 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`gavlan-s-great-axe`,gameId:`no-rest-for-the-wicked`,name:`Gavlan's Great Axe`,category:`great_axes`,categoryLabel:`Great Axes`,categoryLabelZh:`大斧`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/gavlans-great-axe-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Gavlan's+Great+Axe`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`gavlan's great axe great axes 大斧 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`gilded-twibill`,gameId:`no-rest-for-the-wicked`,name:`Gilded Twibill`,category:`great_axes`,categoryLabel:`Great Axes`,categoryLabelZh:`大斧`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/gilded-twibill-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Gilded+Twibill`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`gilded twibill great axes 大斧 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`mountain-eater`,gameId:`no-rest-for-the-wicked`,name:`Mountain Eater`,category:`great_axes`,categoryLabel:`Great Axes`,categoryLabelZh:`大斧`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/mountain-eater-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Mountain+Eater`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`mountain eater great axes 大斧 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`penelope`,gameId:`no-rest-for-the-wicked`,name:`Penelope`,category:`great_axes`,categoryLabel:`Great Axes`,categoryLabelZh:`大斧`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/penelope-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Penelope`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`penelope great axes 大斧 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`short-bardiche`,gameId:`no-rest-for-the-wicked`,name:`Short Bardiche`,category:`great_axes`,categoryLabel:`Great Axes`,categoryLabelZh:`大斧`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/short-bardiche-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Short+Bardiche`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`short bardiche great axes 大斧 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`spalled-axe`,gameId:`no-rest-for-the-wicked`,name:`Spalled Axe`,category:`great_axes`,categoryLabel:`Great Axes`,categoryLabelZh:`大斧`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/spalled-axe-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Spalled+Axe`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`spalled axe great axes 大斧 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`warlord-s-thirst`,gameId:`no-rest-for-the-wicked`,name:`Warlord's Thirst`,category:`great_axes`,categoryLabel:`Great Axes`,categoryLabelZh:`大斧`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/warlords-thirst-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Warlord's+Thirst`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`warlord's thirst great axes 大斧 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`fetid-club`,gameId:`no-rest-for-the-wicked`,name:`Fetid Club`,category:`great_clubs`,categoryLabel:`Great Clubs`,categoryLabelZh:`大棍棒`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/fetid-club-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Fetid+Club`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`fetid club great clubs 大棍棒 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`the-voice-of-our-lord`,gameId:`no-rest-for-the-wicked`,name:`The Voice of Our Lord`,category:`great_clubs`,categoryLabel:`Great Clubs`,categoryLabelZh:`大棍棒`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-voice-of-ou-lord-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Voice+of+Our+Lord`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`the voice of our lord great clubs 大棍棒 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`wretched-mace`,gameId:`no-rest-for-the-wicked`,name:`Wretched Mace`,category:`great_clubs`,categoryLabel:`Great Clubs`,categoryLabelZh:`大棍棒`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/wretched-mace-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Wretched+Mace`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`wretched mace great clubs 大棍棒 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`bud-of-the-everlasting-tree`,gameId:`no-rest-for-the-wicked`,name:`Bud of the Everlasting Tree`,category:`great_hammers`,categoryLabel:`Great Hammers`,categoryLabelZh:`大锤`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/bud-of-the-everlasting-tree-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Bud+of+the+Everlasting+Tree`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`bud of the everlasting tree great hammers 大锤 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`cinder-and-stone`,gameId:`no-rest-for-the-wicked`,name:`Cinder & Stone`,category:`great_hammers`,categoryLabel:`Great Hammers`,categoryLabelZh:`大锤`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/cinder-stone-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Cinder+&amp;+Stone`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`cinder & stone great hammers 大锤 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`eternal-companion`,gameId:`no-rest-for-the-wicked`,name:`Eternal Companion`,category:`great_hammers`,categoryLabel:`Great Hammers`,categoryLabelZh:`大锤`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/eternal-companion-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Eternal+Companion`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`eternal companion great hammers 大锤 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`festering-cleft`,gameId:`no-rest-for-the-wicked`,name:`Festering Cleft`,category:`great_hammers`,categoryLabel:`Great Hammers`,categoryLabelZh:`大锤`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/festering-cleft-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Festering+Cleft`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`festering cleft great hammers 大锤 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`night-protector`,gameId:`no-rest-for-the-wicked`,name:`Night Protector`,category:`great_hammers`,categoryLabel:`Great Hammers`,categoryLabelZh:`大锤`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/night-protector-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Night+Protector`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`night protector great hammers 大锤 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`pound-of-cadavers`,gameId:`no-rest-for-the-wicked`,name:`Pound of Cadavers`,category:`great_hammers`,categoryLabel:`Great Hammers`,categoryLabelZh:`大锤`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/pound-of-cadavers-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Pound+of+Cadavers`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`pound of cadavers great hammers 大锤 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`spliced-hammer`,gameId:`no-rest-for-the-wicked`,name:`Spliced Hammer`,category:`great_hammers`,categoryLabel:`Great Hammers`,categoryLabelZh:`大锤`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/spliced-hammer-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Spliced+Hammer`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`spliced hammer great hammers 大锤 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`the-ram`,gameId:`no-rest-for-the-wicked`,name:`The Ram`,category:`great_hammers`,categoryLabel:`Great Hammers`,categoryLabelZh:`大锤`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-ram-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Ram`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`the ram great hammers 大锤 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`tooth-of-the-ancient-one`,gameId:`no-rest-for-the-wicked`,name:`Tooth of the Ancient One`,category:`great_hammers`,categoryLabel:`Great Hammers`,categoryLabelZh:`大锤`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/tooth-of-the-ancient-one-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Tooth+of+the+Ancient+One`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`tooth of the ancient one great hammers 大锤 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`weeping-earth`,gameId:`no-rest-for-the-wicked`,name:`Weeping Earth`,category:`great_hammers`,categoryLabel:`Great Hammers`,categoryLabelZh:`大锤`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/weeping-earth-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Weeping+Earth`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`weeping earth great hammers 大锤 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`baron-s-edge`,gameId:`no-rest-for-the-wicked`,name:`Baron's Edge`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/barons-edge-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Baron's+Edge`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`baron's edge great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`blister`,gameId:`no-rest-for-the-wicked`,name:`Blister`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/blister-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Blister`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`blister great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`burning-thorn`,gameId:`no-rest-for-the-wicked`,name:`Burning Thorn`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/burning-thorn-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Burning+Thorn`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`burning thorn great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`claymore`,gameId:`no-rest-for-the-wicked`,name:`Claymore`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/claymore_two_handed_weapons_no_rest_for_the_wicked_wiki_guide_100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Claymore`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`claymore great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`corpse-smeared-blade`,gameId:`no-rest-for-the-wicked`,name:`Corpse Smeared Blade`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/blood-rusted_sword_one_handed_straight_sword_weapons_no_rest_for_the_wicked_wiki_guide_100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Corpse+Smeared+Blade`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`corpse smeared blade great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`culvarie`,gameId:`no-rest-for-the-wicked`,name:`Culvarie`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/culvarie-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Culvarie`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`culvarie great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`falstead-s-fury`,gameId:`no-rest-for-the-wicked`,name:`Falstead's Fury`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/daraks-fury-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Falstead's+Fury`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`falstead's fury great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`deep-mind`,gameId:`no-rest-for-the-wicked`,name:`Deep Mind`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/deep-mind-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Deep+Mind`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`deep mind great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`festering-earth`,gameId:`no-rest-for-the-wicked`,name:`Festering Earth`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/festering-earth-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Festering+Earth`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`festering earth great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`freiheit`,gameId:`no-rest-for-the-wicked`,name:`Freiheit`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/freiheit-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Freiheit`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`freiheit great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`frost-bringer`,gameId:`no-rest-for-the-wicked`,name:`Frost Bringer`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/frost-bringer-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Frost+Bringer`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`frost bringer great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`gnarled-saw`,gameId:`no-rest-for-the-wicked`,name:`Gnarled Saw`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/gnarled-saw-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Gnarled+Saw`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`gnarled saw great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`icebreaker`,gameId:`no-rest-for-the-wicked`,name:`Icebreaker`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/icebreaker-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Icebreaker`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`icebreaker great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`keeper-s-mercy`,gameId:`no-rest-for-the-wicked`,name:`Keeper's Mercy`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/keepers-mercy-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Keeper's+Mercy`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`keeper's mercy great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`shattered-sun`,gameId:`no-rest-for-the-wicked`,name:`Shattered Sun`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/shattered-sun-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Shattered+Sun`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`shattered sun great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`sieger`,gameId:`no-rest-for-the-wicked`,name:`Sieger`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/sieger-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Sieger`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`sieger great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`solitude`,gameId:`no-rest-for-the-wicked`,name:`Solitude`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/solitude-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Solitude`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`solitude great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`summer-s-sting`,gameId:`no-rest-for-the-wicked`,name:`Summer's Sting`,category:`great_swords`,categoryLabel:`Great Swords`,categoryLabelZh:`大剑`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/summers-sting-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Summers'+Sting`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`summer's sting great swords 大剑 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`bolein-polearm`,gameId:`no-rest-for-the-wicked`,name:`Bolein Polearm`,category:`halberds`,categoryLabel:`Halberds`,categoryLabelZh:`戟`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/bolein-polearm-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Bolein+Polearm`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`bolein polearm halberds 戟 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`executioner-s-halberd`,gameId:`no-rest-for-the-wicked`,name:`Executioner's Halberd`,category:`halberds`,categoryLabel:`Halberds`,categoryLabelZh:`戟`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/executioners-halberd-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Executioner's+Halberd`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`executioner's halberd halberds 戟 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`god-s-reach`,gameId:`no-rest-for-the-wicked`,name:`God's Reach`,category:`halberds`,categoryLabel:`Halberds`,categoryLabelZh:`戟`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/gods-reach-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/God's+Reach`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`god's reach halberds 戟 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`gristleborn`,gameId:`no-rest-for-the-wicked`,name:`Gristleborn`,category:`halberds`,categoryLabel:`Halberds`,categoryLabelZh:`戟`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/gristleborn-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Gristleborn`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`gristleborn halberds 戟 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`ocean-sweeper`,gameId:`no-rest-for-the-wicked`,name:`Ocean Sweeper`,category:`halberds`,categoryLabel:`Halberds`,categoryLabelZh:`戟`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/ocean-sweeper-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Ocean+Sweeper`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`ocean sweeper halberds 戟 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`phoenix-crest`,gameId:`no-rest-for-the-wicked`,name:`Phoenix Crest`,category:`halberds`,categoryLabel:`Halberds`,categoryLabelZh:`戟`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/phoenix-crest-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Phoenix+Crest`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`phoenix crest halberds 戟 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`regal-cleft`,gameId:`no-rest-for-the-wicked`,name:`Regal Cleft`,category:`halberds`,categoryLabel:`Halberds`,categoryLabelZh:`戟`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/regal-cleft-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Regal+Cleft`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`regal cleft halberds 戟 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`seabed-scraper`,gameId:`no-rest-for-the-wicked`,name:`Seabed Scraper`,category:`halberds`,categoryLabel:`Halberds`,categoryLabelZh:`戟`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/seabed-scraper-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Seabed+Scraper`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`seabed scraper halberds 戟 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`serrated-cutter`,gameId:`no-rest-for-the-wicked`,name:`Serrated Cutter`,category:`halberds`,categoryLabel:`Halberds`,categoryLabelZh:`戟`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/serrated-cutter-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Serrated+Cutter`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`serrated cutter halberds 戟 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`broken-forge`,gameId:`no-rest-for-the-wicked`,name:`Broken Forge`,category:`hammers`,categoryLabel:`Hammers`,categoryLabelZh:`锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/broken-forge-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Broken+Forge`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`broken forge hammers 锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`brutal-maul`,gameId:`no-rest-for-the-wicked`,name:`Brutal Maul`,category:`hammers`,categoryLabel:`Hammers`,categoryLabelZh:`锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/brutal-maul-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Brutal+Maul`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`brutal maul hammers 锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`climber-s-pick`,gameId:`no-rest-for-the-wicked`,name:`Climber's Pick`,category:`hammers`,categoryLabel:`Hammers`,categoryLabelZh:`锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/climbers_pick_one_handed_hammer_no_rest_for_the_wicked_wiki_guide_100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Climber's+Pick`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`climber's pick hammers 锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`crystalline-sledge`,gameId:`no-rest-for-the-wicked`,name:`Crystalline Sledge`,category:`hammers`,categoryLabel:`Hammers`,categoryLabelZh:`锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/crystalline-sledge-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Crystalline+Sledge`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`crystalline sledge hammers 锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`deadblow`,gameId:`no-rest-for-the-wicked`,name:`Deadblow`,category:`hammers`,categoryLabel:`Hammers`,categoryLabelZh:`锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/deadblow-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Deadblow`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`deadblow hammers 锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`grimacing-stone`,gameId:`no-rest-for-the-wicked`,name:`Grimacing Stone`,category:`hammers`,categoryLabel:`Hammers`,categoryLabelZh:`锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/grimacing-stone-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Grimacing+Stone`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`grimacing stone hammers 锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`oxen-s-vengeance`,gameId:`no-rest-for-the-wicked`,name:`Oxen's Vengeance`,category:`hammers`,categoryLabel:`Hammers`,categoryLabelZh:`锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/oxens-vengeance-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Oxen's+Vengeance`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`oxen's vengeance hammers 锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`rostock`,gameId:`no-rest-for-the-wicked`,name:`Rostock`,category:`hammers`,categoryLabel:`Hammers`,categoryLabelZh:`锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/rostock-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Rostock`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`rostock hammers 锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`singing-peal`,gameId:`no-rest-for-the-wicked`,name:`Singing Peal`,category:`hammers`,categoryLabel:`Hammers`,categoryLabelZh:`锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/singing-peal-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Singing+Peal`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`singing peal hammers 锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`splintered-wing`,gameId:`no-rest-for-the-wicked`,name:`Splintered Wing`,category:`hammers`,categoryLabel:`Hammers`,categoryLabelZh:`锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/splintered-wing-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Splintered+Wing`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`splintered wing hammers 锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`grass-cutter`,gameId:`no-rest-for-the-wicked`,name:`Grass Cutter`,category:`katanas`,categoryLabel:`Katanas`,categoryLabelZh:`武士刀`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/grass-cutter-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Grass+Cutter`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`grass cutter katanas 武士刀 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`hanzo-blade`,gameId:`no-rest-for-the-wicked`,name:`Hanzo Blade`,category:`katanas`,categoryLabel:`Katanas`,categoryLabelZh:`武士刀`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/hanzo-blade-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Hanzo+Blade`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`hanzo blade katanas 武士刀 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`katana`,gameId:`no-rest-for-the-wicked`,name:`Katana`,category:`katanas`,categoryLabel:`Katanas`,categoryLabelZh:`武士刀`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/katana-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Katana`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`katana katanas 武士刀 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`tachi`,gameId:`no-rest-for-the-wicked`,name:`Tachi`,category:`katanas`,categoryLabel:`Katanas`,categoryLabelZh:`武士刀`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/tachi-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Tachi`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`tachi katanas 武士刀 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`uchigatana`,gameId:`no-rest-for-the-wicked`,name:`Uchigatana`,category:`katanas`,categoryLabel:`Katanas`,categoryLabelZh:`武士刀`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/uchigatana-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Uchigatana`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`uchigatana katanas 武士刀 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`wakizashi`,gameId:`no-rest-for-the-wicked`,name:`Wakizashi`,category:`katanas`,categoryLabel:`Katanas`,categoryLabelZh:`武士刀`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/wakizashi-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Wakizashi`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`wakizashi katanas 武士刀 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`wind-of-death`,gameId:`no-rest-for-the-wicked`,name:`Wind of Death`,category:`katanas`,categoryLabel:`Katanas`,categoryLabelZh:`武士刀`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/wind-of-death-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Wind+of+Death`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`wind of death katanas 武士刀 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`cleric-s-mace`,gameId:`no-rest-for-the-wicked`,name:`Cleric's Mace`,category:`maces`,categoryLabel:`Maces`,categoryLabelZh:`钉头锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/clerics_mace_one_handed_mace_no_rest_for_the_wicked_wiki_guide_100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Cleric's+Mace`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`cleric's mace maces 钉头锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`comet-fall`,gameId:`no-rest-for-the-wicked`,name:`Comet Fall`,category:`maces`,categoryLabel:`Maces`,categoryLabelZh:`钉头锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/comet-fall-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Comet+Fall`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`comet fall maces 钉头锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`malice`,gameId:`no-rest-for-the-wicked`,name:`Malice`,category:`maces`,categoryLabel:`Maces`,categoryLabelZh:`钉头锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/malice-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Malice`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`malice maces 钉头锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`savage-cathecism`,gameId:`no-rest-for-the-wicked`,name:`Savage Cathecism`,category:`maces`,categoryLabel:`Maces`,categoryLabelZh:`钉头锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/savage-catechism-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Savage+Cathecism`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`savage cathecism maces 钉头锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`shrike-tree`,gameId:`no-rest-for-the-wicked`,name:`Shrike Tree`,category:`maces`,categoryLabel:`Maces`,categoryLabelZh:`钉头锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/shrike-tree-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Shrike+Tree`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`shrike tree maces 钉头锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`tapestry-mender`,gameId:`no-rest-for-the-wicked`,name:`Tapestry Mender`,category:`maces`,categoryLabel:`Maces`,categoryLabelZh:`钉头锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/tapestry-mender-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Tapestry+Mender`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`tapestry mender maces 钉头锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`the-last-stitch`,gameId:`no-rest-for-the-wicked`,name:`The Last Stitch`,category:`maces`,categoryLabel:`Maces`,categoryLabelZh:`钉头锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-last-stitch-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Last+Stitch`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`the last stitch maces 钉头锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`weave-eater`,gameId:`no-rest-for-the-wicked`,name:`Weave Eater`,category:`maces`,categoryLabel:`Maces`,categoryLabelZh:`钉头锤`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/weave-eater-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Weave+Eater`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`weave eater maces 钉头锤 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`estoc`,gameId:`no-rest-for-the-wicked`,name:`Estoc`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/estoc-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Estoc`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`estoc rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`gentleman-s-gambit`,gameId:`no-rest-for-the-wicked`,name:`Gentleman's Gambit`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/gentlemans-gambit-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Gentleman's+Gambit`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`gentleman's gambit rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`longnail`,gameId:`no-rest-for-the-wicked`,name:`Longnail`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/longnail-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Longnail`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`longnail rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`moon-shaft`,gameId:`no-rest-for-the-wicked`,name:`Moon Shaft`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/moon-shaft-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Moon+Shaft`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`moon shaft rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`odessa-s-saber`,gameId:`no-rest-for-the-wicked`,name:`Odessa's Saber`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/odessas-saber-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Odessa's+Saber`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`odessa's saber rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`pig-sticker`,gameId:`no-rest-for-the-wicked`,name:`Pig Sticker`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/pig-sticker-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Pig+Sticker`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`pig sticker rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`royal-rapier`,gameId:`no-rest-for-the-wicked`,name:`Royal Rapier`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/royal-rapier-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Royal+Rapier`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`royal rapier rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`sinew`,gameId:`no-rest-for-the-wicked`,name:`Sinew`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/sinew-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Sinew`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`sinew rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`siren-queen-s-horn`,gameId:`no-rest-for-the-wicked`,name:`Siren Queen's Horn`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/siren-queens-horn-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Siren+Queen's+Horn`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`siren queen's horn rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`stitcher`,gameId:`no-rest-for-the-wicked`,name:`Stitcher`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/stitcher-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Stitcher`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`stitcher rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`tucked-falcon`,gameId:`no-rest-for-the-wicked`,name:`Tucked Falcon`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/tucked-falcon-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Tucked+Falcon`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`tucked falcon rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`winnick-s-rapier`,gameId:`no-rest-for-the-wicked`,name:`Winnick's Rapier`,category:`rapiers`,categoryLabel:`Rapiers`,categoryLabelZh:`刺剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/winnicks-rapier-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Winnick's+Rapier`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`winnick's rapier rapiers 刺剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`hope-shorn`,gameId:`no-rest-for-the-wicked`,name:`Hope Shorn`,category:`scythes`,categoryLabel:`Scythes`,categoryLabelZh:`镰刀`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/hope-shorn-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Hope+Shorn`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`hope shorn scythes 镰刀 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`scythe-of-wretches`,gameId:`no-rest-for-the-wicked`,name:`Scythe of Wretches`,category:`scythes`,categoryLabel:`Scythes`,categoryLabelZh:`镰刀`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/scythe-of-wretches-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Scythe+of+Wretches`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`scythe of wretches scythes 镰刀 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`soul-thresher`,gameId:`no-rest-for-the-wicked`,name:`Soul Thresher`,category:`scythes`,categoryLabel:`Scythes`,categoryLabelZh:`镰刀`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/soul-thresher-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Soul+Thresher`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`soul thresher scythes 镰刀 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`assegai`,gameId:`no-rest-for-the-wicked`,name:`Assegai`,category:`spears`,categoryLabel:`Spears`,categoryLabelZh:`长矛`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/assegai-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Assegai`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`assegai spears 长矛 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`boar-spiker`,gameId:`no-rest-for-the-wicked`,name:`Boar Spiker`,category:`spears`,categoryLabel:`Spears`,categoryLabelZh:`长矛`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/boar-spiker-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Boar+Spiker`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`boar spiker spears 长矛 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`coral-piercer`,gameId:`no-rest-for-the-wicked`,name:`Coral Piercer`,category:`spears`,categoryLabel:`Spears`,categoryLabelZh:`长矛`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/coral-piercer-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Coral+Piercer`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`coral piercer spears 长矛 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`gnarled-harpoon`,gameId:`no-rest-for-the-wicked`,name:`Gnarled Harpoon`,category:`spears`,categoryLabel:`Spears`,categoryLabelZh:`长矛`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/gnarled-harpoon-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Gnarled+Harpoon`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`gnarled harpoon spears 长矛 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`needle-spear`,gameId:`no-rest-for-the-wicked`,name:`Needle Spear`,category:`spears`,categoryLabel:`Spears`,categoryLabelZh:`长矛`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/needle-spear-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Needle+Spear`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`needle spear spears 长矛 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`proud-lance`,gameId:`no-rest-for-the-wicked`,name:`Proud Lance`,category:`spears`,categoryLabel:`Spears`,categoryLabelZh:`长矛`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/proud-lance-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Proud+Lance`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`proud lance spears 长矛 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`sacrament-s-sin`,gameId:`no-rest-for-the-wicked`,name:`Sacrament's Sin`,category:`spears`,categoryLabel:`Spears`,categoryLabelZh:`长矛`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/sacraments-sin-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Sacrament's+Sin`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`sacrament's sin spears 长矛 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`talon-of-the-balak-taw`,gameId:`no-rest-for-the-wicked`,name:`Talon of the Balak Taw`,category:`spears`,categoryLabel:`Spears`,categoryLabelZh:`长矛`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/talon-of-the-balak-taw-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Talon+of+the+Balak+Taw`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`talon of the balak taw spears 长矛 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`the-cage`,gameId:`no-rest-for-the-wicked`,name:`The Cage`,category:`spears`,categoryLabel:`Spears`,categoryLabelZh:`长矛`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-cage-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Cage`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`the cage spears 长矛 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`the-oldest-betrayal`,gameId:`no-rest-for-the-wicked`,name:`The Oldest Betrayal`,category:`spears`,categoryLabel:`Spears`,categoryLabelZh:`长矛`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-oldest-betrayal-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Oldest+Betrayal`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`the oldest betrayal spears 长矛 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`the-shrieker`,gameId:`no-rest-for-the-wicked`,name:`The Shrieker`,category:`spears`,categoryLabel:`Spears`,categoryLabelZh:`长矛`,handedness:`双手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/the-shrieker-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/The+Shrieker`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`the shrieker spears 长矛 双手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`alsoc-s-ruined-staff`,gameId:`no-rest-for-the-wicked`,name:`Alsoc's Ruined Staff`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/alsocs-ruined-staff-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Alsoc's+Ruined+Staff`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`alsoc's ruined staff staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`bear-slayer`,gameId:`no-rest-for-the-wicked`,name:`Bear Slayer`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/bear-slayer-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Bear+Slayer`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`bear slayer staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`cursed-crone`,gameId:`no-rest-for-the-wicked`,name:`Cursed Crone`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/cursed-crone-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Cursed+Crone`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`cursed crone staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`dried-hive`,gameId:`no-rest-for-the-wicked`,name:`Dried Hive`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/dried-hive-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Dried+Hive`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`dried hive staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`falling-sky`,gameId:`no-rest-for-the-wicked`,name:`Falling Sky`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/falling-sky-staff-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Falling+Sky`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`falling sky staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`false-truth`,gameId:`no-rest-for-the-wicked`,name:`False Truth`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/false-truth-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/False+Truth`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`false truth staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`gnarled-staff`,gameId:`no-rest-for-the-wicked`,name:`Gnarled Staff`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/gnarled_staff_two_handed_weapons_no_rest_for_the_wicked_wiki_guide_100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Gnarled+Staff`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`gnarled staff staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`pinwheel`,gameId:`no-rest-for-the-wicked`,name:`Pinwheel`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/pinwheel-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Pinwheel`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`pinwheel staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`root-tender`,gameId:`no-rest-for-the-wicked`,name:`Root Tender`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/root-tender-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Root+Tender`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`root tender staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`sinner-s-crown`,gameId:`no-rest-for-the-wicked`,name:`Sinner's Crown`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/sinners-crown-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Sinner's+Crown`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`sinner's crown staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`spherin`,gameId:`no-rest-for-the-wicked`,name:`Spherin`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/spherin-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Spherin`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`spherin staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`stag-head`,gameId:`no-rest-for-the-wicked`,name:`Stag Head`,category:`staves`,categoryLabel:`Staves`,categoryLabelZh:`法杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/stag-head-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Stag+Head`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`stag head staves 法杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`azure-blade`,gameId:`no-rest-for-the-wicked`,name:`Azure Blade`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/azure-blade-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Azure+Blade`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`azure blade straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`backstabber`,gameId:`no-rest-for-the-wicked`,name:`Backstabber`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/backstabber-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Backstabber`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`backstabber straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`blood-rusted-sword`,gameId:`no-rest-for-the-wicked`,name:`Blood-Rusted Sword`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/blood-rusted_sword_one_handed_straight_sword_weapons_no_rest_for_the_wicked_wiki_guide_100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Blood-Rusted+Sword`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`blood-rusted sword straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`coiled-sword`,gameId:`no-rest-for-the-wicked`,name:`Coiled Sword`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/coiled-sword-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Coiled+Sword`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`coiled sword straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`cronus`,gameId:`no-rest-for-the-wicked`,name:`Cronus`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/cronus-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Cronus`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`cronus straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`governor-s-dagger`,gameId:`no-rest-for-the-wicked`,name:`Governor's Dagger`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/governors-dagger-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Governor's+Dagger`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`governor's dagger straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`keeper-s-grace`,gameId:`no-rest-for-the-wicked`,name:`Keeper's Grace`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/keepers-grace-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Keeper's+Grace`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`keeper's grace straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`nith-blade`,gameId:`no-rest-for-the-wicked`,name:`Nith Blade`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/nith-blade-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Nith+Blade`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`nith blade straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`phalen-sliver`,gameId:`no-rest-for-the-wicked`,name:`Phalen Sliver`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/phalen-sliver-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Phalen+Sliver`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`phalen sliver straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`sacrament-s-pride`,gameId:`no-rest-for-the-wicked`,name:`Sacrament's Pride`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/sacraments-pride-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Sacrament's+Pride`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`sacrament's pride straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`weave-cutter`,gameId:`no-rest-for-the-wicked`,name:`Weave Cutter`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/weave-cutter-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Weave+Cutter`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`weave cutter straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`wooden-sword`,gameId:`no-rest-for-the-wicked`,name:`Wooden Sword`,category:`straight_swords`,categoryLabel:`Straight Swords`,categoryLabelZh:`直剑`,handedness:`单手`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/wooden-sword-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Wooden+Sword`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`wooden sword straight swords 直剑 单手 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`flame-becomes-us`,gameId:`no-rest-for-the-wicked`,name:`Flame Becomes Us`,category:`wands`,categoryLabel:`Wands`,categoryLabelZh:`魔杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/flame-becomes-us-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Flame+Becomes+Us`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`flame becomes us wands 魔杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`},{slug:`sanglier-staff`,gameId:`no-rest-for-the-wicked`,name:`Sanglier Staff`,category:`wands`,categoryLabel:`Wands`,categoryLabelZh:`魔杖`,handedness:`法器`,iconUrl:`https://norestforthewicked.wiki.fextralife.com/file/No-Rest-For-The-Wicked/sanglier-staff-weapon-no-rest-for-the-wicked-wiki-guide-100px.png`,sourceUrl:`https://norestforthewicked.wiki.fextralife.com/Sanglier+Staff`,imageSourceNote:`Fextralife Weapons 页面公开展示的武器图标，本站远程引用并保留来源链接。`,tier:`页面未稳定标注`,scaling:`页面多处仍为 ???，以游戏内实际掉落词条为准`,requirements:`页面多处仍为 ???，以游戏内实际装备要求为准`,runeSlots:[`X：空槽或随机`,`Y：空槽或随机`,`B：空槽或随机`,`A：空槽或随机`],acquisition:[`武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。`,`具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。`],merchants:[`来源页面未稳定列出固定商人时，标记为随机或待复核。`],notes:[`0% 耐久时武器不可装备，可通过对应 NPC 或 Repair Powder 修理。`,`常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。`,`普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`],lastVerifiedAt:`2026-07-09`,searchText:`sanglier staff wands 魔杖 法器 页面多处仍为 ???，以游戏内实际掉落词条为准 页面多处仍为 ???，以游戏内实际装备要求为准 武器通常可从探索掉落、宝箱、敌人掉落或商人处获得。 具体词条、稀有度和符文槽会受随机掉落影响，拿到实物后需要以游戏内面板复核。 0% 耐久时武器不可装备，可通过对应 npc 或 repair powder 修理。 常见稀有度包括白色普通、蓝色稀有、紫色诅咒、金色独特。 普通武器更适合自定义；稀有、诅咒或独特装备可围绕词条和符文构建玩法。`}],ii={axes:`斧`,bows:`弓`,clubs:`棍棒`,curved_great_swords:`曲刃大剑`,curved_swords:`曲剑`,daggers:`匕首`,double_daggers:`双匕首`,great_axes:`大斧`,great_clubs:`大棍棒`,great_hammers:`大锤`,great_swords:`大剑`,halberds:`戟`,hammers:`锤`,katanas:`武士刀`,maces:`钉头锤`,rapiers:`刺剑`,scythes:`镰刀`,spears:`长矛`,staves:`法杖`,straight_swords:`直剑`,wands:`魔杖`};function ai(e){return ri.filter(t=>t.gameId===e)}function oi(e,t){return ri.find(n=>n.gameId===e&&n.slug===t)}function si(e,t,n){let r=t.trim().toLowerCase();return e.filter(e=>n!==`all`&&e.category!==n?!1:r?e.searchText.includes(r):!0)}function ci(e){let t=new Map;for(let n of e)t.set(n.category,[...t.get(n.category)??[],n]);return Array.from(t.entries()).sort(([e],[t])=>ii[e].localeCompare(ii[t],`zh-Hans-CN`))}var li=ar[0]?.id??``,ui={category:`all`,region:`all`,phase:`all`,spoilerLevel:`all`};function di(){return(0,k.jsxs)(Jt,{children:[(0,k.jsx)(Kt,{path:`/`,element:(0,k.jsx)(Gt,{to:`/games/${li}`,replace:!0})}),(0,k.jsx)(Kt,{path:`/games/:gameId`,element:(0,k.jsx)(fi,{})}),(0,k.jsx)(Kt,{path:`/games/:gameId/weapons`,element:(0,k.jsx)(gi,{})}),(0,k.jsx)(Kt,{path:`/games/:gameId/weapons/:weaponSlug`,element:(0,k.jsx)(_i,{})}),(0,k.jsx)(Kt,{path:`/games/:gameId/bosses`,element:(0,k.jsx)(vi,{})}),(0,k.jsx)(Kt,{path:`/games/:gameId/bosses/:bossSlug`,element:(0,k.jsx)(yi,{})}),(0,k.jsx)(Kt,{path:`/games/:gameId/runes`,element:(0,k.jsx)(bi,{})}),(0,k.jsx)(Kt,{path:`/games/:gameId/runes/:runeSlug`,element:(0,k.jsx)(xi,{})}),(0,k.jsx)(Kt,{path:`/games/:gameId/guides/:guideSlug`,element:(0,k.jsx)(hi,{})}),(0,k.jsx)(Kt,{path:`*`,element:(0,k.jsx)(N,{title:`页面不存在`})})]})}function fi(){let{gameId:e=li}=xt(),t=yt(),n=ar.find(t=>t.id===e),[r,i]=(0,x.useState)(``),[a,o]=(0,x.useState)(ui),[s,c]=(0,x.useState)(`all`),[l,u]=(0,x.useState)(`all`),[d,f]=(0,x.useState)(`all`);if(!n)return(0,k.jsx)(N,{title:`未找到这个游戏`});let p=Or.filter(e=>e.gameId===n.id),m=Wr(p,`region`),h=Wr(p,`phase`),g=Pi(p.filter(e=>e.category===`equipment`),`equipmentType`),_=Pi(p.filter(e=>e.category===`boss`),`bossType`),v=Array.from(new Set(p.flatMap(e=>e.buildTags??[]))).sort((e,t)=>e.localeCompare(t,`zh-Hans-CN`)),y=n.supportedCategories.map(e=>({category:e,count:p.filter(t=>t.category===e).length})),b=a.category===`equipment`||a.category===`all`?s:`all`,ee=a.category===`boss`||a.category===`all`?l:`all`,S=a.category===`build`||a.category===`all`?d:`all`,C=Ur(p,n.id,r,a).filter(e=>(b===`all`||e.equipmentType===b)&&(ee===`all`||e.bossType===ee)&&(S===`all`||e.buildTags?.includes(S))),te=a.category===`equipment`||a.category===`boss`;function ne(e){o({...a,category:e}),e!==`equipment`&&e!==`all`&&c(`all`),e!==`boss`&&e!==`all`&&u(`all`),e!==`build`&&e!==`all`&&f(`all`)}return(0,k.jsxs)(`main`,{className:`app-shell`,children:[(0,k.jsx)(Di,{gameId:n.id,onGameChange:e=>t(`/games/${e}`)}),(0,k.jsxs)(`section`,{className:`game-hero`,children:[(0,k.jsx)(`img`,{src:n.cover,alt:``}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`多游戏攻略库`}),(0,k.jsx)(`h1`,{children:n.name}),(0,k.jsx)(`p`,{children:n.description}),(0,k.jsx)(ki,{})]})]}),(0,k.jsx)(pi,{stats:y,activeCategory:a.category,onSelect:ne}),(0,k.jsxs)(`section`,{className:`feature-strip`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`图鉴资料升级`}),(0,k.jsx)(`h2`,{children:`武器、Boss、符文图鉴`}),(0,k.jsx)(`p`,{children:`已整理 193 把武器、8 个 Boss 和 222 条符文；Boss 详情包含招式与打法，符文保留表格字段。`})]}),(0,k.jsxs)(`div`,{className:`feature-actions`,children:[(0,k.jsx)(O,{className:`primary-link solid`,to:`/games/${n.id}/weapons`,children:`武器`}),(0,k.jsx)(O,{className:`primary-link solid`,to:`/games/${n.id}/bosses`,children:`Boss`}),(0,k.jsx)(O,{className:`primary-link solid`,to:`/games/${n.id}/runes`,children:`符文`})]})]}),(0,k.jsxs)(`section`,{className:`library-layout`,"aria-label":`攻略列表`,children:[(0,k.jsxs)(`aside`,{className:`filter-panel`,children:[(0,k.jsxs)(`label`,{className:`field`,children:[(0,k.jsx)(`span`,{children:`搜索`}),(0,k.jsx)(`input`,{value:r,onChange:e=>i(e.target.value),placeholder:`任务、地点、NPC、道具、Boss、装备...`})]}),(0,k.jsx)(Oi,{label:`分类`,value:a.category,onChange:e=>ne(e),options:[[`all`,`全部分类`],...n.supportedCategories.map(e=>[e,or[e]])]}),(0,k.jsx)(Oi,{label:`区域`,value:a.region,onChange:e=>o({...a,region:e}),options:[[`all`,`全部区域`],...m.map(e=>[e,e])]}),(0,k.jsx)(Oi,{label:`阶段`,value:a.phase,onChange:e=>o({...a,phase:e}),options:[[`all`,`全部阶段`],...h.map(e=>[e,e])]}),(a.category===`equipment`||a.category===`all`)&&(0,k.jsx)(Oi,{label:`装备类型`,value:s,onChange:c,options:[[`all`,`全部装备类型`],...g.map(e=>[e,e])]}),(a.category===`boss`||a.category===`all`)&&(0,k.jsx)(Oi,{label:`Boss 类型`,value:l,onChange:u,options:[[`all`,`全部 Boss 类型`],..._.map(e=>[e,e])]}),(a.category===`build`||a.category===`all`)&&(0,k.jsx)(Oi,{label:`Build 标签`,value:d,onChange:f,options:[[`all`,`全部 Build 标签`],...v.map(e=>[e,e])]}),(0,k.jsx)(Oi,{label:`剧透`,value:a.spoilerLevel,onChange:e=>o({...a,spoilerLevel:e}),options:[[`all`,`全部剧透级别`],...Object.entries(sr)]}),(0,k.jsx)(`button`,{type:`button`,className:`ghost-button`,onClick:()=>{i(``),o(ui),c(`all`),u(`all`),f(`all`)},children:`重置筛选`})]}),(0,k.jsxs)(`div`,{className:`guide-results`,children:[(0,k.jsxs)(`div`,{className:`result-summary`,children:[(0,k.jsx)(`h2`,{children:`攻略条目`}),(0,k.jsxs)(`span`,{children:[C.length,` 篇`]})]}),te?(0,k.jsx)(mi,{guides:C,mode:a.category===`equipment`?`equipment`:`boss`}):(0,k.jsx)(`div`,{className:`guide-grid`,children:C.map(e=>(0,k.jsx)(Ei,{guide:e},`${e.gameId}/${e.slug}`))}),C.length===0&&(0,k.jsx)(Ni,{title:`没有匹配攻略`,body:`换一个关键词或重置筛选试试。`})]})]})]})}function pi({stats:e,activeCategory:t,onSelect:n}){let r=e.reduce((e,t)=>e+t.count,0);return(0,k.jsxs)(`section`,{className:`category-dashboard`,"aria-label":`分类总览`,children:[(0,k.jsxs)(`button`,{type:`button`,className:t===`all`?`active`:``,onClick:()=>n(`all`),children:[(0,k.jsx)(`span`,{children:`全部`}),(0,k.jsx)(`strong`,{children:r})]}),e.map(({category:e,count:r})=>(0,k.jsxs)(`button`,{type:`button`,className:t===e?`active`:``,onClick:()=>n(e),children:[(0,k.jsx)(`span`,{children:or[e]}),(0,k.jsx)(`strong`,{children:r})]},e))]})}function mi({guides:e,mode:t}){return(0,k.jsx)(`div`,{className:`catalog-sections`,children:Ii(e,t).map(([e,t])=>(0,k.jsxs)(`section`,{className:`catalog-section`,children:[(0,k.jsxs)(`div`,{className:`catalog-heading`,children:[(0,k.jsx)(`h3`,{children:e}),(0,k.jsxs)(`span`,{children:[t.length,` 项`]})]}),(0,k.jsx)(`div`,{className:`catalog-grid`,children:t.map(e=>(0,k.jsx)(Ei,{guide:e,catalog:!0},`${e.gameId}/${e.slug}`))})]},e))})}function hi(){let{gameId:e=``,guideSlug:t=``}=xt(),n=ar.find(t=>t.id===e),r=Or.find(n=>n.gameId===e&&n.slug===t),i=(0,x.useMemo)(()=>Or.filter(n=>n.gameId===e&&n.slug!==t&&(n.category===r?.category||n.region===r?.region||n.tags.some(e=>r?.tags.includes(e)))).slice(0,3),[e,t,r]);return n?r?(0,k.jsxs)(`main`,{className:`app-shell detail-shell`,children:[(0,k.jsx)(Di,{gameId:n.id}),(0,k.jsx)(O,{className:`back-link`,to:`/games/${n.id}`,children:`返回攻略列表`}),(0,k.jsxs)(`article`,{className:`guide-detail`,children:[(0,k.jsxs)(`header`,{children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:or[r.category]}),(0,k.jsx)(`h1`,{children:r.title}),(0,k.jsx)(`p`,{children:r.summary}),(0,k.jsxs)(`div`,{className:`status-row`,children:[r.example&&(0,k.jsx)(`span`,{className:`notice`,children:`示例内容`}),(0,k.jsx)(`span`,{className:`notice`,children:cr[r.contentStatus]}),(0,k.jsxs)(`span`,{className:`notice`,children:[`复核：`,r.lastVerifiedAt]})]}),(0,k.jsx)(ki,{})]}),(0,k.jsxs)(`dl`,{className:`meta-panel`,"aria-label":`攻略资料卡`,children:[(0,k.jsx)(M,{label:`区域`,values:[r.region]}),(0,k.jsx)(M,{label:`阶段`,values:[r.phase]}),(0,k.jsx)(M,{label:`NPC`,values:r.npcs}),(0,k.jsx)(M,{label:`关键道具`,values:r.items}),(0,k.jsx)(M,{label:`前置条件`,values:r.prerequisites}),(0,k.jsx)(M,{label:`奖励`,values:r.rewards}),(0,k.jsx)(M,{label:`装备类型`,values:Fi(r.equipmentType)}),(0,k.jsx)(M,{label:`Boss 类型`,values:Fi(r.bossType)}),(0,k.jsx)(M,{label:`Build 标签`,values:r.buildTags??[]}),(0,k.jsx)(M,{label:`剧透级别`,values:[sr[r.spoilerLevel]]}),(0,k.jsx)(M,{label:`更新`,values:[r.updatedAt]})]}),(0,k.jsx)(Ai,{guide:r}),(0,k.jsx)(rr,{source:r.body}),(0,k.jsx)(Mi,{values:r.tags}),(0,k.jsx)(ji,{guide:r})]}),i.length>0&&(0,k.jsxs)(`section`,{className:`related-guides`,children:[(0,k.jsx)(`h2`,{children:`相关攻略`}),(0,k.jsx)(`div`,{className:`guide-grid compact`,children:i.map(e=>(0,k.jsx)(Ei,{guide:e,compact:!0},`${e.gameId}/${e.slug}`))})]})]}):(0,k.jsx)(N,{title:`未找到这篇攻略`}):(0,k.jsx)(N,{title:`未找到这个游戏`})}function gi(){let{gameId:e=li}=xt(),t=ar.find(t=>t.id===e),[n,r]=(0,x.useState)(``),[i,a]=(0,x.useState)(`all`);if(!t)return(0,k.jsx)(N,{title:`未找到这个游戏`});let o=ai(t.id),s=si(o,n,i),c=ci(s),l=Array.from(new Set(o.map(e=>e.category))).sort((e,t)=>ii[e].localeCompare(ii[t],`zh-Hans-CN`));return(0,k.jsxs)(`main`,{className:`app-shell weapon-shell`,children:[(0,k.jsx)(Di,{gameId:t.id}),(0,k.jsx)(O,{className:`back-link`,to:`/games/${t.id}`,children:`返回攻略库首页`}),(0,k.jsxs)(`section`,{className:`weapon-hero`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`Weapons Catalog`}),(0,k.jsx)(`h1`,{children:`武器图鉴`}),(0,k.jsx)(`p`,{children:`按来源页面的武器分类和图标整理，适合快速查找斧、弓、匕首、武士刀、法杖、长矛等装备。`})]}),(0,k.jsxs)(`dl`,{className:`weapon-stats`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:`武器总数`}),(0,k.jsx)(`dd`,{children:o.length})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:`细分类`}),(0,k.jsx)(`dd`,{children:l.length})]})]})]}),(0,k.jsxs)(`section`,{className:`weapon-tools`,"aria-label":`武器筛选`,children:[(0,k.jsxs)(`label`,{className:`field`,children:[(0,k.jsx)(`span`,{children:`搜索武器`}),(0,k.jsx)(`input`,{value:n,onChange:e=>r(e.target.value),placeholder:`输入武器名、类型、单手、双手、法器...`})]}),(0,k.jsx)(Oi,{label:`武器类型`,value:i,onChange:e=>a(e),options:[[`all`,`全部武器类型`],...l.map(e=>[e,ii[e]])]})]}),(0,k.jsxs)(`div`,{className:`weapon-tabs`,"aria-label":`武器类型快捷入口`,children:[(0,k.jsx)(`button`,{type:`button`,className:i===`all`?`active`:``,onClick:()=>a(`all`),children:`全部`}),l.map(e=>(0,k.jsx)(`button`,{type:`button`,className:i===e?`active`:``,onClick:()=>a(e),children:ii[e]},e))]}),(0,k.jsxs)(`div`,{className:`result-summary`,children:[(0,k.jsx)(`h2`,{children:`武器列表`}),(0,k.jsxs)(`span`,{children:[s.length,` 把`]})]}),c.length>0?(0,k.jsx)(`div`,{className:`weapon-sections`,children:c.map(([e,t])=>(0,k.jsxs)(`section`,{className:`weapon-section`,children:[(0,k.jsxs)(`div`,{className:`weapon-section-heading`,children:[(0,k.jsx)(`h3`,{children:ii[e]}),(0,k.jsxs)(`span`,{children:[t.length,` 把`]})]}),(0,k.jsx)(`div`,{className:`weapon-grid`,children:t.map(e=>(0,k.jsx)(wi,{weapon:e},e.slug))})]},e))}):(0,k.jsx)(Ni,{title:`没有匹配武器`,body:`换一个关键词或重置武器类型。`})]})}function _i(){let{gameId:e=``,weaponSlug:t=``}=xt(),n=ar.find(t=>t.id===e),r=oi(e,t),i=r?ai(e).filter(e=>e.category===r.category&&e.slug!==r.slug).slice(0,8):[];return n?r?(0,k.jsxs)(`main`,{className:`app-shell weapon-shell`,children:[(0,k.jsx)(Di,{gameId:n.id}),(0,k.jsx)(O,{className:`back-link`,to:`/games/${n.id}/weapons`,children:`返回武器图鉴`}),(0,k.jsxs)(`article`,{className:`weapon-detail`,children:[(0,k.jsxs)(`section`,{className:`weapon-detail-main`,children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:r.categoryLabelZh}),(0,k.jsx)(`h1`,{children:r.name}),(0,k.jsxs)(`p`,{children:[r.name,` 属于 `,r.categoryLabelZh,`，当前资料综合自 Fextralife Weapons 页面和该武器来源页；随机词条、稀有度和要求以游戏内实物为准。`]}),(0,k.jsx)(j,{title:`获取方式`,values:r.acquisition}),(0,k.jsx)(j,{title:`商人 / 掉落备注`,values:r.merchants}),(0,k.jsx)(j,{title:`使用注意`,values:r.notes}),i.length>0&&(0,k.jsxs)(`section`,{className:`related-weapon-strip`,children:[(0,k.jsx)(`h2`,{children:`同类武器`}),(0,k.jsx)(`div`,{className:`weapon-mini-grid`,children:i.map(e=>(0,k.jsx)(wi,{weapon:e,compact:!0},e.slug))})]})]}),(0,k.jsxs)(`aside`,{className:`weapon-infobox`,"aria-label":`武器资料卡`,children:[(0,k.jsx)(`img`,{src:r.iconUrl,alt:`${r.name} 图标`}),(0,k.jsx)(`h2`,{children:r.name}),(0,k.jsxs)(`dl`,{children:[(0,k.jsx)(M,{label:`分类`,values:[r.categoryLabelZh]}),(0,k.jsx)(M,{label:`持握`,values:[r.handedness]}),(0,k.jsx)(M,{label:`阶级`,values:[r.tier]}),(0,k.jsx)(M,{label:`属性补正`,values:[r.scaling]}),(0,k.jsx)(M,{label:`装备要求`,values:[r.requirements]}),(0,k.jsx)(M,{label:`符文槽`,values:r.runeSlots}),(0,k.jsx)(M,{label:`复核日期`,values:[r.lastVerifiedAt]})]}),(0,k.jsx)(`a`,{href:r.sourceUrl,target:`_blank`,rel:`noreferrer`,children:`查看来源页`}),(0,k.jsx)(`p`,{children:r.imageSourceNote})]})]})]}):(0,k.jsx)(N,{title:`未找到这把武器`}):(0,k.jsx)(N,{title:`未找到这个游戏`})}function vi(){let{gameId:e=li}=xt(),t=ar.find(t=>t.id===e),[n,r]=(0,x.useState)(``),[i,a]=(0,x.useState)(`all`),[o,s]=(0,x.useState)(`all`);if(!t)return(0,k.jsx)(N,{title:`未找到这个游戏`});let c=Yr(t.id),l=Array.from(new Set(c.map(e=>e.bossType))).sort((e,t)=>e.localeCompare(t,`zh-Hans-CN`)),u=$r(c,n,i,o),d=ti(u);return(0,k.jsxs)(`main`,{className:`app-shell weapon-shell`,children:[(0,k.jsx)(Di,{gameId:t.id}),(0,k.jsx)(O,{className:`back-link`,to:`/games/${t.id}`,children:`返回攻略库首页`}),(0,k.jsx)(Si,{eyebrow:`Boss Catalog`,title:`Boss 图鉴`,body:`按主线、支线和 Boss 类型整理；点进详情可看位置、奖励、招式与打法。`,stats:[[`Boss 总数`,String(c.length)],[`类型`,String(l.length)]]}),(0,k.jsxs)(`section`,{className:`weapon-tools`,"aria-label":`Boss 筛选`,children:[(0,k.jsx)(Ci,{value:n,onChange:r,placeholder:`搜索 Boss、地点、奖励、招式...`}),(0,k.jsx)(Oi,{label:`Boss 分类`,value:i,onChange:e=>a(e),options:[[`all`,`全部 Boss`],...Object.entries(qr)]}),(0,k.jsx)(Oi,{label:`Boss 类型`,value:o,onChange:s,options:[[`all`,`全部类型`],...l.map(e=>[e,e])]})]}),(0,k.jsx)(`div`,{className:`weapon-sections`,children:d.map(([e,t])=>(0,k.jsxs)(`section`,{className:`weapon-section`,children:[(0,k.jsxs)(`div`,{className:`weapon-section-heading`,children:[(0,k.jsx)(`h3`,{children:qr[e]}),(0,k.jsxs)(`span`,{children:[t.length,` 个`]})]}),(0,k.jsx)(`div`,{className:`weapon-grid boss-grid`,children:t.map(e=>(0,k.jsx)(Ti,{boss:e},e.slug))})]},e))}),u.length===0&&(0,k.jsx)(Ni,{title:`没有匹配 Boss`,body:`换关键词或重置筛选。`})]})}function yi(){let{gameId:e=``,bossSlug:t=``}=xt(),n=ar.find(t=>t.id===e),r=Zr(e,t);return n?r?(0,k.jsxs)(`main`,{className:`app-shell weapon-shell`,children:[(0,k.jsx)(Di,{gameId:n.id}),(0,k.jsx)(O,{className:`back-link`,to:`/games/${n.id}/bosses`,children:`返回 Boss 图鉴`}),(0,k.jsxs)(`article`,{className:`weapon-detail`,children:[(0,k.jsxs)(`section`,{className:`weapon-detail-main`,children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:r.categoryLabelZh}),(0,k.jsx)(`h1`,{children:r.name}),(0,k.jsx)(`p`,{children:r.summary}),(0,k.jsx)(j,{title:`战前准备`,values:r.preparation}),(0,k.jsx)(j,{title:`打法流程`,values:r.strategy}),(0,k.jsxs)(`section`,{className:`info-section`,children:[(0,k.jsx)(`h2`,{children:`招式与应对`}),(0,k.jsx)(`div`,{className:`data-table-wrap`,children:(0,k.jsxs)(`table`,{className:`data-table`,children:[(0,k.jsx)(`thead`,{children:(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`th`,{children:`招式`}),(0,k.jsx)(`th`,{children:`应对`})]})}),(0,k.jsx)(`tbody`,{children:r.attacks.map(e=>(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:e.name}),(0,k.jsx)(`td`,{children:e.counter})]},e.name))})]})})]}),r.notes.length>0&&(0,k.jsx)(j,{title:`备注`,values:r.notes})]}),(0,k.jsxs)(`aside`,{className:`weapon-infobox`,"aria-label":`Boss 资料卡`,children:[r.imageUrl?(0,k.jsx)(`img`,{src:r.imageUrl,alt:`${r.name} 图片`}):(0,k.jsx)(`div`,{className:`missing-image`,children:`待补图`}),(0,k.jsx)(`h2`,{children:r.name}),(0,k.jsxs)(`dl`,{children:[(0,k.jsx)(M,{label:`分类`,values:[r.categoryLabelZh]}),(0,k.jsx)(M,{label:`类型`,values:[r.bossType]}),(0,k.jsx)(M,{label:`可选`,values:[r.optional]}),(0,k.jsx)(M,{label:`位置`,values:r.location}),(0,k.jsx)(M,{label:`相关任务`,values:r.quest}),(0,k.jsx)(M,{label:`弱点`,values:r.weakness}),(0,k.jsx)(M,{label:`强抗`,values:r.strongAgainst}),(0,k.jsx)(M,{label:`抗性`,values:r.resistantTo}),(0,k.jsx)(M,{label:`免疫`,values:r.immuneTo}),(0,k.jsx)(M,{label:`奖励`,values:r.rewards}),(0,k.jsx)(M,{label:`复核日期`,values:[r.lastVerifiedAt]})]}),(0,k.jsx)(`a`,{href:r.sourceUrl,target:`_blank`,rel:`noreferrer`,children:`查看来源页`})]})]})]}):(0,k.jsx)(N,{title:`未找到这个 Boss`}):(0,k.jsx)(N,{title:`未找到这个游戏`})}function bi(){let{gameId:e=li}=xt(),t=ar.find(t=>t.id===e),[n,r]=(0,x.useState)(``),[i,a]=(0,x.useState)(`all`),[o,s]=(0,x.useState)(`all`);if(!t)return(0,k.jsx)(N,{title:`未找到这个游戏`});let c=Xr(t.id),l=Array.from(new Set(c.map(e=>e.attackType))).sort((e,t)=>e.localeCompare(t,`zh-Hans-CN`)),u=ei(c,n,i,o),d=ni(u);return(0,k.jsxs)(`main`,{className:`app-shell weapon-shell`,children:[(0,k.jsx)(Di,{gameId:t.id}),(0,k.jsx)(O,{className:`back-link`,to:`/games/${t.id}`,children:`返回攻略库首页`}),(0,k.jsx)(Si,{eyebrow:`Runes Catalog`,title:`符文图鉴`,body:`保留来源表格的描述、成本、攻击类型、兼容武器和获取方式，支持筛选与详情查看。`,stats:[[`符文总数`,String(c.length)],[`攻击类型`,String(l.length)]]}),(0,k.jsxs)(`section`,{className:`weapon-tools`,"aria-label":`符文筛选`,children:[(0,k.jsx)(Ci,{value:n,onChange:r,placeholder:`搜索符文、描述、获取方式、武器类型...`}),(0,k.jsx)(Oi,{label:`用途分类`,value:i,onChange:e=>a(e),options:[[`all`,`全部用途`],...Object.entries(Jr)]}),(0,k.jsx)(Oi,{label:`攻击类型`,value:o,onChange:s,options:[[`all`,`全部攻击类型`],...l.map(e=>[e,e])]})]}),(0,k.jsx)(`div`,{className:`weapon-sections`,children:d.map(([e,t])=>(0,k.jsxs)(`section`,{className:`weapon-section`,children:[(0,k.jsxs)(`div`,{className:`weapon-section-heading`,children:[(0,k.jsx)(`h3`,{children:Jr[e]}),(0,k.jsxs)(`span`,{children:[t.length,` 条`]})]}),(0,k.jsx)(`div`,{className:`data-table-wrap`,children:(0,k.jsxs)(`table`,{className:`data-table`,children:[(0,k.jsx)(`thead`,{children:(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`th`,{children:`符文`}),(0,k.jsx)(`th`,{children:`描述`}),(0,k.jsx)(`th`,{children:`成本`}),(0,k.jsx)(`th`,{children:`类型`}),(0,k.jsx)(`th`,{children:`兼容武器`}),(0,k.jsx)(`th`,{children:`获取方式`})]})}),(0,k.jsx)(`tbody`,{children:t.map(e=>(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(O,{to:`/games/${e.gameId}/runes/${e.slug}`,children:e.name})}),(0,k.jsx)(`td`,{children:e.description}),(0,k.jsx)(`td`,{children:e.cost}),(0,k.jsx)(`td`,{children:e.attackType}),(0,k.jsx)(`td`,{children:e.compatibleWeaponType}),(0,k.jsx)(`td`,{children:e.whereToFind})]},e.slug))})]})})]},e))}),u.length===0&&(0,k.jsx)(Ni,{title:`没有匹配符文`,body:`换关键词或重置筛选。`})]})}function xi(){let{gameId:e=``,runeSlug:t=``}=xt(),n=ar.find(t=>t.id===e),r=Qr(e,t);return n?r?(0,k.jsxs)(`main`,{className:`app-shell weapon-shell`,children:[(0,k.jsx)(Di,{gameId:n.id}),(0,k.jsx)(O,{className:`back-link`,to:`/games/${n.id}/runes`,children:`返回符文图鉴`}),(0,k.jsxs)(`article`,{className:`weapon-detail`,children:[(0,k.jsxs)(`section`,{className:`weapon-detail-main`,children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:Jr[r.category]}),(0,k.jsx)(`h1`,{children:r.name}),(0,k.jsx)(`p`,{children:r.description}),(0,k.jsx)(j,{title:`使用判断`,values:[`成本：${r.cost}`,`攻击类型：${r.attackType}`,`兼容武器：${r.compatibleWeaponType}`,`获取方式：${r.whereToFind}`]}),(0,k.jsx)(j,{title:`备注`,values:[`符文数据来自 Fextralife Runes 表格；数值、成本和兼容武器保留来源字段，避免遗漏。`,`实际 Build 适配需要结合武器动作、 Focus/Stamina 消耗和当前词条复核。`]})]}),(0,k.jsxs)(`aside`,{className:`weapon-infobox`,"aria-label":`符文资料卡`,children:[(0,k.jsx)(`div`,{className:`rune-mark`,children:r.name.slice(0,1)}),(0,k.jsx)(`h2`,{children:r.name}),(0,k.jsxs)(`dl`,{children:[(0,k.jsx)(M,{label:`用途`,values:[Jr[r.category]]}),(0,k.jsx)(M,{label:`成本`,values:[r.cost]}),(0,k.jsx)(M,{label:`攻击类型`,values:[r.attackType]}),(0,k.jsx)(M,{label:`兼容武器`,values:[r.compatibleWeaponType]}),(0,k.jsx)(M,{label:`获取方式`,values:[r.whereToFind]}),(0,k.jsx)(M,{label:`复核日期`,values:[r.lastVerifiedAt]})]}),(0,k.jsx)(`a`,{href:r.sourceUrl,target:`_blank`,rel:`noreferrer`,children:`查看来源页`})]})]})]}):(0,k.jsx)(N,{title:`未找到这个符文`}):(0,k.jsx)(N,{title:`未找到这个游戏`})}function Si({eyebrow:e,title:t,body:n,stats:r}){return(0,k.jsxs)(`section`,{className:`weapon-hero`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:e}),(0,k.jsx)(`h1`,{children:t}),(0,k.jsx)(`p`,{children:n})]}),(0,k.jsx)(`dl`,{className:`weapon-stats`,children:r.map(([e,t])=>(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:e}),(0,k.jsx)(`dd`,{children:t})]},e))})]})}function Ci({value:e,onChange:t,placeholder:n}){return(0,k.jsxs)(`label`,{className:`field`,children:[(0,k.jsx)(`span`,{children:`搜索`}),(0,k.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:n})]})}function wi({weapon:e,compact:t=!1}){return(0,k.jsxs)(O,{className:`weapon-card ${t?`compact-weapon-card`:``}`,to:`/games/${e.gameId}/weapons/${e.slug}`,children:[(0,k.jsx)(`img`,{src:e.iconUrl,alt:`${e.name} 图标`}),(0,k.jsx)(`strong`,{children:e.name}),!t&&(0,k.jsxs)(`span`,{children:[e.categoryLabelZh,` · `,e.handedness]})]})}function Ti({boss:e}){return(0,k.jsxs)(O,{className:`weapon-card boss-card`,to:`/games/${e.gameId}/bosses/${e.slug}`,children:[e.imageUrl?(0,k.jsx)(`img`,{src:e.imageUrl,alt:`${e.name} 图片`}):(0,k.jsx)(`div`,{className:`missing-image small`,children:`待补图`}),(0,k.jsx)(`strong`,{children:e.name}),(0,k.jsxs)(`span`,{children:[e.categoryLabelZh,` · `,e.bossType]})]})}function j({title:e,values:t}){return(0,k.jsxs)(`section`,{className:`info-section`,children:[(0,k.jsx)(`h2`,{children:e}),(0,k.jsx)(`ul`,{children:t.map(e=>(0,k.jsx)(`li`,{children:e},e))})]})}function Ei({guide:e,compact:t=!1,catalog:n=!1}){let r=e.images[0];return(0,k.jsxs)(O,{className:`guide-card ${t?`compact-card`:``} ${n?`catalog-card`:``}`,to:`/games/${e.gameId}/guides/${e.slug}`,children:[r&&(0,k.jsx)(`img`,{className:`card-image`,src:r.url,alt:r.alt}),(0,k.jsxs)(`div`,{className:`card-topline`,children:[(0,k.jsx)(`span`,{children:or[e.category]}),(0,k.jsx)(`strong`,{children:cr[e.contentStatus]})]}),(0,k.jsx)(`h3`,{children:e.title}),!n&&(0,k.jsx)(`p`,{children:e.summary}),n&&(0,k.jsx)(`p`,{className:`catalog-type`,children:e.equipmentType??e.bossType??e.region}),!t&&!n&&(0,k.jsxs)(`dl`,{children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:`区域`}),(0,k.jsx)(`dd`,{children:e.region})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:`阶段`}),(0,k.jsx)(`dd`,{children:e.phase})]})]}),(0,k.jsx)(Mi,{values:e.tags.slice(0,4)})]})}function Di({gameId:e,onGameChange:t}){return(0,k.jsxs)(`header`,{className:`topbar`,children:[(0,k.jsxs)(O,{className:`brand`,to:`/games/${e}`,children:[(0,k.jsx)(`span`,{children:`攻略库`}),(0,k.jsx)(`strong`,{children:`Guide Forge`})]}),(0,k.jsxs)(`nav`,{className:`topnav`,"aria-label":`图鉴导航`,children:[(0,k.jsx)(O,{to:`/games/${e}/weapons`,children:`武器`}),(0,k.jsx)(O,{to:`/games/${e}/bosses`,children:`Boss`}),(0,k.jsx)(O,{to:`/games/${e}/runes`,children:`符文`})]}),(0,k.jsxs)(`label`,{className:`game-switcher`,children:[(0,k.jsx)(`span`,{children:`游戏`}),(0,k.jsx)(`select`,{value:e,onChange:e=>t?.(e.target.value),children:ar.map(e=>(0,k.jsx)(`option`,{value:e.id,children:e.name},e.id))})]})]})}function Oi({label:e,value:t,onChange:n,options:r}){return(0,k.jsxs)(`label`,{className:`field`,children:[(0,k.jsx)(`span`,{children:e}),(0,k.jsx)(`select`,{value:t,onChange:e=>n(e.target.value),children:r.map(([e,t])=>(0,k.jsx)(`option`,{value:e,children:t},e))})]})}function ki(){return(0,k.jsx)(`p`,{className:`source-notice`,children:`以下攻略均综合整理自互联网公开资料，并在详情页附来源链接；内容为重写摘要，不搬运第三方全文。`})}function Ai({guide:e}){return e.images.length===0?null:(0,k.jsx)(`section`,{className:`image-gallery`,"aria-label":`攻略图片`,children:e.images.map(e=>(0,k.jsxs)(`figure`,{children:[(0,k.jsx)(`img`,{src:e.url,alt:e.alt}),(0,k.jsxs)(`figcaption`,{children:[e.caption,(0,k.jsx)(`a`,{href:e.sourceUrl,target:`_blank`,rel:`noreferrer`,children:`图片来源`}),(0,k.jsx)(`span`,{children:e.licenseNote})]})]},`${e.url}-${e.caption}`))})}function ji({guide:e}){return(0,k.jsxs)(`section`,{className:`source-list`,"aria-label":`来源链接`,children:[(0,k.jsx)(`h2`,{children:`来源链接`}),(0,k.jsx)(`ul`,{children:e.sources.map(e=>(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`a`,{href:e.url,target:`_blank`,rel:`noreferrer`,children:e.title}),(0,k.jsxs)(`span`,{children:[e.type,` · `,e.language]})]},`${e.title}-${e.url}`))})]})}function M({label:e,values:t}){let n=t.length>0?t:[`无`];return(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:e}),(0,k.jsx)(`dd`,{children:n.join(`、`)})]})}function Mi({values:e}){return e.length===0?null:(0,k.jsx)(`ul`,{className:`tag-list`,children:e.map(e=>(0,k.jsx)(`li`,{children:e},e))})}function Ni({title:e,body:t}){return(0,k.jsxs)(`div`,{className:`empty-state`,children:[(0,k.jsx)(`h2`,{children:e}),(0,k.jsx)(`p`,{children:t})]})}function N({title:e}){return(0,k.jsxs)(`main`,{className:`app-shell`,children:[(0,k.jsx)(Di,{gameId:li}),(0,k.jsx)(Ni,{title:e,body:`回到攻略列表继续浏览已有内容。`}),(0,k.jsx)(O,{className:`primary-link`,to:`/games/${li}`,children:`打开攻略库`})]})}function Pi(e,t){return Array.from(new Set(e.map(e=>e[t]).filter(Boolean))).sort((e,t)=>e.localeCompare(t,`zh-Hans-CN`))}function Fi(e){return e?[e]:[]}function Ii(e,t){let n=t===`equipment`?`未分类装备`:`未分类 Boss`,r=new Map;for(let i of e){let e=(t===`equipment`?i.equipmentType:i.bossType)??n;r.set(e,[...r.get(e)??[],i])}return Array.from(r.entries()).sort(([e],[t])=>e.localeCompare(t,`zh-Hans-CN`))}(0,tr.createRoot)(document.getElementById(`root`)).render((0,k.jsx)(x.StrictMode,{children:(0,k.jsx)(In,{basename:`/-/`,children:(0,k.jsx)(di,{})})}));